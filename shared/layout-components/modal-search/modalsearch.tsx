          ...
          <div className="ti-modal-body">
            <div className="input-group border-[2px] border-primary rounded-[0.25rem] w-full flex">
              ...
              <a
                aria-label="anchor"
                href="#!"
                className="!border-r-0 flex items-center input-group-text bg-light !py-[0.375rem] !px-[0.75rem]"
                id="voice-search"
              >
            ...
            <div className="mt-5">
              ...
              {allData.map((idx) => (
                <span
                  key={Math.random()}
                  className="search-tags text-[0.75rem] !py-[0rem] !px-[0.55rem] dark:border-defaultborder/10"
                >
                  <i className={`fe fe-${idx.icon} me-2`}></i>
                  {idx.class}
                  <a
                    href="#!"
            ...
            <div className="my-[1.5rem]">
              ...
              >
                <Link href="/components/pages/notifications/">
              ...
              <div
                ...
                className="!p-2 border dark:border-defaultborder/10 rounded-[0.3125rem] flex items-center text-defaulttextcolor dark:text-defaulttextcolor/70 !mb-2 !text-[0.8125rem] alert"
              >
                <Link href="/components/ui-elements/alerts/">
                  <span>Alerts</span>
                </Link>
                <Link
                  aria-label="anchor"
              ...
              >
                <Link href="/components/pages/email/mail-app/">
                  <span>Mail</span>
                </Link>
                <Link
                  aria-label="anchor"
