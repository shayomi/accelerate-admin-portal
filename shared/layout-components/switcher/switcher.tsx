          ...
          <div className="ti-offcanvas-body" id="switcher-body">
                ...
                <div className="grid grid-cols-2 gap-2 switcher-style">
                  ...
                  <div className="flex">
                    <input
                      ...
                      checked={
                        local_varaiable.dataToggled == 'double-menu-open'
                      }
                      onChange={(_e) => {}}
            ...
            >
              ...
              <div className="theme-colors">
                ...
                <div className="px-4 text-[#8c9097] dark:text-white/50 text-[.6875rem]">
                  <b className="me-2">Note:</b>If you want to change color
                  Header dynamically change from below Theme Primary color
                  picker.
                </div>
              </div>
              <div className="theme-colors">
