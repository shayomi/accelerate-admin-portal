...
export const animated: animate[] = [
  {
    id: 1,
    class: 'progress-bar-striped progress-bar-animated w-[10%]',
    valuenow: '10',
  },
  {
    id: 2,
    class: 'bg-secondary progress-bar-striped progress-bar-animated w-1/5',
    valuenow: '20',
  },
  {
    id: 3,
    class: 'bg-success progress-bar-striped progress-bar-animated w-2/5',
    valuenow: '40',
  },
  {
    id: 4,
    class: 'bg-info progress-bar-striped progress-bar-animated w-3/5',
    valuenow: '60',
  },
  {
    id: 5,
    class: 'bg-warning progress-bar-striped progress-bar-animated w-4/5',
    valuenow: '80',
  },
];
