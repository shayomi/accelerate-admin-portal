...
export const DisableItems: DisableItems1[] = [
  ...
  {
    id: 5,
    class: 'Written in 45 BC. This book is a treatise on the theory',
    text: '',
  },
];
...
export const ContextualButtons: ContextualButton[] = [
  ...
  },
  {
    ...
    class: '!bg-light/10 !text-defaulttextcolor',
  },
  {
    id: 9,
    text: 'A simple dark list group item',
    class: '!bg-black/10 dark:!bg-light !text-defaulttextcolor',
  },
];
...
export const ContextualButtons1: ContextualButton1[] = [
  ...
  },
  {
    id: 8,
    text: 'A simple light list group item',
    class: '!bg-light/10 !text-defaulttextcolor hover:!bg-light/20',
  },
  {
    id: 9,
    text: 'A simple dark list group item',
    class:
      '!bg-black/10 dark:!bg-light !text-defaulttextcolor hover:!bg-black/20',
  },
];
...
export const Solidcolors: Solidcolors1[] = [
  ...
  },
  {
    ...
    text: 'A simple dark list group item',
    class:
      '!bg-black dark:!bg-white dark:!text-black !text-white !border-black',
  },
];
