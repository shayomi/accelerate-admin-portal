...
export const Backgroundcards: Background1[] = [
  ...
  },
  {
    ...
    text1: 'Sebastien steyn',
    text2: 'Completed by Tomorrow',
    color: 'danger',
    class: 'white',
  },
  {
...
export const Gridcards: Gridcards1[] = [
  {
    ...
    text1: 'Morphology of a typical fruit.',
  },
  {
    id: 2,
    src: '../../../assets/images/media/media-43.jpg',
    text1: 'Research improves ability & agility !',
  },
  {
    id: 3,
    src: '../../../assets/images/media/media-45.jpg',
    text1: 'Most tropical areas are suitable',
  },
  {
    id: 4,
    src: '../../../assets/images/media/media-46.jpg',
    text1: 'Are They seasonal fruits ?',
  },
];
