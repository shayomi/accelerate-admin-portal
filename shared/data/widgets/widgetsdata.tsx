...
export const Salesdata = [
  {
    id: 1,
    icon: 'ri-briefcase-2-line text-[1rem]',
    color: 'primary',
    text1: 'Total Sales',
    text2: '15,800',
    badge: '+25.8%',
  ...
  {
    id: 3,
    icon: 'ri-wallet-2-line text-[1rem]',
    color: 'success',
    text1: 'Total Income',
    text2: '$14,800',
    badge: '+7.45%',
  ...
  {
    id: 4,
    icon: 'ri-line-chart-line text-[1rem]',
    color: 'info',
  ...
  {
    id: 5,
    icon: 'ri-money-dollar-box-line text-[1rem]',
    color: 'warning',
    text1: 'Sales Profit',
    text2: '$7,474',
    badge: '+36.03%',
  ...
  {
    id: 6,
    icon: 'ri-profile-line text-[1rem]',
    color: 'danger',
    text1: 'Opex Ratio',
    text2: '32%',
    badge: '+0.89%',
...
export function MapData({ setTooltipContent }: any) {
  ...
  const handleMoveEnd = (
    position: SetStateAction<{ coordinates: number[]; zoom: number }>,
  ) => {
