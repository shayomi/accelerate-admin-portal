...
export class CurrencyXRS extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class CurrencyGLM extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class CurrencyMonero extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class CurrencyEOS extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
