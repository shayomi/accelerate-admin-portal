    ...
    return (
      <Wizard step={this.state.step} onChange={this.handleStep}>
        <Step
          title={
            <>
              <i className="ri-truck-line basicstep-icon"></i> Shipping
            </>
          }
        >
          <div className="p-6">
            <p className="mb-1 font-semibold text-[#8c9097] dark:text-white/50 opacity-[0.5] text-[1.25rem]">
              01
            </p>
            <div className="text-[0.9375rem] font-semibold sm:flex block items-center justify-between mb-4">
              ...
              <div className="sm:mt-0 mt-2">
                ...
                >
                  <i className="ri-add-line  align-middle text-[0.875rem] font-semibold inline-block"></i>
                  Add New Address
                </Link>
                <div
                    ...
                    <div className="ti-modal-content">
                      ...
                      <div className="ti-modal-body !max-w-[800px] px-4">
                        <div className="grid grid-cols-12 gap-6">
                          ...
                          <div className="xl:col-span-6 col-span-12">
                            <label htmlFor="email-new" className="form-label">
                              Email
                            </label>
                            <input
                              type="email"
                          ...
                          <div className="xl:col-span-6 col-span-12">
                            <label htmlFor="address-new" className="form-label">
                              Address
                            </label>
                            <input
                              type="text"
            ...
            <div className="grid grid-cols-12 gap-4 !mb-4">
              <div className="xl:col-span-6 col-span-12">
                <div className="form-floating">
                  ...
                  />
                  <label
                    htmlFor="fullname-add"
                    className="!text-[0.75rem] after:bg-white after:dark:bg-bodybg after:rounded-md after:inset-y-4 after:inset-x-[0.375rem]"
                  >
                    Full Name
                  </label>
                </div>
              ...
              <div className="xl:col-span-6 col-span-12">
                <div className="form-floating">
                  <input
                    type="email"
                    className="form-control is-valid  w-full !rounded-md"
                    id="phoneno-add"
            ...
            <p className="text-[0.9375rem] font-semibold mb-1 xl:col-span-12">
              Shipping Methods :
            </p>
            <div className="grid grid-cols-12 gap-4">
              <div className="xl:col-span-6 col-span-12">
                  ...
                  <div className="form-check-label">
                    <div className="sm:flex items-center justify-between">
                      ...
                      <div className="shipping-partner-details sm:me-5 me-0">
                        ...
                        <p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] mb-0">
                          Delivered By 24,Nov 2022
                        </p>
                      </div>
                      <div className="font-semibold sm:me-5 me-0">$9.99</div>
                      <div>
                        <input
                          id="shipping-method1"
                ...
                <div className="form-check shipping-method-container mb-0">
                  <div className="form-check-label">
                    <div className="sm:flex items-center justify-between">
                      ...
                      <div className="font-semibold sm:me-5 me-0">$10.49</div>
                      <div>
                        <input
                          id="shipping-method2"
                          name="shipping-methods"
                ...
                <div className="form-check shipping-method-container mb-0">
                  <div className="form-check-label">
                    <div className="sm:flex items-center justify-between">
                      ...
                      <div className="font-semibold sm:me-5 me-0">$12.29</div>
                      <div>
                        <input
                          id="shipping-method3"
                          name="shipping-methods"
                ...
                <div className="form-check shipping-method-container mb-0">
                  <div className="form-check-label">
                    <div className="sm:flex items-center justify-between">
                      ...
                      <div className="font-semibold sm:me-5 me-0">$18.99</div>
                      <div>
                        <input
                          id="shipping-method4"
                          name="shipping-methods"
        ...
        <Step
          title={
            <>
              <i className="ri-user-3-line basicstep-icon"></i> PersonalDetails{' '}
            </>
          }
        >
          <div className="p-4">
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="xl:col-span-6 col-span-12">
                <label htmlFor="firstname-personal" className="form-label">
                  First Name
                </label>
                <input
                  type="text"
              ...
              <div className="xl:col-span-6 col-span-12">
                <label htmlFor="lastname-personal" className="form-label">
                  Last Name
                </label>
                <input
                  type="text"
              ...
              <div className="xl:col-span-6 col-span-12">
                <label htmlFor="email-personal" className="form-label">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="xl:col-span-6 col-span-12">
                <label htmlFor="phoneno-personal" className="form-label">
                  Phone no
                </label>
                <input
                  type="text"
              ...
              <div className="xxl:col-span-2 col-span-12">
                <label htmlFor="pincode-personal" className="form-label">
                  Pincode
                </label>
                <input
                  type="text"
              ...
              <div className="xxl:col-span-4 col-span-12">
                <label htmlFor="choices-single-default1" className="form-label">
                  State
                </label>
                <Select
                  isSearchable
              ...
              <div className="xxl:col-span-2 col-span-12">
                <label htmlFor="country-personal" className="form-label">
                  Country
                </label>
                <input
                  type="text"
        ...
        <Step
          title={
            <>
              <i className="ri-bank-card-line basicstep-icon"></i> Payment{' '}
            </>
          }
        >
              ...
              <div className="xl:col-span-12 col-span-12">
                <div className="mb-4">
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className="form-control !rounded-s-sm"
                      placeholder="Address"
                      aria-label="address"
                    ...
                    <button
                      type="button"
                      className="ti-btn ti-btn-info border-defaultborder !rounded-s-none !mb-0"
                      id="payment-address"
                    >
                      Change
                    </button>
                ...
                <div className="box border dark:border-defaultborder/10 !shadow-none mb-4">
                  ...
                  <div className="box-body">
                    ...
                    >
                      ...
                      />
                      <label
                        className="w-full ti-btn ti-btn-outline-light !text-defaulttextcolor sm:!border-e-0 dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 hover:!bg-light !rounded-e-none"
                        htmlFor="btnradio"
                      >
                      ...
                      />
                      <label
                        className="w-full ti-btn ti-btn-outline-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 sm:!border-e-0 dark:!border-defaultborder/10 hover:!bg-light sm:mt-0 mt-1 !rounded-none"
                        htmlFor="btnradio"
                      >
                        UPI
                      </label>
                      ...
                      />
                      <label
                        className="w-full ti-btn ti-btn-light !text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:!border-defaultborder/10 hover:!bg-light !rounded-s-none sm:mt-0 mt-1"
                        htmlFor="btnradio"
                      >
                        Credit/Debit Card
                      </label>
                    ...
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="xl:col-span-4 col-span-12">
                        <label htmlFor="payment-cvv" className="form-label">
                          CVV
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="xl:col-span-4 col-span-12">
                        ...
                        <label
                          htmlFor="payment-security"
                          className=" mt-1 !text-success !text-[0.6875rem]"
                        >
                          <sup className="top-[0.4em]">
        ...
        <Step
          title={
            <>
              <i className="ri-checkbox-circle-line basicstep-icon"></i>{' '}
              Confirmation{' '}
            </>
          }
        >
          <div className="p-[3rem] checkout-payment-success my-3">
            <div className="mb-[3rem]">
              <h5 className="text-success font-semibold text-[1.25rem]">
                Payment Successful...🤝
              </h5>
            </div>
            ...
            <div className="mb-6">
              <p className="mb-1 text-[0.875rem]">
                ...
                <Link className="link-success" href="#!">
                  <u className="text-success">Track Order</u>
                </Link>
              </p>
            ...
            <Link
              href="/components/pages/ecommerce/products/"
