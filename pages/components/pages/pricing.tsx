    ...
    <Fragment>
      ...
      <div className="grid grid-cols-12 gap-x-6 mb-[3rem]">
        <div className="xl:col-span-12 col-span-12">
          ...
          <p className="text-[#8c9097] dark:text-white/50 mb-4 text-center">
            Choose plan that suits best for your business needs, Our plans
            scales with you based on your needs
          </p>
          <div className="flex justify-center !mb-6">
            ...
            >
              <Link
                href="#!"
                className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4  text-sm font-medium text-center rounded-sm hover:text-primary active"
                id="pricing-item"
                data-hs-tab="#pricing-monthly1-pane"
              ...
              <Link
                href="#!"
                className="hs-tab-active:bg-primary hs-tab-active:text-white cursor-pointer text-primary py-2 px-4 text-sm font-medium text-center  rounded-sm hover:text-primary "
                id="pricing-yearly1-item"
                data-hs-tab="#pricing-yearly1-pane"
        ...
        <div className="xl:col-span-12 col-span-12">
          <div className="tab-content" id="myTabContent1">
                  ...
                  <div className="box overflow-hidden">
                    <div className="box-body !p-0">
                      ...
                      <div className="!p-6">
                        ...
                        <div className="text-[1.5625rem] font-bold mb-1">
                          $0
                          <sub className="text-[#8c9097] dark:text-white/50 font-semibold text-[.6875rem] ms-1">
                            / Per Month
                          </sub>
                        </div>
                        <div className="mb-1 text-[#8c9097] dark:text-white/50">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iure quos debitis aliquam .
                        </div>
                        <div className="text-[0.75rem] mb-4">
                          <u>Billed Monthly</u>
                        </div>
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">1 GB</strong>Hard disk
                              storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">1 Year</strong>Email
                              support
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">5 GB</strong>Hard disk
                              storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">2 Years</strong>Email
                              support
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                  ...
                  <div className="box overflow-hidden border border-primary">
                    <div className="box-body !p-0">
                      ...
                      <div className="!p-6">
                        ...
                        <div className="text-[0.75rem] mb-4 text-dark">
                          <u>Billed Monthly</u>
                        </div>
                        <ul className="list-none mb-0">
                          <li className="flex items-center mb-4">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">20 GB</strong>Hard disk
                              storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">3 Years</strong>Email
                              support
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">30 GB</strong>Hard disk
                              storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1">5 Year</strong>Email
                              support
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
            ...
            <div
              className="tab-pane !p-0 !border-0 hidden"
            ...
            <div className="box overflow-hidden">
              <div className="box-body !p-0">
                <div className="tab-content" id="myTabContent">
                  <div
                    className="tab-pane show active !p-0 border-b-0 dark:border-defaultborder/10"
                        ...
                        <div className="p-6">
                          ...
                          <div className="py-4 flex items-center justify-center">
                            ...
                            <div className="text-end ms-5">
                              ...
                              <p className="text-[#8c9097] dark:text-white/50 opacity-50 text-[.6875rem] font-semibold mb-0">
                                per month
                              </p>
                            </div>
                          </div>
                          <ul className="list-none text-center text-[0.75rem] px-4 pt-4 mb-0">
                            <li className="mb-4">
                              <span className="text-[#8c9097] dark:text-white/50">
                                Storage Capacity
                                <span className="badge bg-light text-defaulttextcolor ms-1">
                                  1Tb
                                </span>
                              </span>
                            </li>
                  ...
                  <div
                    className="tab-pane !p-0 border-b-0 dark:border-defaultborder/10 hidden"
            ...
            <div className="flex justify-center">
              <div className="">
                ...
                <p className="text-[#8c9097] dark:text-white/50 text-center mb-6 text-[0.813rem]">
                  Select best plans that fits your needs for your business
                  growth,plans are flexible with the enterprise.Familiarize with
                  the payment plans below
                </p>
              </div>
            </div>
            <div className="box">
                  ...
                  <table className="table table-bordered dark:border-defaultborder/10 whitespace-nowrap min-w-full">
                    ...
                    <tbody>
                      ...
                      <tr className="border border-defaultborder dark:border-defaultborder/10">
                        ...
                        <td>
                          <span className="font-semibold">2 Free</span> Domain
                          names
                        </td>
                        <td>
                          <span className="font-semibold">5 Free</span> Domain
                          names
                        </td>
                        <td>
                          <span className="font-semibold">10 Free</span> Domain
                          names
                        </td>
                      </tr>
                      <tr className="border border-defaultborder dark:border-defaultborder/10">
                        ...
                        <td>
                          <span className="badge bg-success/10 text-success !p-1 leading-none !rounded-full">
                      ...
                      <tr className="border border-defaultborder dark:border-defaultborder/10">
                        ...
                        <td>
                          <span className="badge bg-danger/10 text-danger !p-1 leading-none !rounded-full">
                      ...
                      <tr className="border border-defaultborder dark:border-defaultborder/10">
                        <th scope="row">
                          <span className="font-bold text-[.875rem] text-start">
                            Net Price
                          </span>
                        </th>
                        <td>
                          <span className="text-[1.125rem] font-semibold text-dark">
                            $99
                          </span>
                        </td>
                        <td>
