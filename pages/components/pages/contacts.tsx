                ...
                <div className="sm:flex block items-center justify-between">
                  ...
                  <div className="flex sm:mt-0 mt-2 items-center">
                    <div className="input-group">
                      <input
                        type="text"
                        className="form-control !rounded-s-sm w-full !bg-light dark:!bg-light !border-0"
                    ...
                    <div className="hs-dropdown ti-dropdown ms-2">
                      <button
                        aria-label="button"
                        type="button"
                        className="ti-btn ti-btn-icon ti-btn-primary w-[2.313rem] h-[2.313rem]"
                        aria-expanded="false"
                      >
                    ...
                    <div className="hs-tooltip ti-main-tooltip">
                      <button
                        type="button"
                        className="hs-tooltip-toggle ti-btn ti-btn-icon ti-btn-secondary !ms-2 w-[2.313rem] h-[2.313rem]"
                      >
          ...
          <div className="box">
            <div className="box-body contact-action">
              ...
              <div className="flex items-center justify-center gap-2 contact-hover-buttons">
                <button
                  type="button"
                  className="ti-btn btn-sm ti-btn-light contact-hover-btn !py-1 !px-2 !text-[0.75rem] !font-medium"
                >
                  View Contact
                </button>
                <div className="hs-dropdown ti-dropdwon contact-hover-dropdown">
                  ...
                  <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                    <li>
                      <Link
                        className="ti-dropdown-item flex !gap-x-0 !px-[0.9375rem] !text-[0.8125rem] !font-medium"
                        href="#!"
                      >
                        <i className="ri-share-line me-2 align-middle inline-block"></i>
                        Share
                      </Link>
                    </li>
                    <li>
                      <Link
                        className="ti-dropdown-item flex !gap-x-0"
                        href="#!"
                      >
                        <i className="ri-phone-line me-2 align-middle inline-block"></i>
                        Call
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ri-chat-2-line me-2 align-middle inline-block"></i>
                        Message
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ri-video-chat-line me-2 align-middle inline-block"></i>
                        Video Call
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ri-delete-bin-5-line me-2 align-middle inline-block"></i>
                        Delete
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="ri ri-heart-3-line me-2 align-middle inline-block"></i>
                        Favourite
                      </Link>
                    </li>
                  </ul>
                ...
                <button
                  aria-label="button"
                  className="ti-btn !py-[0.14rem] !px-2 ti-btn-light contact-hover-dropdown1"
                  type="button"
                >
      ...
      <nav aria-label="Page navigation" className="mb-4">
        <ul className="ti-pagination !justify-end py-[0.375rem] px-3 text-[1rem] flex flex-row">
          <li className="page-item disabled">
            <Link className="page-link py-[0.375rem] px-3" href="#!">
              Previous
            </Link>
          </li>
