    ...
    <Fragment>
      <HelmetProvider>
        ...
        >
                ...
                <div className="grid grid-cols-12 gap-6">
                  <div className="xxl:col-span-7 xl:col-span-7 lg:col-span-6 col-span-12">
                    <div className="xl:py-[3rem]">
                      <div className="mb-4">
                        <h5 className="font-semibold text-white opacity-[0.9] text-[1.25rem]">
          ...
          <section
            className="section !bg-[#f9fafb] dark:!bg-black/10 section-bg text-defaulttextcolor dark:text-defaulttextcolor/70"
            id="statistics"
          >
          ...
          >
            <div className="container text-center">
              ...
              <h3 className="font-semibold mb-2 dark:text-defaulttextcolor dark:text-defaulttextcolor/70710">
                Designed with precision and well documented
              </h3>
              <div className="grid grid-cols-12 justify-center max-w-xl mx-auto">
                <div className="col-span-12">
                  <p className="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-4 font-normal">
              ...
              <div className="grid grid-cols-8 justify-center align-center">
                ...
                <div className="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 pt-5 pb-0 lg:px-2 !text-start px-12 my-auto">
                  <h5 className="lg:text-start font-semibold mb-0 text-[1.25rem]">
                  ...
                  <p className=" text-[#8c9097] dark:text-white/50 mb-4">
                    ...
                    damsenlel verman code Lorem ipsum, dolor sit amet
            ...
            <div className="container text-center">
              ...
              <div>
                <div className="xl:col-span-7">
                  <p className="text-[#8c9097] dark:text-white/50 text-sm mb-12 font-normal">
          ...
          <section
            className="section landing-Features text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]"
            id="features"
          >
            <div className="container text-center">
              <p className="text-[0.75rem] font-semibold text-success mb-1">
                ...
                <div className="justify-center">
                  <div className="">
                    <div className="feature-logos sm:mt-[3rem] flex-wrap">
                      ...
                      <div className="sm:ms-[3rem] ms-2 text-center">
                        <img
                          src="../../../assets/images/media/landing/web/8.png"
                          alt="image"
                          className="featur-icon"
                        />
                        <h5 className="mt-3 text-white text-[1.25rem] ">
          ...
          <section
            className="section landing-testimonials bg-[#f9fafb] section-bg text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]"
            id="testimonials"
          >
            <div className="container text-center">
              <p className="text-[0.75rem] font-semibold text-success mb-1">
              ...
              <div>
                <div className="xl:col-span-7 col-span-12">
                  <p className="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-[3rem] font-normal">
                    Some of the reviews our clients gave which brings motivation
                    to work for future projects.
                  </p>
                </div>
          ...
          >
            <div className="container text-center">
              ...
              <div>
                <div className="xl:col-span-7 col-span-12">
                  <p className="text-[#8c9097] dark:text-white/50 text-[0.9375rem] mb-12 font-normal">
                    Our team consists of highly qulified employees that works
                    hard to raise company standards.
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-12 gap-6">
              ...
              <div className="mt-[3rem]">
                <button type="button" className="ti-btn bg-primary text-white">
                  View All
                </button>
              </div>
            </div>
            ...
            <div className="container text-center">
              ...
              <div className="box overflow-hidden shadow-none justify-center">
                <div className="box-body !p-0">
                  <div
                    className="tab-content dark:!border-defaultborder/10"
                    id="myTabContent"
                  >
                    <div
                      className="tab-pane show active !p-0 dark:!border-defaultborder/10"
                          ...
                          <div className="p-6">
                            ...
                            <div className="py-6 flex items-center justify-center">
                              ...
                              <div className="text-end ms-[3rem]">
                                ...
                                <p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-0">
                                  per month
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12">
                          <div className="p-6 pricing-offer overflow-hidden">
                            ...
                            <div className="grid">
                              <button
                                type="button"
                                className="ti-btn bg-primary text-white !font-medium shadow"
                              >
                                Get Started
                              </button>
                            </div>
                    ...
                    <div
                      className="tab-pane !p-0 border dark:border-defaultborder/10 hidden"
                    ...
                    <div className="xl:col-span-6 col-span-12">
                      ...
                      >
                        <div className="hs-accordion-group">
                          <div
                            className="hs-accordion active bg-white dark:bg-bodybg  border dark:border-defaultborder/10 mt-[0.5rem] rounded-sm  dark:border dark:border-defaultborder/10-white/10"
                            id="faq-one"
                          >
                            <button
                              type="button"
