          ...
          <div className="box">
            <div className="box-body !p-0">
              <div className="p-4 grid border-b border-dashed dark:border-defaultborder/10">
                ...
                >
                  <i className="ri-add-circle-line !text-[1rem]"></i>Create New
                  Task
                </Link>
              ...
              <div className="p-4 task-navigation border-b border-dashed dark:border-defaultborder/10">
                <ul className="list-none task-main-nav mb-0">
                  ...
                  <li className="active">
                    <Link href="#!">
                      <div className="flex items-center">
                        ...
                        <span className="badge bg-success/10 text-success rounded-full">
                          167
                        </span>
                      </div>
                    </Link>
                  ...
                  <li className="!px-0 !pt-2">
                    <span className="text-[.6875rem] text-[#8c9097] dark:text-white/50 op-7 font-semibold">
                      CATEGORIES
                    </span>
                  </li>
                  <li>
          ...
          <div className="grid grid-cols-12 gap-x-6">
                  ...
                  <div className="md:flex px-4 py-6 items-center justify-between">
                    ...
                    <div className="mt-2 md:mt-0">
                      <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse flex-wrap">
                        <Link
                          className="w-full flex sm:w-auto active hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md py-2 px-3 text-sm"
                          href="#!"
                          id="alltasks-item"
                          data-hs-tab="#all-tasks"
                          aria-controls="all-tasks"
                        >
                          All Tasks
                        </Link>
                        <Link
                          className="w-full flex sm:w-auto hs-tab-active:font-semibold  hs-tab-active:text-primary hs-tab-active:bg-primary/10 rounded-md  py-2 px-3  text-sm"
                          href="#!"
                          id="pending-item"
                          data-hs-tab="#pending"
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="tab-content task-tabs-container">
                            ...
                            <div>
                              <p className="font-semibold mb-4 flex items-center">
                                <Link aria-label="anchor" href="#!">
                                  <i className="ri-star-s-fill text-[1rem] opacity-[0.5] me-1 text-[#8c9097] dark:text-white/50"></i>
                                </Link>
                            ...
                            <div>
                              <div className="btn-list">
                                ...
                                <button
                                  type="button"
                                  aria-label="button"
                                  className="ti-btn ti-btn-sm ti-btn-danger me-0"
                                >
                                  <i className="ri-delete-bin-line"></i>
                                </button>
                              </div>
                              <span className="badge bg-warning/10 text-warning block">
                                High
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="box-body">
                          <div className="flex justify-between flex-wrap gap-2">
                            ...
                            <div>
                              ...
                              <span className="badge bg-success/10 text-success block">
                                Low
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="box-body">
                          <div className="flex justify-between flex-wrap gap-2">
                            ...
                            <div>
                              ...
                              <span className="badge bg-primary/10 text-primary block">
                                Medium
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="box-body">
                          <div className="flex justify-between flex-wrap gap-2">
                            ...
                            <div>
                              ...
                              <span className="badge bg-danger/10 text-danger block">
                                Critical
                              </span>
                            </div>
                          </div>
                ...
                <div
                  className="tab-pane !p-0 hidden"
                  id="pending"
                  aria-labelledby="pending-item"
                  role="tabpanel"
                >
                  <div className="grid grid-cols-12 gap-6">
