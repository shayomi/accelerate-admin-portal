              ...
              <div className="xxl:col-span-6 xl:col-span-6 col-span-12">
                <div className="p-4 lg:p-0 text-start mb-6">
                  <h6 className="font-semibold text-white pb-6">
                    <span className="about-heading-white text-[1rem]">
                      About Us
                    </span>
                  </h6>
                  ...
                  <p className="mb-6 font-normal opacity-[0.7] text-[1rem]">
                    You fight like a younger man, there’s nothing held back.
                    It’s admirable, but mistaken. When their enemies were at the
                    gates the Romans would suspend democracy and appoint one man
                    to protect the city...
                  </p>
                  <button
                    type="button"
                          ...
                          <div>
                            ...
                            <p className="text-dark text-[2rem] mb-0">
                              <span className="count-up" data-count="136">
                                {" "}
                                <CountUp end={137} start={0} duration={4.94} />
                              </span>
                              +
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-dark text-[2rem] mb-0">
                              <span className="count-up" data-count="2499">
                                <CountUp end={2500} start={0} duration={4.94} />
                              </span>
                              +
                            </p>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-dark text-[2rem] mb-0">
                              <span className="count-up" data-count="21">
                                {" "}
                                <CountUp end={22} start={0} duration={4.94} />
                              </span>
                            </p>
                          </div>
                        </div>
        ...
        <div className="!max-w-[40rem] !justify-center !mx-auto !items-center mb-[3rem]">
          <div className="text-start">
            ...
            <p className="text-[.875rem] mb-6 text-[#8c9097] dark:text-white/50">
              ...
              consectetur adipisicing elit. Natus, aliquam voluptas repellat eum
              beatae veniam, cumque eligendi earum praesentium, in corrupti
              reprehenderit cum architecto quisquam? Quibusdam quaerat veritatis
              perferendis iusto. !
            </p>
            <div>
