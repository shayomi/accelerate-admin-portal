import {
  ...
  Myfilesdata,
  Recentdata,
} from "@/shared/data/pages/filemanager/filemanagerdata";
  ...
  return (
    <Fragment>
      ...
      <div className="file-manager-container p-2 gap-2 sm:!flex !block text-defaulttextcolor text-defaultsize">
        <div
          className={`file-manager-navigation ${isFileManagerOpen ? "close" : ""}`}
        >
              ...
              >
                ...
                <li className="mb-8">
                  <div className="text-[#8c9097] dark:text-white/50 mb-2">
                    <p className="mb-1">
                      <span className="font-bold text-[.875rem]">69.42GB</span>{" "}
                      Used
                    </p>
                    <p className="text-[.75rem] mb-0">
                      58% Used - 51.04Gb free
                    </p>
                  </div>
                ...
                <div className="table-responsive border border-bottom-0 dark:border-defaultborder/10">
                  <table className="table whitespace-nowrap table-hover min-w-full">
                    ...
                    <tbody className="files-list">
                      {Recentdata.map((idx) => (
                        <tr
                          className="border border-inherit border-solid border-x-0 hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light"
                          key={Math.random()}
        ...
        <div
          className={`selected-file-details ${isFileManagerOpen1 ? "open" : ""}`}
        >
