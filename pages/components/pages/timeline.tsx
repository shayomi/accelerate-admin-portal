                  ...
                  <div className="flex items-center">
                    <div className="sm:mt-0 mt-2">
                      ...
                      <p className="mb-0 text-[#8c9097] dark:text-white/50">
                        ...
                        <span className="badge bg-primary/10 text-primary font-semibold mx-1">
                          files
                        </span>
                        and
                        <span className="badge bg-primary/10 text-primary font-semibold mx-1">
                  ...
                  <div className="flex items-center">
                    <div className="sm:mt-0 mt-2">
                      ...
                      <p className="mb-0 text-[#8c9097] dark:text-white/50">
                        ...
                        <span className="badge bg-danger/10 text-danger font-semibold mx-1">
                          deleted
                        </span>{" "}
                  ...
                  <div className="flex items-center">
                    <div className="sm:mt-0 mt-2">
                      ...
                      <p className="mb-0 text-[#8c9097] dark:text-white/50">
                        ...
                        <i className="ri-checkbox-circle-line text-success ms-1 text-[1rem] align-middle"></i>
                      </p>
                    </div>
                    <div className="ms-auto">
                      <span className="ltr:float-right rtl:float-left badge !bg-light text-[#8c9097] dark:text-white/50 timeline-badge whitespace-nowrap">
                  ...
                  <div className="flex items-center">
                    <div className="sm:mt-0 mt-2">
                      ...
                      <p className="mb-0 text-[#8c9097] dark:text-white/50">
                        ...
                        <span className="badge bg-success/10 text-success font-semibold mx-1">
                          login
                        </span>{" "}
                        details
                      </p>
