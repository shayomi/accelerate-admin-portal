import {
  Exploretopicsdata,
  Populartagsdata,
} from "@/shared/data/pages/blogs/blogdetailsdata";
      ...
      <div className="container my-[3rem]">
        <div className="grid grid-cols-12 sm:gap-x-6">
          <div className="xl:col-span-8  col-span-12">
            <div className="box">
              <div className="box-body">
                <p className="text-[1.125rem] font-semibold mb-1">
                  Touring excites in winter when we travel with friends !
                </p>
              ...
              <div className="box-body">
                ...
                <p className="mb-6 text-[#8c9097] dark:text-white/50">
                  ...
                  used to walk down a little lane way to the train station on my
                  commute to work. It’s not an especially beautiful lane way
                </p>
                <p className="mb-[3rem] text-[#8c9097] dark:text-white/50">
                  The world is animated by the wind. This invisible, mysterious
                  force can bring a landscape alive. Its absence can cast a calm
                  stillness over the earth. On barren mountain tops its power is
                  barely perceptible; in forests and seas its presence becomes
                  manifest. Winds are wild, and sometimes destructive. When we
                  look deeply into the surely gravity’s law, strong as an ocean
                  current, takes hold of even the strongest thing and pulls it
                  toward the heart of the world. Each thing- each stone,
                  blossom, child – is held in place. Only we, in our arrogance,
                  push out beyond what we belong to for some empty freedom. If
                  we surrendered
                </p>
                <div className="box !bg-light !mb-[3rem] shadow-none">
                  ...
                  <div className="box-body">
                    <blockquote className="blockquote mb-0 text-center">
                      <p className="text-[1rem] font-semibold mb-2 text-dark">
                        In nature, nothing is perfect and everything is perfect.
                        Trees can be contorted, bent in weird ways, and they're
                        still beautiful..
                      </p>
                      <footer className="text-[#6c757d] mt-2 text-[.875rem] opacity-[0.7]">
                        Someone famous as{" "}
                ...
                <p className="mb-[3rem] text-[#8c9097] dark:text-white/50">
                  ...
                  these 101 quotes about nature will have you itching to get off
                  your couch and get outside. For famous{" "}
            ...
            <div className="box">
              <div className="box-header">
                <div className="box-title">Leave a Comment</div>
              </div>
              <div className="box-body">
          ...
          <div className="xl:col-span-4 col-span-12">
            <div className="box">
              <div className="box-body text-center !p-6">
                ...
                <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-1">
                  <span>emaileyjackson2134</span>@gmail.com
                </p>
            ...
            <div className="box">
              <div className="box-header">
                <div className="box-title">Newsletter</div>
              </div>
              <div className="box-body">
                <div className="text-center">
                  <h6 className="font-semibold mb-4 text-[1rem]">
                    <span className="text-primary text-[1.125rem]">1658</span>{" "}
                    Subscribers
                  </h6>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control dark:bg-bodybg !rounded-s-md"
            ...
            <div className="box">
              <div className="box-header">
                <div className="box-title">Explore Topics</div>
              </div>
              <div className="box-body">
                    ...
                    <li className="list-group-item" key={Math.random()}>
                      <Link href="#!">
                        <div className="flex items-center justify-between">
                          ...
                          <div>
                            <span className="badge bg-light text-default !rounded-full">
                              {idx.badge}
                            </span>
                          </div>
                        </div>
            ...
            <div className="box">
              <div className="box-header">
                <div className="box-title">Popular Tags</div>
              </div>
              <div className="box-body">
                <div className="blog-popular-tags">
                  {Populartagsdata.map((idx) => (
                    <Link href="#!" key={Math.random()}>
                      <span className="badge bg-light text-[#8c9097] dark:text-white">
                        {idx.text}
                      </span>
                    </Link>
                  ))}
