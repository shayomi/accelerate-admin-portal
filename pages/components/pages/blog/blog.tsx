import {
  Populartopics,
  Populartopics1,
} from "@/shared/data/pages/blogs/blogdata";
        ...
        <div className="grid grid-cols-12 gap-x-6">
                      ...
                      <Link href="#!">
                        ...
                        <div className="blog-caption text-start">
                          <p className="mb-2 text-xs">
                            The agency has a diverse workforce of just under
                            18,000 civil servants, and works with many more U.S.
                          </p>
                  ...
                  <SwiperSlide>
                    <div className="rtl:dir-rtl">
                      <Link href="#!">
                        ...
                        <div className="blog-caption text-start">
                          <p className="mb-2 text-xs">
                            NASA is committed to providing all categories of
                            businesses in both NASA prime contracts and
                            subcontracts.
                          </p>
                          <h6 className="text-base font-semibold mb-2">
                            NASA Businesses
                  ...
                  <SwiperSlide>
                    <div className="rtl:dir-rtl">
                      <Link href="#!">
                        ...
                        <div className="blog-caption text-start">
                          <p className="mb-2 text-xs">
                            NASA Nelson served in the U.S. Senate for 18 years
                            from Florida space shuttle mission 61-C in 1986.
                          </p>
                          <h6 className="text-base font-semibold mb-2">
                            NASA Leadership
                          </h6>
              ...
              <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                <div className="box">
                  ...
                  <div className="box-body">
                    <Link
                      href="/components/pages/blog/blog-details/"
                      className="font-semibold text-[0.875rem] text-dark mb-1"
                    >
                      Touring excites in winter !
                    </Link>
                    <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-[#8c9097] dark:text-white/50 text-[.625rem] mb-0">
                            20,Dec 2022 - 16:32
                          </p>
                        </div>
                      </div>
              ...
              <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                <div className="box">
                  ...
                  <div className="box-body">
                    ...
                    >
                      {" "}
                      Boat manufacutrers are in debt !
                    </Link>
                    <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">
          ...
          <div className="xl:col-span-12 col-span-12">
            <div className="flex justify-between items-center mb-3">
              <h5 className="mb-0 font-semibold text-[1.25rem] text-defaulttextcolor">
                Popular Topics
              </h5>
                    ...
                    <div className="box !bg-black/20 overlay-card text-white">
                      ...
                      <div className="card-img-overlay flex flex-column p-0 over-content-bottom">
                        <div className="box-footer border-t-0">
                          <h6 className="font-semibold mb-0 text-white text-[1rem]">
                            {idx.text}
                          </h6>
                        </div>
                      </div>
                  ...
                  <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                    <div className="box">
                      ...
                      <div className="box-body">
                        ...
                        <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">
                          The holographic principle, theorized to be a property
                          of quantum gravity, postulates that the description.
                        </p>
                        <Link
                          href="#!"
                          className="ti-btn ti-btn-primary !font-medium !mb-0"
                    ...
                    <div className="box">
                      ...
                      <div className="box-body">
                        <Link
                          ...
                          className="font-semibold text-[0.875rem] text-dark mb-1"
                        >
                          Beautiful beach on a sunny day !
                        </Link>
                        <p className="card-text text-[#8c9097] dark:text-white/50 mb-3">
                          The holographic principle, theorized to be a property
                          of quantum gravity, postulates that the description.
              ...
              <div className="xl:col-span-6 xxl:col-span-4 col-span-12">
                <div className="box">
                  <div className="box-header flex items-center justify-between">
                    <div className="box-title">Featured Blogs</div>
                    <div>
