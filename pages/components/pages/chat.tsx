      ...
      <div className="main-chart-wrapper p-2 gap-2 lg:flex">
        <div className="chat-info border dark:border-defaultborder/10">
          ...
          >
            ...
            >
              <i className="ri-history-line me-1 align-middle inline-block cursor-pointer w-[1.875rem] h-[1.875rem] ps-2 pt-1 rounded-full hs-tab-active:bg-primary/10 bg-light"></i>
              Recent
            </Link>
            <Link
              href="#!"
            ...
            >
              <i className="ri-group-2-line me-1 align-middle inline-block w-[1.875rem] h-[1.875rem] ps-2 pt-1 rounded-full hs-tab-active:bg-primary/10 bg-light"></i>
              Groups
            </Link>
            <Link
              href="#!"
            ...
            >
              <i className="ri-phone-line me-1 align-middle inline-block w-[1.875rem] h-[1.875rem] ps-2 pt-1 rounded-full hs-tab-active:bg-primary/10 bg-light"></i>
              Calls
            </Link>
          </nav>
          <div className="tab-content overflow-scroll" id="myTabContent">
            ...
            >
              ...
              >
                <li className="!pb-0 !pt-0">
                  <p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-2 opacity-[0.7]">
                    ACTIVE CHATS
                  </p>
                </li>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-[0.75rem] mb-0">
                          ...
                          <span className="chat-read-icon ltr:float-right rtl:float-left align-middle">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-[0.75rem] mb-0 chat-msg-typing ">
                          ...
                          <span className="badge bg-success/10 !rounded-full text-success ltr:float-right rtl:float-left">
                            2
                          </span>
                        </p>
                      </div>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-[0.75rem] mb-0">
                          <span className="chat-msg text-truncate">
                            You are need to be appreaciated for what you have
                            done,congs
                          </span>
                          <span className="chat-read-icon ltr:float-right rtl:float-left align-middle">
                            <i className="ri-check-double-fill"></i>
            ...
            >
              <ul className="list-none mb-0 mt-2">
                <li className="!pb-0">
                  <p className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] font-semibold mb-1 opacity-[0.7]">
                    MY CHAT GROUPS
                  </p>
                </li>
                <li>
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-[0.75rem] mb-0">
                          <span className="chat-msg text-truncate">
                            <span className="group-indivudial">Rams:</span>Happy
                  ...
                  <li>
                    <div className="flex items-center">
                      ...
                      <div className="flex-grow my-auto">
                        ...
                        <p className="text-[0.75rem] !mb-0">
                          <span className="text-[#8c9097] dark:text-white/50 text-truncate">
                            Today,12:47PM
                          </span>
                        </p>
                      </div>
        ...
        <PerfectScrollbar
          className="chat-user-details border dark:border-defaultborder/10"
            ...
            <ul className="shared-files list-none">
                ...
                <div className="flex items-center">
                  ...
                  <div className="!text-[1.125rem]">
                    <Link aria-label="anchor" href="#!">
                      <i className="ri-download-2-line text-[#8c9097] dark:text-white/50"></i>
                    </Link>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <div className="">
                    <Link aria-label="anchor" href="#!">
                      <i className="ri-download-2-line text-[#8c9097] dark:text-white/50 !text-[1.125rem]"></i>
                    </Link>
                  </div>
                </div>
              </li>
