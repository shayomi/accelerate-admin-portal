...
const Mailapp = () => {
  ...
  const [isMailsInformationVisible, setMailsInformationVisible] =
    useState(false);
        ...
        <div className="main-mail-container !p-2 gap-x-2 flex">
          ...
          >
            <div className="grid items-start !p-4 border-b dark:border-defaultborder/10">
              ...
              >
                <i className="ri-add-circle-line text-[1rem] align-middle"></i>
                Compose Mail
              </Link>
                      ...
                      <div className="grid grid-cols-12 gap-6">
                        <div className="xl:col-span-6 col-span-12 mb-2">
                          <label htmlFor="fromMail" className="form-label">
                            From
                            <sup className="top-[0.5em]">
                              <i className="ri-star-s-fill text-success text-[0.5rem]"></i>
                            </sup>
                          </label>
                          <input
                            type="email"
                  ...
                  <li>
                    <Link href="#!">
                      <div className="flex items-start leading-none">
                        ...
                        <div>
                          <p className="text-defaulttextcolor font-semibold mb-1">
                            Angelica
                          </p>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-grow">
                          ...
                          <p className="mail-msg mb-0">
                            <span className="block mb-0 font-semibold ">
                              {idx.title}
                            </span>
                            <span className="text-[.6875rem] text-[#8c9097] dark:text-white/50 text-wrap ">
          ...
          >
            <div className="mail-info-header flex flex-wrap gap-2 items-center">
              ...
              <div className="flex-grow">
                <h6 className="mb-0 font-semibold text-[1rem] dark:text-defaulttextcolor/70">
                  Michael Jeremy
                </h6>
                  ...
                  <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="inline-flex ri-star-line me-1 align-middle"></i>
                        Starred
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="inline-flex ri-inbox-archive-line me-1 align-middle"></i>
                        Archive
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="inline-flex ri-spam-2-line me-1 align-middle"></i>
                        Report Spam
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="inline-flex ri-delete-bin-line me-1 align-middle"></i>
                        Delete
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        href="#!"
                      >
                        <i className="inline-flex ri-reply-line me-1 align-middle"></i>
                        Reply
                      </Link>
                    </li>
                  </ul>
            ...
            >
              <div className="sm:flex block items-center justify-between mb-6">
                <div>
                  <p className="text-[1.25rem] font-semibold mb-0">
                    History of planets are discovered yesterday.
                  </p>
                </div>
                <div className="ltr:float-right rtl:float-left">
                  <span className="me-2 text-[0.75rem] text-[#8c9097] dark:text-white/50">
                    Oct-22-2022,03:05PM
                  </span>
                </div>
              </div>
              ...
              <div className="mail-attachments mb-6">
                ...
                <div className="mt-2 flex items-center flex-wrap">
                  ...
                  <Link
                    aria-label="anchor"
                    href="#!"
                    className="!w-[2.75rem] !h-[2.75rem] ti-btn-icon ti-btn-outline-light dark:hover:!bg-light  flex items-center justify-center !rounded-md dark:!border-defaultborder/10 !ms-2 !text-[1.2rem] !text-defaulttextcolor dark:!text-defaulttextcolor/70 border"
                  >
              ...
              <div className="mb-4">
                <span className="text-[.875rem] font-semibold">
                  <i className="ri-reply-all-line me-1 align-middle inline-block"></i>
                  Reply:
                </span>
              </div>
            ...
            <div className="mail-info-footer  dark:!border-defaultborder/10 flex flex-wrap gap-2 items-center justify-between">
              ...
              <div className="space-x-2 rtl:space-x-reverse">
                <button type="button" className="ti-btn ti-btn-secondary-full">
                  <i className="ri-share-forward-line me-1 inline-block align-middle"></i>
                  Forward
                </button>
                <button
                  type="button"
                ...
                >
                  <i className="ri-reply-all-line me-1 inline-block align-middle"></i>
                  Reply
                </button>
              </div>
            </div>
