        ...
        <div className="xl:col-span-9 col-span-12">
          <div className="box">
            <div className="box-header md:flex block">
              <div className="h5 mb-0 sm:flex bllock items-center">
                ...
                <div className="sm:ms-2 ms-0 sm:mt-0 mt-2">
                  <div className="h6 font-semibold mb-0 ">
                    SHOPPING INVOICE :{" "}
              ...
              <div className="ms-auto md:mt-0 mt-2">
                <button
                  type="button"
                  className="ti-btn !py-1 !px-2  text-white !text-[0.75rem] bg-secondary me-2"
                  onClick={() => print()}
                >
                  Print
                  <i className="ri-printer-line ms-1 align-middle inline-block"></i>
                </button>
                <button
                  type="button"
                  className="ti-btn !py-1 !px-2 text-white !text-[0.75rem] bg-primary"
                >
                  Save As PDF
            ...
            <div className="box-body">
              <div className="grid grid-cols-12 gap-4">
                <div className="xl:col-span-12 col-span-12">
                  <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                    ...
                    <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12 sm:ms-auto sm:mt-0 mt-4">
                      ...
                      <p className="font-bold mb-1">Json Taylor</p>
                ...
                <div className="xl:col-span-3 col-span-12">
                  <p className="font-semibold text-[#8c9097] dark:text-white/50 mb-1">
                    Invoice ID :
                  </p>
                ...
                <div className="xl:col-span-3 col-span-12">
                  ...
                  <p className="text-[.9375rem] mb-1">
                    29,Nov 2022 -{" "}
                    <span className="text-[#8c9097] dark:text-white/50 text-xs">
                      12:42PM
                    </span>
                  </p>
                </div>
                            ...
                            <table className="table table-sm whitespace-nowrap mb-0 table-borderless w-full">
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <p className="mb-0 font-semibold text-[.9375rem]">
                                      $2,364
                                    </p>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <p className="mb-0 font-semibold text-[1rem] text-success">
                                      $2,570.42
                                    </p>
                                  </td>
                                </tr>
            ...
            <div className="box-footer text-end">
              <button type="button" className="ti-btn bg-success text-white">
                Download{" "}
              ...
              <div className="grid grid-cols-12 gap-4">
                <div className="xl:col-span-12 col-span-12">
                  ...
                  <p className="mb-4">
                    ...
                    <span className="text-success font-semibold text-[.875rem]">
                      $2570.42
                    </span>
                  </p>
                  <p className="mb-4">
                    ...
                    29,Dec 2022 -{" "}
                    <span className="text-danger text-[0.75rem] font-semibold">
                      30 days due
                    </span>
                  </p>
                  <p className="mb-4">
