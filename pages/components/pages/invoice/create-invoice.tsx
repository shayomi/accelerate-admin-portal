        ...
        <div className="xl:col-span-9 col-span-12">
          <div className="box">
            <div className="box-header xxl:!flex !block">
              <div className="h5 mb-0 sm:flex block items-center">
                ...
                <div className="sm:ms-2 ms-0 sm:mt-0 mt-2">
                  <input
                    type="text"
                    className="form-control !text-[.8rem] !py-1 !px-[0.8rem] !bg-light !rounded-md"
              ...
              <div className="ms-auto xxl:!mt-0 !mt-2">
                <button
                  type="button"
                  className="ti-btn !py-1 !px-2 bg-primary text-white !text-[0.75rem] me-2"
                >
                  Save As PDF
                  <i className="ri-file-pdf-line ms-1 align-middle inline-block"></i>
                </button>
                <button
                  aria-label="button"
                  type="button"
                  className="ti-btn ti-btn-sm ti-btn-secondary me-2"
                >
                ...
                <button
                  aria-label="button"
                  type="button"
                  className="ti-btn ti-btn-sm ti-btn-success me-2"
                >
            ...
            <div className="box-body">
              <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                <div className="xl:col-span-12 col-span-12">
                  <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                    <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
                      <p className="font-semibold mb-2">Billing From :</p>
                    ...
                    <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12 sm:mt-0 mt-4">
                      <p className="font-semibold mb-2">Billing To :</p>
                      <div className="grid grid-cols-12 gap-2">
                        ...
                        <div className="xl:col-span-12 col-span-12 choices-control">
                          <p className="font-semibold mb-2 mt-2">Currency :</p>
                          <Select
                            options={Currencyoptions}
                            classNamePrefix="Select2"
                            menuPlacement="auto"
                            className="w-full !rounded-md !bg-light"
                ...
                <div className="xl:col-span-3 col-span-12">
                  ...
                  <input
                    type="text"
                    className="form-control !leading-none w-full !rounded-md !bg-light"
                    id="invoice-number"
                    placeholder="Inv No"
                ...
                <div className="xl:col-span-3 col-span-12">
                  ...
                  <input
                    type="text"
                    className="form-control w-full !leading-none !rounded-md !bg-light"
                    ...
                    <table className="table whitespace-nowrap border dark:border-defaultborder/10 mt-3">
                      <thead>
                        <tr>
                          ...
                          <th scope="row" className="min-w-[120px]">
                            QUANTITY
                          </th>
                      ...
                      <tbody>
                        <tr className="border border-defaultborder dark:border-defaultborder/10">
                          <td>
                            <input
                              type="text"
                              className="form-control !w-auto !rounded-md !bg-light"
                          ...
                          <td className="invoice-quantity-container">
                            <div className="input-group dark:border-defaultborder/10 rounded-md !flex-nowrap">
                              <button
                                aria-label="button"
                                type="button"
                                className="ti-btn ti-btn-icon !bg-primary !text-white input-group-text !mb-0 product-quantity-minus !rounded-e-none"
                                onClick={dec}
                              >
                              ...
                              <input
                                type="text"
                                className="form-control  text-center !w-12 !p-1"
                                aria-label="quantity"
                              ...
                              <button
                                aria-label="button"
                                type="button"
                                className="ti-btn ti-btn-icon !bg-primary !text-white input-group-text !mb-0 product-quantity-plus !rounded-s-none"
                                onClick={inc}
                              >
                          ...
                          <td className="invoice-quantity-container">
                            <div className="input-group dark:border-defaultborder/10 rounded-md  !flex-nowrap">
                              <button
                                aria-label="button"
                                type="button"
                                className="ti-btn ti-btn-icon !bg-primary !text-white input-group-text flex-fill !mb-0 product-quantity-minus !rounded-e-none"
                                onClick={dec}
                              >
                                <i className="ri-subtract-line"></i>
                              </button>
                              ...
                              <button
                                aria-label="button"
                                type="button"
                                className="ti-btn ti-btn-icon !bg-primary !text-white input-group-text flex-fill !mb-0 product-quantity-plus !rounded-s-none"
                                onClick={inc}
                              >
                                <i className="ri-add-line"></i>
                              </button>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <input
                                      type="text"
                                      className="form-control w-full !rounded-md !bg-light invoice-amount-input"
                                      placeholder="Enter Amount"
            ...
            <div className="box-footer text-end">
              <button
                type="button"
                className="ti-btn ti-btn-light sm:me-2 !mb-2 sm:!mb-0 "
              >
                <i className="ri-eye-line me-1 align-middle inline-block"></i>
                Preview
              </button>
              <button
                type="button"
              ...
              <div className="grid grid-cols-12 gap-4">
                <div className="xl:col-span-12 col-span-12">
                  ...
                  >
                    ...
                    />
                    <label
                      className="ti-btn ti-btn-outline-light dark:text-defaulttextcolor/70 dark:!border-defaultborder/10 !border-e-0  sm:mt-0 mt-1 !rounded-e-none hover:!bg-light "
                      htmlFor="btnradio2"
                    >
                      UPI
                    </label>
                    ...
                    />
                    <label
                      className="ti-btn ti-btn-light sm:mt-0 mt-1 dark:text-defaulttextcolor/70 dark:!border-defaultborder/10 !rounded-s-none hover:!bg-light"
                      htmlFor="btnradio3"
                    >
                      Credit/Debit Card
                    </label>
                ...
                <div className="xl:col-span-12 col-span-12">
                  ...
                  >
                    <Link className="text-danger text-[0.6875rem]" href="#!">
                ...
                <div className="xl:col-span-12 col-span-12">
                  <input
                    type="text"
                    className="form-control w-full !rounded-md !bg-light mb-2"
                    placeholder="Enter OTP"
                  />
                </div>
                <div className="xl:col-span-12 col-span-12">
                  <div
                    className="alert alert-success !border-success/10"
                    role="alert"
                  >
