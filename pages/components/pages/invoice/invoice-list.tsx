                  ...
                  <div className="pb-0 mt-0">
                    <div>
                      <h4 className="text-[1.125rem] font-semibold mb-2">
                        $
                        <span className="count-up" data-count="192">
                          <CountUp end={192} start={0} duration={4.94} />
                        </span>
                        .87k
                      </h4>
              ...
              <div className="p-6 border-b border-dashed dark:border-defaultborder/10 flex items-start">
                ...
                <div className="flex-grow">
                  ...
                  <div>
                    <h4 className="text-[1.125rem] font-semibold mb-2">
                      $
                      <span className="count-up" data-count="68.83">
                        <CountUp end={68.83} start={0} duration={4.94} />
                      </span>
                      K
                    </h4>
                    <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
              ...
              <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                ...
                <div className="flex-grow">
                  ...
                  <div>
                    <h4 className="text-[1.125rem] font-semibold mb-2">
                      $
                      <span className="count-up" data-count="81.57">
                        <CountUp end={81.57} start={0} duration={4.94} />
                      </span>
                      K
                    </h4>
                    <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
              ...
              <div className="flex items-start p-6 border-b dark:border-defaultborder/10 border-dashed">
                <div className="svg-icon-background !bg-light me-6">
                  <svg
                    ...
                    enableBackground="new 0 0 24 24"
                    viewBox="0 0 24 24"
                    className="svg-dark dark:fill-white"
                  >
                    <path d="M19,12h-7V5c0-0.6-0.4-1-1-1c-5,0-9,4-9,9s4,9,9,9s9-4,9-9C20,12.4,19.6,12,19,12z M12,19.9c-3.8,0.6-7.4-2.1-7.9-5.9C3.5,10.2,6.2,6.6,10,6.1V13c0,0.6,0.4,1,1,1h6.9C17.5,17.1,15.1,19.5,12,19.9z M15,2c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h6c0.6,0,1-0.4,1-1C22,5.1,18.9,2,15,2z M16,8V4.1C18,4.5,19.5,6,19.9,8H16z" />
                  </svg>
                </div>
                <div className="flex-grow">
                  ...
                  <div>
                    <h4 className="text-[1.125rem] font-semibold mb-2">
                      $
                      <span className="count-up" data-count="32.47">
                        <CountUp end={32.47} start={0} duration={4.94} />
                      </span>
                      K
                    </h4>
                    <p className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0 leading-none">
