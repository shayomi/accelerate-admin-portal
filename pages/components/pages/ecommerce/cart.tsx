        ...
        <div className="xxl:col-span-9 col-span-12">
          <div className="box" id="cart-container-delete">
            <div className="box-header">
              <div className="box-title">Cart Items</div>
            </div>
                      ...
                      <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                          ...
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <div className="mb-1 flex items-center align-middle">
                                ...
                                <span className="font-semibold text-[#8c9097] dark:text-white/50">
                                  Grey
                                  <span className="badge bg-success/10 text-success ms-4">
                                    In Offer
                                  </span>
                                </span>
                              </div>
                        ...
                        <td className="product-quantity-container">
                          <div className="input-group dark:border-defaultborder/10 rounded-md !flex-nowrap">
                            <button
                              onClick={() => decrementQuantity(idx.id)}
                              aria-label="button"
                              type="button"
                              className="!border-0 ti-btn ti-btn-icon ti-btn-light  input-group-text flex-grow product-quantity-minus !mb-0"
                            >
                            ...
                            />
                            <button
                              onClick={() => incrementQuantity(idx.id)}
                              aria-label="button"
                              type="button"
                              className="!border-0 ti-btn ti-btn-icon ti-btn-light input-group-text flex-grow product-quantity-plus !mb-0"
                            >
          ...
          <div className="box !hidden" id="cart-empty-cart">
            ...
            <div className="box-body flex items-center justify-center">
              <div className="cart-empty text-center">
                ...
                <h5 className="mb-4 text-[1.25rem]">
            ...
            <div className="box-body !p-0">
              <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                ...
                >
                  ...
                  />
                  <label
                    className="ti-btn ti-btn-outline-light !text-defaulttextcolor dark:hover:!bg-light dark: !border-defaultborder/10 dark:text-defaulttextcolor/70 !border-e-0 dark:!border-defaultborder/10 !rounded-e-none !font-medium"
                    htmlFor="btnradio1"
                  >
                    Free Delivery
                  </label>
                  ...
                  />
                  <label
                    className="ti-btn ti-btn-light dark:!border-defaultborder/10  dark:text-defaulttextcolor/70 dark:hover:!bg-light !font-medium !rounded-s-none"
                    htmlFor="btnradio2"
                  >
                    Express Delivery
                  </label>
                </div>
                <p className="mb-0 mt-2 text-[0.75rem] text-[#8c9097] dark:text-white/50">
              ...
              <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                ...
                <Link href="#!" className="text-[0.75rem] text-success">
              ...
              <div className="p-4 grid">
                <Link
                  ...
                  className="ti-btn bg-primary  text-white !font-medium !mb-2"
                >
                  Proceed To Checkout
                </Link>
                <Link
