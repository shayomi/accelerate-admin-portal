                    ...
                    <div className="xl:col-span-8 col-span-12 xxl:mt-0 mt-4">
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-[#8c9097] dark:text-white/50 mb-0">
                          ...
                          reiciendis harum reprehenderit omnis tempora adipisci
                          in iste aperiam unde, repellendus possimus explicabo
                          veritatis? Dignissimos, id.
                        </p>
                      </div>
                      <div className="mb-4">
                            ...
                            <div className="border p-4 dark:border-defaultborder/10">
                              ...
                              <div className="sm:ps-4 ps-0 mb-4">
                                ...
                                <p className="mb-0 text-[0.75rem] text-[#8c9097] dark:text-white/50 ps-2">
                                  ...
                                  best for daily use... It supports Spo2.. Very
                                  well..{" "}
                                </p>
                              </div>
                      ...
                      <div className="mb-[3rem]">
                        <div className="offer-promotion dark:border-defaultborder/10 mb-6">
                          <div className="xxl:flex flex lg:block sm:flex flex-wrap justify-between items-center">
                            <div className="text-warning xxxl:mb-0 mb-2">
                              Use Code{" "}
                              <span className="promotion-code font-semibold">
                                FIRBUY
                              </span>
                              <Link
