          ...
          <div className="box">
            <div className="box-body sm:flex items-center justify-between">
              ...
              <div className="flex mt-2 sm:mt-0" role="search">
                <input
                  className="form-control form-control-sm me-2 !rounded-sm"
                  type="search"
                  placeholder="Search"
                  aria-label="Search"
                  onChange={(ele) => {
                ...
                />
                <button
                  className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-light"
                  type="submit"
                >
                  Search
                </button>
                ...
                <div className="box product-card">
                  <div className="box-body">
                    <Link href="#!" className="product-image">
                      <img
                        src={idx.preview}
                        className="card-img mb-3 rounded-sm"
                        alt="..."
                      />
                    </Link>
                    ...
                    <p className="mb-1 font-semibold text-[1rem] flex items-center justify-between">
                      <span>
                        {idx.oldpr}
                        <span className="text-[#8c9097] dark:text-white/50 line-through ms-1 opacity-[0.6] inline-block">
                          {idx.newpr}
                        </span>
                      </span>
                      <span className="badge bg-secondary/10 text-secondary ltr:float-right rtl:float-left !text-[.625rem]">
                        {idx.percentage}
                      </span>
                    </p>
                    <p className="text-[.6875rem] text-success font-semibold mb-0 flex items-center">
                      <i className="ti ti-discount-2 text-[1rem] me-1"></i>Offer
                  ...
                  <div className="box-footer text-center ">
                    <Link
                      ...
                      className="ti-btn ti-btn-primary m-2 !font-medium"
                      onClick={() => {
                        AddToCart(idx.id);
                      }}
                    >
                      <i className="ri-shopping-cart-2-line me-1 align-middle inline-block "></i>
                      Move To Cart
                    </Link>
                    <Link
                      href="/components/pages/ecommerce/product-details/"
                      className="ti-btn ti-btn-success m-2 !font-medium"
                    >
