    ...
    <Fragment>
      ...
      <div className="grid grid-cols-12 gap-x-6">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="mb-1">
                              ...
                              <span className="text-[#8c9097] dark:text-white/50">
                                Orange
                                <span className="badge text-white bg-info ms-3">
                                  32% Off
                                </span>
                              </span>
                            </div>
            ...
            <div className="box-footer border-t-0">
              <div className="btn-list ltr:float-right rtl:float-left">
                <button
                  ...
                  onClick={() => print()}
                >
                  <i className="ri-printer-line me-1 align-middle inline-block"></i>
                  Print
                </button>
                <button
                  aria-label="button"
        ...
        <div className="xl:col-span-3 col-span-12">
          <div className="box">
              ...
              <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    aria-label="button"
                    type="button"
                    className="ti-btn bg-primary ti-btn-sm text-white"
                  >
            ...
            <div className="box-footer">
              Total
              <span className="text-success"> 294 items</span> purchased upto
              now
            </div>
          </div>
        </div>
        <div className="xl:col-span-3 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Order Tracking</div>
                ...
                >
                  <div className="hs-accordion active" id="order-heading-one">
                    ...
                    >
                      <div className="flex mb-0">
                        ...
                        <div className="flex-grow">
                          <p className="font-semibold mb-0 text-[0.875rem]">
                            Order Placed
                          </p>
                    ...
                    >
                      <div className="flex mb-0">
                        <div className="me-2">
                          <span className="avatar avatar-md avatar-rounded">
                            <img
                              src="../../../../assets/images/ecommerce/png/34.png"
                              alt=""
                            />
                          </span>
                        </div>
                    ...
                    >
                      <div className="accordion-body !pt-0 !ps-8">
                        <div className="text-[0.6875rem] mb-4 ps-4">
                          ...
                          <span className="text-[#8c9097] dark:text-white/50 opacity-[0.5]">
                            Nov 03, 2022, 15:36
                          </span>
                        </div>
                        <div className="text-[0.6875rem] mb-4 ps-4">
                        ...
                        <div className="text-[0.6875rem] ps-4">
                          <p className="mb-0">
                            Arrived in Hyderabad and expected Delivery is{" "}
                            <span className="font-weight-semibold">
                              Apr 16, 2022
                            </span>{" "}
                          </p>
                  ...
                  <div className="hs-accordion" id="order-heading-four">
                    ...
                    >
                      <div className="flex mb-0">
                        <div className="me-2">
                          <span className="avatar avatar-md avatar-rounded bg-primary/10 !text-primary border !border-primary/10">
                  ...
                  <div className="hs-accordion" id="order-heading-five">
                    <Link
                      href="#!"
                      className="group inline-flex items-center gap-x-3 w-full font-semibold text-start transition"
                    >
                      <div className="flex mb-0">
                        <div className="me-2">
                          <span className="avatar avatar-md avatar-rounded bg-primary/10 !text-primary border !border-primary/10">
