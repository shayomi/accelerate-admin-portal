          ...
          <div className="xxl:col-span-3 col-span-12">
            <div className="box">
              <div className="box-header">
                <div className="box-title me-1">
                  Order Summary{" "}
                  <span className="badge bg-primary/10 text-primary !border-b-0 !rounded-full">
                    02
                  </span>
                </div>
              </div>
              <div className="box-body !p-0">
                  ...
                  <li className="list-group-item !border-t-0 !border-s-0 !border-e-0">
                    <div className="flex items-center flex-wrap">
                      ...
                      <div>
                        ...
                        <p className="mb-0 text-[0.875rem] font-semibold">
                          $189
                          <span className="ms-1 text-[#8c9097] dark:text-white/50 text-[0.6875rem]  inline-block">
                            <s>$329</s>
                          </span>
                        </p>
                      </div>
                ...
                <div className="p-4 border-b border-dashed dark:border-defaultborder/10">
                  <div className="flex items-center justify-between flex-wrap">
                    <div className="text-[0.75rem] font-semibold bg-primary/10 text-primary p-1 rounded-full">
                      SPRUKO25
                    </div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="font-semibold text-[1rem] text-dark">
                      {" "}
                      $1,387
                    </div>
                  </div>
