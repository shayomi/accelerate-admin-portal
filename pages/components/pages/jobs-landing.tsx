              ...
              <div className="header-element !items-center">
                <div className="lg:hidden block">
                  ...
                  <Link
                    aria-label="anchor"
                    href="#!"
                    className="ti-btn p-2 px-3 ti-btn-success"
              ...
              <nav className="main-menu-container nav nav-pills sub-open">
                ...
                <div className="lg:flex hidden">
                  <div className="btn-list lg:flex hidden lg:mt-2 xl:mt-0 mt-0">
                    ...
                    <Link
                      href="/components/apps/jobs/job-post/"
                    ...
                    <Link
                      ...
                      data-hs-overlay="#hs-overlay-switcher"
                    >
                      <i className="ri-settings-2-line animate-spin-slow"></i>
                    </Link>
                  </div>
                </div>
              </nav>
              ...
              <div className="grid grid-cols-12 gap-6 items-center justify-center">
                ...
                <div className="md:col-span-7 xl:col-span-8 col-span-12">
                  <div className="my-6">
                    ...
                    >
                      <i className="ti ti-upload"></i> Upload Your Resume
                    </Link>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="container">
              <div className=" justify-center text-center mb-[3rem]">
                <div className="xl:col-span-6 col-span-12">
                  <p className="text-[0.75rem] font-semibold mb-1">
                    <span className="landing-section-heading">Find jobs</span>
                  </p>
                  ...
                  <div className="box featured-jobs">
                    <div className="box-body">
                      ...
                      <div className="sm:flex mb-4">
                        <span className="avatar avatar-lg avatar-rounded bg-primary/10 !fill-primary border dark:border-defaultborder/10">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            data-name="Layer 1"
                            viewBox="0 0 24 24"
                        ...
                        <div className="ms-2">
                          <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                            <Link href="#!"> HTML Developer - Fresher</Link>
                          </h5>
                      ...
                      <div className="flex justify-between">
                        <h6 className="font-semibold mb-0 text-default text-[1rem]">
                          $25,000 - $35,000
                        </h6>
                        <Link
                          href="#!"
                  ...
                  <div className="box featured-jobs">
                    <div className="box-body">
                      ...
                      <div className="sm:flex mb-4">
                        ...
                        <div className="ms-2">
                          <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                            <Link href="#!"> React Lead Developer</Link>
                          </h5>
                  ...
                  <div className="box featured-jobs">
                    <div className="box-body">
                      ...
                      <div className="sm:flex mb-4">
                        ...
                        <div className="ms-2">
                          <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                            <Link href="#!"> Vuejs Frontend Developer</Link>
                          </h5>
                  ...
                  <div className="box featured-jobs">
                    <div className="box-body">
                      ...
                      <div className="sm:flex mb-4">
                        ...
                        <div className="ms-2">
                          <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                            <Link href="#!"> Wordpress Developer - Remote</Link>
                          </h5>
            ...
            <div className="container">
              <div className="grid grid-cols-12 items-center justify-center">
                ...
                <div className="md:col-span-8 col-span-12 my-6">
                  ...
                  >
                    <i className="ti ti-upload"></i> Publish new job
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1 col-span-12">
                  <div className="box border dark:border-defaultborder/10">
                    ...
                    <div className="box-body">
                      <span className="badge bg-secondary text-white blog-badge">
                        Interview
                      </span>
                      ...
                      <p className="card-text mb-4">
                        The holographic principle, theorized to be a property of
                        quantum gravity, postulates that the description.
                      </p>
                      <Link className="text-primary font-semibold" href="#!">
                        Read this post
                        <i className="ri-arrow-right-s-line align-middle rtl:rotate-180"></i>
                ...
                <div className="md:col-span-1 col-span-12">
                  <div className="box border dark:border-defaultborder/10">
                    ...
                    <div className="box-body">
                      <span className="badge bg-danger text-white blog-badge">
                        Freelancer
                      </span>
                      <h5 className="font-semibold mb-1 text-[1.25rem]">
                        Freelancer vs Employement
                      </h5>
                      <p className="card-text mb-4">
                        The holographic principle, theorized to be a property of
                        quantum gravity, postulates that the description.
                ...
                <div className="md:col-span-1 col-span-12">
                  <div className="box border dark:border-defaultborder/10">
                    ...
                    <div className="box-body">
                      <span className="badge bg-warning text-white blog-badge">
                        Jobmaster
                      </span>
                      <h5 className="font-semibold mb-1 text-[1.25rem]">
                        Job opportunity in jobmaster
                      </h5>
                      <p className="card-text mb-4">
                        The holographic principle, theorized to be a property of
                        quantum gravity, postulates that the description.
              ...
              <div className="grid grid-cols-12 gap-6">
                <div className="lg:col-span-9 col-span-12">
                  <h2 className="font-semibold text-[2rem]">
                    Let Employers easy to find you !
                  </h2>
                  <span className="block font-normal text-[0.9375rem] opacity-[0.8]">
          ...
          <section className="section bg-banner" id="career-advice">
            <div className="grid grid-cols-12 justify-center !px-4">
              ...
              <div className="lg:col-span-6 col-span-12 text-center">
                ...
                <span className="text-[0.9375rem] font-normal opacity-[0.8] block mb-6">
                  Est amet sit vero sanctus labore no sed ipsum ipsum nonumy.
                  Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam
                  rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus
                  labore no sed ipsum ipsum nonumy vero sanctus labore..
                ...
                >
                  <i className="bi bi-send me-1"></i> Apply Job Now
                </Link>
              </div>
              <div className="lg:col-span-3 col-span-12"></div>
            </div>
                ...
                <div>
                  <ul className="list-none font-normal landing-footer-list mb-0 flex gap-2 flex-wrap">
                    <li className="!mb-0 px-3">
                      <Link href="#!" className="text-white opacity-[0.8]">
                        Terms Of Service
                      </Link>
                    </li>
                    <li className="!mb-0 px-3">
