    ...
    <Fragment>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  <div className="flex flex-wrap items-center justify-between text-[.875rem] mb-1">
                    ...
                    <span className="ms-1 text-[#8c9097] dark:text-white/50">
                      BTC
                    </span>
                  </div>
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div className="flex-grow">
                      <span className="ms-2 badge bg-success/10 text-success rounded-full">
                        +25.8%
                      </span>
                    </div>
                    <div id="btcCoin">
            ...
            <div className="xl:col-span-6 col-span-12">
              <div className="box custom-box">
                <div className="box-body">
                  ...
                  <span className="text-[0.75rem] text-success ms-1">
                    <i className="ti ti-trending-up me-1 inline-block"></i>0.5%
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="box custom-box box-bg-primary">
                <div className="box-body">
                  <div className="flex items-start mb-2">
                    <div className="flex-grow">
                      <p className="mb-0 opacity-[0.7] !text-white">
                        Premium Recruiters
                      </p>
                    </div>
                    <div className="ms-2">
                  ...
                  <span className="text-[0.75rem] opacity-[0.7] ms-1 !text-white">
                    <i className="ti ti-trending-up me-1 inline-block"></i>0.5%
                  </span>
                </div>
              </div>
                ...
                <div className="box-body !p-0">
                  <div className="p-4">
                    <div className="flex items-center mb-2">
                      ...
                      <p className="mb-0 flex-grow text-[#8c9097] dark:text-white/50">
                        Total Revenue
                      </p>
                    </div>
                    <span className="text-[1.25rem] font-semibold">
            ...
            <div className="xl:col-span-6 col-span-12">
              <div className="box custom-box">
                <div className="box-body">
                  ...
                  <span className="text-[0.75rem] text-success ms-1">
                    <i className="ti ti-trending-up me-1 inline-block"></i>3.5%
                  </span>
                  ...
                  <div className="progress progress-xs mb-4">
                    <div
                      className="progress-bar !bg-success w-1/4"
                      role="progressbar"
                      aria-valuenow={25}
                      aria-valuemin={0}
                      aria-valuemax={100}
                  ...
                  <div className="progress progress-xs mb-2">
                    <div
                      className="progress-bar !bg-success w-3/4"
                      role="progressbar"
                      aria-valuenow={25}
                      aria-valuemin={0}
                      aria-valuemax={100}
                ...
                <div className="box-body">
                  <div className="flex items-center mb-4">
                    <div className="flex-grow flex items-center">
                      <div className="me-2">
                        <span className="avatar rounded-[0.375rem] !bg-primary !text-white text-[1.25rem]">
                          <i className="bi bi-people"></i>
                        </span>
                      </div>
                      <div className="flex-grow">
                        <p className="mb-0 ">Premium Recruiters</p>
                        <span className="text-success text-[0.75rem]">
                          7 New
                        </span>
                      </div>
                    </div>
                    <div>
                      <Link
                        href="#!"
                        className="ti-btn ti-btn-icon ti-btn-primary !rounded-full btn-wave mb-0"
                        aria-label="View All"
                      >
                        <i className="bi bi-chevron-right rtl:rotate-180"></i>
                      </Link>
                    </div>
                  </div>
                  <p className="mb-3 text-[1.25rem] font-semibold">386</p>
                  <p className="mb-2 text-[#8c9097] dark:text-white/50 font-normal">
                    Recents
                  </p>
                  <div className="flex items-center justify-between">
                    <div className="avatar-list-stacked">
                      ...
                      <Link
                        href="#!"
                        className="avatar avatar-sm rounded-circle overflow-hidden bg-primary text-white"
                      >
                        +4
                      </Link>
                    </div>
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box custom-box">
                <div className="box-body">
                  <div className="flex items-center">
                    <div className="flex-grow">
                      <p className="mb-1 text-[1.25rem] font-semibold text-default">
                        1,773
                      </p>
                      <p className="mb-0 text-[#8c9097] dark:text-white/50">
                        Active Members
                      </p>
                      <p className="mb-0 text-[.6875rem]">
                    ...
                    <div className="ms-2">
                      <span className="avatar !bg-info !text-white !rounded-full text-[1.25rem]">
              ...
              <div className="box custom-box">
                <div className="box-body">
                  <div className="flex items-center">
                    ...
                    <div className="ms-2">
                      <span className="avatar !bg-success !text-white !rounded-full text-[1.25rem]">
                ...
                <div className="box-header !bg-white/20 !border-b-0 justify-between">
                  ...
                  <div>
                    <button
                      aria-label="button"
                      type="button"
                      className="ti-btn ti-btn-sm !bg-primary !mb-0 rtl:rotate-180"
                    >
                      <i className="ti ti-chevron-right rtl:rotate-180"></i>
                    </button>
                  </div>
                </div>
                <div className="box-body">
                  <div className="flex flex-wrap items-start">
                    <div className="flex-grow overflow-hidden">
                      <p className="mb-2 leading-none text-[1.25rem] font-semibold !text-white">
                        9,231
                      </p>
                      <p className="mb-0 text-[0.75rem] text-white opacity-[0.7]">
                        ...
                        <span className="opacity-[0.7] ms-1 !text-white">
                          From Last Month
                        </span>
                      </p>
                    </div>
                    <div>
                      <span className="avatar avatar-sm bg-success !rounded-full">
                        <i className="bi bi-people-fill"></i>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-4">
                    <div className="flex flex-wrap mb-1">
                      <Link aria-label="anchor" href="#!" className="pe-2">
                        <span className="avatar border text-[#8c9097] dark:text-white/50 !text-primary dark:border-defaultborder/10">
                          <i className="ri-apple-fill text-[1.125rem]"></i>
                        </span>
                      </Link>
                      <div className="flex-grow">
                        <div className="flex flex-wrap items-center justify-between mb-1">
                          ...
                          <span className="!text-success text-end">
                            <i className="ti ti-trending-up text-[.6875rem] me-1 inline-block"></i>
                            0.14%
                          </span>
                        </div>
                    ...
                    <div className="flex items-center">
                      <Link
                        href="#!"
                        className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2"
                      >
                        Short
                      </Link>
                      <Link
                        href="#!"
                        className="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary"
                      >
                        Buy
                      </Link>
                    </div>
                ...
                <div className="box-body !p-0">
                  <div className="p-4">
                    <div className="flex flex-wrap mb-1">
                      <Link aria-label="anchor" href="#!" className="pe-2">
                        <span className="avatar border text-[#8c9097] dark:text-white/50 !text-primary dark:border-defaultborder/10">
                          <i className="ri-bit-coin-fill text-[1.125rem]"></i>
                        </span>
                      </Link>
                      <div className="flex-grow">
                        <div className="flex flex-wrap items-center justify-between mb-1">
            ...
            <div className="box-body">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-grow flex items-start">
                  <div className="me-2">
                    <span className="avatar avatar-md !text-primary border bg-light dark:border-defaultborder/10">
                      <i className="ti ti-users text-[1.125rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    ...
                    <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.75rem] opacity-[0.7]">
              ...
              <div className="flex items-center mb-0">
                ...
                <span className="text-[#8c9097] dark:text-white/50 ms-2">
                  <i className="ti ti-trending-up align-middle text-success me-1 inline-block"></i>
                  2.5%
                </span>
              </div>
              <div className="flex items-center">
                <div className="flex-grow">
                  <div className="progress progress-xs">
                    <div
                      className="progress-bar bg-primary w-[14%]"
                      role="progressbar"
                      aria-valuenow={15}
                      aria-valuemin={0}
                      aria-valuemax={100}
          ...
          <div className="box custom-box">
            <div className="box-body">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-grow flex items-start">
                  <div className="me-2">
                    <span className="avatar avatar-md !text-secondary border bg-light dark:border-defaultborder/10">
                      <i className="ti ti-user-circle text-[1.125rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    <p className="font-semibold text-[.875rem] mb-0">
              ...
              <div className="flex items-center">
                <div className="flex-grow">
                  <div className="progress progress-xs">
                    <div
                      className="progress-bar !bg-secondary w-[55%]"
                      role="progressbar"
                      aria-valuenow={55}
                      aria-valuemin={0}
                      aria-valuemax={100}
          ...
          <div className="box custom-box">
            <div className="box-body">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-grow flex items-start">
                  <div className="me-2">
                    <span className="avatar avatar-md !text-success border bg-light dark:border-defaultborder/10">
                      <i className="ti ti-view-360 text-[1.125rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    <p className="font-semibold text-[.875rem] mb-0">
          ...
          <div className="box custom-box">
            <div className="box-body">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-grow flex items-start">
                  <div className="me-2">
                    <span className="avatar avatar-md !text-indigo border bg-light dark:border-defaultborder/10">
                      <i className="ti ti-view-360 text-[1.125rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
              ...
              <div className="flex items-center mb-0">
                ...
                <span className="text-[#8c9097] dark:text-white/50 ms-2">
                  <i className="ti ti-trending-down align-middle text-danger me-1 inline-block"></i>
                  3.2%
                </span>
              </div>
              <div className="flex items-center">
                <div className="flex-grow">
                  <div className="progress progress-xs">
                    <div
                      className="progress-bar !bg-indigo w-[67%]"
                      role="progressbar"
                      aria-valuenow={67}
                      aria-valuemin={0}
                      aria-valuemax={100}
            ...
            <div className="box-body !p-0">
              <div className="flex items-start p-6 flex-wrap">
                ...
                <div className="flex-grow">
                  ...
                  <p className="opacity-[0.7] mb-0 text-[0.75rem] !text-white">
                    Expenses
                  </p>
                </div>
                <div>
            ...
            <div className="box-body">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center flex-wrap">
                  ...
                  <span className="badge bg-success/10 text-success rounded-full ms-1">
                    +25.8%
                  </span>
                </div>
              </div>
            ...
            <div className="box-body">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center flex-wrap">
                  ...
                  <span className="badge bg-danger/10 text-danger rounded-full ms-1">
                    -3.21%
                  </span>
                </div>
              </div>
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              ...
              >
                <button
                  type="button"
                  className="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                  id="mon"
                  data-hs-tab="#mon-1"
                  aria-controls="mon-1"
                >
                ...
                <button
                  type="button"
                  className="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                  id="tue"
                  data-hs-tab="#tue-1"
                  aria-controls="tue-1"
                >
                  ...
                  <tbody>
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[34%]"
                            role="progressbar"
                            aria-valuenow={34}
                            aria-valuemin={0}
                            aria-valuemax={100}
                    ...
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[58%]"
                            role="progressbar"
                            aria-valuenow={58}
                            aria-valuemin={0}
                            aria-valuemax={100}
                    ...
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[62%]"
                            role="progressbar"
                            aria-valuenow={62}
                            aria-valuemin={0}
                            aria-valuemax={100}
                    ...
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[71%]"
                            role="progressbar"
                            aria-valuenow={71}
                            aria-valuemin={0}
                            aria-valuemax={100}
                    ...
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[48%]"
                            role="progressbar"
                            aria-valuenow={48}
                            aria-valuemin={0}
                            aria-valuemax={100}
                    ...
                    <tr className="border border-defaultborder ">
                      ...
                      <td>
                        <div className="progress progress-xs">
                          <div
                            className="progress-bar bg-primary w-[28%]"
                            role="progressbar"
                            aria-valuenow={28}
                            aria-valuemin={0}
                            aria-valuemax={100}
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            <div className="box-header">
              <div className="box-title">Users By Country</div>
            </div>
            <div className="box-body">
              <div className="flex flex-wrap justify-between mb-[3rem]">
                <div className="me-[3rem] flex items-center">
                  <div className="me-2">
                    <span className="avatar !rounded-full bg-primary/10 !text-primary">
                      <i className="ri-user-3-line text-[1rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    <p className="text-[1.125rem] mb-0 text-primary font-semibold">
                      25,350
                    </p>
                ...
                <div className="me-4 flex items-center">
                  <div className="me-2">
                    <span className="avatar !rounded-full bg-light !text-defaulttextcolor">
                      <i className="ri-user-3-line text-[1rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                ...
                <div className="me-4 flex items-center">
                  <div className="me-2">
                    <span className="avatar !rounded-full bg-success/10 !text-success">
                      <i className="ri-user-3-line text-[1rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    <p className="text-[1.125rem] mb-0 text-success font-semibold">
                      1,24,890
                    </p>
                    <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                      This Year
                ...
                <div className="me-4 flex items-center">
                  <div className="me-2">
                    <span className="avatar !rounded-full bg-secondary/10 !text-secondary">
                      <i className="ri-user-3-line text-[1rem]"></i>
                    </span>
                  </div>
                  <div className="flex-grow">
                    <p className="text-[1.125rem] mb-0 text-secondary font-semibold">
                      97,799
                    </p>
                    <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                      Last Year
                  ...
                  <div className="h-full my-auto">
                    <ul className="list-group">
                      <li className="list-group-item">
                        <div className="flex flex-wrap items-center justify-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-primary text-[0.5rem] me-1 align-middle inline-block"></i>
                            Brazil
                          </div>
                          <div>1,290</div>
                      ...
                      <li className="list-group-item">
                        <div className="flex flex-wrap items-center justify-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-secondary text-[0.5rem] me-1 align-middle inline-block"></i>
                            Greenland
                          </div>
                          <div>2,596</div>
                          <div className="text-danger">
                            <i className="ri-arrow-down-s-line align-middle me-1 inline-block"></i>
                            1.1%
                          </div>
                        </div>
                      </li>
                      <li className="list-group-item">
                        <div className="flex flex-wrap items-center justify-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-success text-[0.5rem] me-1 align-middle inline-block"></i>
                            Russia
                          </div>
                          <div>3,710</div>
                          <div className="text-success">
                      ...
                      <li className="list-group-item">
                        <div className="flex flex-wrap items-center justify-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-warning text-[0.5rem] me-1 align-middle inline-block"></i>
                            Palestine
                          </div>
                          <div>1,116</div>
                          <div className="text-danger">
                      ...
                      <li className="list-group-item">
                        <div className="flex flex-wrap items-center justify-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-danger text-[0.5rem] me-1 align-middle inline-block"></i>
                            Canada
                          </div>
                          <div>12,150</div>
                          <div className="text-success">
          ...
          <div className="box custom-box">
            <div className="box-header">
              ...
              <div className="ms-auto hs-dropdown ti-dropdown">
                <Link
                  href="#!"
                  className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary dropdown-toggle"
                  aria-expanded="false"
                >
                  Details
                </Link>
            ...
            <div className="box-body pb-4">
              <div className="mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="ltr:float-right rtl:float-left text-primary"
                  fill="currentColor"
                  width="36px"
                  height="36px"
                  viewBox="0 0 24 24"
                ...
                <span className="text-danger me-1 text-[.875rem]">
                  {" "}
                  - 1.3%
                  <i className="ri-arrow-down-s-fill align-middle ms-1"></i>{" "}
                </span>
                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                  33% of target reached
                </span>
              </div>
              <div id="report">
                <Targetreport />
