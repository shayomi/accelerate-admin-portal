                  ...
                  <div>
                    ...
                    <p className="text-[#8c9097] dark:text-white/50 mb-2">
                      <span className="text-default">
                        ...
                        <b className="sm:text-sm text-[0.7rem]">
        ...
        <div className="xl:col-span-3 col-span-12">
              ...
              <div className="table-responsive">
                <table className="table whitespace-nowrap min-w-full">
                  <tbody>
                    ...
                    <tr className="border-b border-defaultborder">
                      <td>
                        <span className="font-semibold">Task Tags :</span>
                      </td>
                      <td>
                        <span className="badge bg-primary/10 me-2 text-primary">
                          UI/Ux
                        </span>
                        <span className="badge bg-primary/10 me-2 text-primary">
                          Designing
          ...
          <div className="box overflow-hidden">
            <div className="box-header justify-between">
              ...
              <div>
                <button
                  type="button"
                  className="ti-btn ti-btn-secondary !py-1 !px-2 !font-medium !text-[0.75rem]"
                >
              ...
              <ul className="list-group">
                <li className="list-group-item">
                  <div className="flex items-center flex-wrap">
                    ...
                    <div className="font-semibold">
                      Conduct Website Design Analysis
                    </div>
                  </div>
                </li>
                <li className="list-group-item">
                ...
                <li className="list-group-item">
                  <div className="flex items-center flex-wrap">
                    ...
                    <div className="font-semibold">
                      Test Responsive and Cross-Browser Compatibility
                    </div>
                  </div>
                </li>
                <li className="list-group-item">
                  <div className="flex items-center flex-wrap">
                    ...
                    <div className="font-semibold">
                      Review and Polish Design Elements
                    </div>
                  </div>
                </li>
                <li className="list-group-item">
          ...
          <div className="box overflow-hidden">
            <div className="box-header !border-b-0">
              <div className="box-title">Attachments</div>
            </div>
            <div className="box-body !p-0">
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">
                  <div className="flex items-center flex-wrap">
                    ...
                    <div className="flex-grow">
                      <Link href="#!">
                        <span className="block font-semibold">Docs.zip</span>
                      </Link>
                      <span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] font-normal">
                        2MB
                      </span>
