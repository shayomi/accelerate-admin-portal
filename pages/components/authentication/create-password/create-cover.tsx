                    ...
                    Hello Jhon !
                      ...
                      Sign In with google
										...
										<button
											aria-label="button"
											type="button"
											className="ti-btn ti-btn-icon ti-btn-primary me-[0.365rem]"
										>
										...
										<button
											aria-label="button"
											type="button"
											className="ti-btn ti-btn-icon ti-btn-info"
										>
                        ...
                        Confirm Password
											...
											<div className="flex">
												...
												>
													<i
														className={`${passwordshow2 ? "ri-eye-line" : "ri-eye-off-line"} align-middle`}
													></i>
												</button>
											</div>
											<div className="mt-2">
					...
					<div className="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 xl:block hidden px-0">
						<div className="authentication-cover">
                            ...
                            Create Password
													...
													<p className="font-normal text-[0.875rem] opacity-[0.7]">
														{" "}
