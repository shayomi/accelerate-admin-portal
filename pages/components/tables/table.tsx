import {
  ...
  Table6data,
  tablehead,
} from "@/shared/data/tables/tabledata";
...
import {
  ...
  tabledata8,
  tabledata9,
} from "@/shared/data/prism/tables-prism";
  ...
  return (
    <div>
              ...
              <table className="table whitespace-nowrap min-w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-defaultborder">
                    ...
                    <td>+1523-12459</td>
                    <td>
                      <span className="badge bg-outline-warning">Failed</span>
                    </td>
                  </tr>
                  <tr className="border-b border-defaultborder">
                    <th scope="row" className="text-start">
                ...
                <tbody>
                  {Table1data.map((idx) => (
                    ...
                    >
                      ...
                      <td>
                        <span
                          className={`badge bg-${idx.color}/10 text-${idx.color1}`}
                        >
                          {idx.text}
                        </span>
                      </td>
                      ...
                      <td>
                        <div className="hstack gap-2 flex-wrap">
                          ...
                          <Link
                            aria-label="anchor"
                            href="#!"
                            className="text-danger text-[.875rem] leading-none"
                          >
                  ...
                  {Table5data.map((idx) => (
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          <i className="ri-download-2-line align-middle me-2 inline-block"></i>
                          Download
                        </button>
                      </td>
                    </tr>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode
            title="Success Table With stripped Rows"
            code={tabledata15}
            customCardClass="custom box"
          >
            <div className="table-responsive">
      ...
      <div className="grid grid-cols-12 gap-6">
                ...
                <tbody>
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <div className="progress progress-xs">
                        <div
                          className="progress-bar bg-primary w-[52%]"
                          role="progressbar"
                          aria-valuenow={52}
                          aria-valuemin={0}
                          aria-valuemax={100}
                  ...
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <div className="progress progress-xs">
                        <div
                          className="progress-bar bg-primary w-2/5"
                          role="progressbar"
                          aria-valuenow={40}
                          aria-valuemin={0}
                          aria-valuemax={100}
                  ...
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <div className="progress progress-xs">
                        <div
                          className="progress-bar bg-primary w-[17%]"
                          role="progressbar"
                          aria-valuenow={17}
                          aria-valuemin={0}
                          aria-valuemax={100}
                  ...
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <div className="progress progress-xs">
                        <div
                          className="progress-bar bg-primary w-[72%]"
                          role="progressbar"
                          aria-valuenow={72}
                          aria-valuemin={0}
                          aria-valuemax={100}
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode
            title="Hoverable Rows With stripped Rows"
            code={tabledata17}
            customCardClass="custom box"
          >
            <div className="table-responsive">
              <table className="table whitespace-nowrap ti-striped-table table-hover min-w-full ti-custom-table-hover">
                ...
                <tbody>
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <span className="badge bg-success/10 text-success">
                        <i className="ri-check-fill align-middle me-1"></i>Paid
                      </span>
                    </td>
                    <td>Jul 26,2022</td>
                  </tr>
                  ...
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <span className="badge bg-danger/10 text-danger">
                        <i className="ri-close-fill align-middle me-1"></i>
                        Cancelled
                      </span>
                    </td>
                    <td>Feb 1,2022</td>
                  ...
                  <tr className="border-b border-defaultborder ">
                    ...
                    <td>
                      <span className="badge bg-light text-black dark:text-white">
                        <i className="ri-reply-line align-middle me-1"></i>
                        Refunded
                      </span>
                    </td>
                    <td>Apr 24,2022</td>
              ...
              <table className="table whitespace-nowrap min-w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-defaultborder">
                    ...
                    <td>175</td>
                    <td>
                      <span className="badge bg-primary text-white">58%</span>
                    </td>
                  </tr>
                  <tr className="border-b border-defaultborder">
                    <th scope="row">03</th>
                    ...
                    <td>126</td>
                    <td>
                      <span className="badge bg-primary text-white">32%</span>
                    </td>
                  </tr>
                </tbody>
                <tfoot className="bg-primary/10">
                  <tr className="border-b border-defaultborder">
                    ...
                    <td>558</td>
                    <td>
                      <span className="badge bg-primary text-white">56%</span>
                    </td>
                  </tr>
                </tfoot>
              </table>
              ...
              <table className="table whitespace-nowrap min-w-full">
                ...
                <tbody>
                  {Colortables.map((idx) => (
                    <tr
                      key={Math.random()}
                      className={`${idx.class1} border-b border-defaultborder`}
                    >
                ...
                <tbody>
                  ...
                  <tr className="border-b border-defaultborder">
                    ...
                    <td>
                      <div className="progress progress-xs">
                        <div
                          className="progress-bar bg-primary w-[91%]"
                          role="progressbar"
                          aria-valuenow={91}
                          aria-valuemin={0}
                          aria-valuemax={100}
