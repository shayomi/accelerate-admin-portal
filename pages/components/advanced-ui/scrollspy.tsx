					...
					<div className="box">
                        ...
                        Brand
										...
										>
											...
											>
												<Link
													className="text-sm text-gray-700 leading-6 hover:text-gray-500 dark:text-white/70 dark:hover:text-white hs-scrollspy-active:text-primary dark:hs-scrollspy-active:text-primary"
													href="#first"
												>
                          First
												</Link>
                          ...
                          Second
                            ...
                            Dropdown
														<svg
															className="hs-scrollspy-active:stroke-primary ltr:ml-2 rtl:mr-2 w-2.5 h-2.5 stroke-gray-500 dark:stroke-white/70"
															width="16"
															height="16"
															viewBox="0 0 16 16"
															fill="none"
													...
													>
														<Link
															className="flex items-center gap-x-3.5 py-2 px-3 rounded-sm text-sm text-gray-700 leading-6 hover:text-gray-500 dark:text-white/70 dark:hover:text-white hs-scrollspy-active:text-primary dark:hs-scrollspy-active:text-primary"
															href="#third"
														>
                              Third
														</Link>
							...
							<div className="box-body">
								<div className="grid grid-cols-5">
									<div className="col-span-12 md:col-span-1">
										<h2 className="text-xl font-medium dark:!text-defaulttextcolor/70">
                      Navbar
										</h2>

										<ul
											className="sticky topacity-0"
										...
										>
											<li data-hs-scrollspy-group="">
												<Link
													href="#item-1"
													className="block py-0.5 text-sm font-medium leading-6 text-slate-700 hover:text-slate-900 dark:!text-defaulttextcolor/70 dark:hover:text-[#8c9097] hs-scrollspy-active:text-primary dark:hs-scrollspy-active:text-primary"
												>
                          Item 1
												</Link>
												<ul>
													<li className="ms-4">
														...
														>
															<svg
																className="w-2 h-6 text-gray-400 overflow-visible group-hover:text-gray-600  dark:!text-defaulttextcolor/70 dark:group-hover:text-[#8c9097] rtl:rotate-180"
																width="16"
																height="16"
																viewBox="0 0 16 16"
																fill="none"
                              ...
                              Item 3-2
									...
									<div className="col-span-12 md:col-span-4">
										<div id="scrollspy-2" className="space-y-4">
											<div id="item-1">
												<h3 className="text-lg font-semibold dark:!text-defaulttextcolor/70">
                          Item 1
												</h3>
												<p className="mt-1 text-sm leading-6 text-gray-600 dark:!text-defaulttextcolor/70">
                          This is some placeholder content for the scrollspy
                          page. Note that as you scroll down the page, the
                          appropriate navigation link is highlighted. It's
                          repeated throughout the component example. We keep
                          adding some more example copy here to emphasize the
