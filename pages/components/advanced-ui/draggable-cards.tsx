...
const Draggablecards = () => {
  ...
  const elementsToModify = [leftContainerRef, rightContainerRef];
        ...
        >
          ...
          <div className="box box-data">
            ...
            <div className="box-body deals-content" onClick={handleBoxClick}>
              ...
              <p className="text-[0.813rem] mb-0">
          ...
          <div className="box custom-box">
            ...
            <div className="box-body deals-content">
              <div className="flex items-center">
                ...
                <div>
                  <p className="box-text mb-0 text-[.875rem] font-semibold">
                    Atharva Simon.
                  </p>
                  <div className="box-title !text-[#8c9097] dark:text-white/50 !text-[0.75rem] !font-normal mb-0">
          ...
          <div className="box custom-box border border-info">
            ...
            <div className="box-body deals-content">
              <div className="flex items-center">
                ...
                <div>
                  <p className="box-text text-info mb-1 text-[.875rem] font-semibold">
                    Alicia Keys.
                  </p>
                  <div className="box-title !text-[0.75rem] mb-1 !font-normal">
                    Department Of Commerce
                  </div>
                  <div className="box-title !text-[#8c9097] dark:text-white/50 !text-[.6875rem] !font-normal mb-0">
                    24 Years, Female
                  </div>
                </div>
              </div>
        ...
        >
          <div className="box custom-box overlay-box">
            ...
            <div className="box-img-overlay flex flex-col p-0 !top-auto inset-x-0 bottom-0">
              ...
              <div className="box-footer !text-white">
            ...
            <div className="box-body deals-content">
              <div className="flex items-center w-full">
                ...
                <div className="">
                  ...
                  <p className="mb-0 text-white opacity-[0.7] text-[0.75rem]">
          ...
          <div className="box custom-box">
            ...
            <div
              ...
              className="hs-collapse show w-full overflow-hidden  transition-[height] duration-300"
