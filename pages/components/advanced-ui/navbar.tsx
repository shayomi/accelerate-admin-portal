			...
			<div className="grid grid-cols-12 gap-x-5">
				<div className="col-span-12">
					<div className="box">
						...
						<div className="box-body">
							<header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm dark:bg-bodybg">
								<nav
									className=" w-full mx-auto sm: sm:flex sm:items-center sm:justify-between"
									aria-label="Global"
								>
                      ...
                      Landing
										...
										<Link
											className="font-medium text-gray-600 hover:text-gray-400 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-500 whitespace-nowrap"
											href="#!"
										>
                      Account
										</Link>
				...
				<div className="col-span-12">
					<div className="box">
						...
						<div className="box-body">
							<header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm dark:bg-bodybg">
								<nav
									className="w-full mx-auto  xxl:flex xxl:items-center xxl:justify-between"
									aria-label="Global"
								>
									<Link href="#!" className="header-logo">
										<img
									...
									<div className="flex flex-row items-center gap-5 mt-5 pb-2 overflow-x-auto xxl:justify-end xxl:mt-0 sm:ps-5 xxl:pb-0 xxl:overflow-x-visible">
										<Link
											className="font-medium text-primary"
											href="#!"
											aria-current="page"
				...
				<div className="col-span-12">
					<div className="box">
						...
						<div className="box-body">
							<header className="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm dark:bg-bodybg">
								<nav
									className="w-full mx-auto  sm:flex sm:items-center sm:justify-between"
									aria-label="Global"
								>
                        ...
                        Blog
                          ...
                          Dropdown
												...
												>
													<Link
														className="flex items-center gap-x-3.5 py-2 px-3 rounded-sm text-sm text-gray-800 hover:bg-gray-100 focus:ring-0 focus:ring-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:bg-black/20 dark:hover:text-gray-300"
														href="#!"
													>
                            About
													</Link>
                              ...
                              Sub menu
															<svg
																className="sm:-rotate-90 ms-2 w-2.5 h-2.5 text-gray-600 rtl:rotate-90"
																width="16"
																height="16"
																viewBox="0 0 16 16"
																fill="none"
				...
				<div className="col-span-12">
					<div className="box">
						...
						<div className="box-body space-y-4">
							<header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-primary text-sm py-4 rounded-sm">
								<nav
                        ...
                        Blog
							...
							<header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-secondary text-sm py-4 rounded-sm">
								<nav
									className="w-full mx-auto px-4  sm:flex sm:items-center sm:justify-between"
									aria-label="Global"
								>
