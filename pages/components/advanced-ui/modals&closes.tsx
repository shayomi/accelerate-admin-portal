		...
		<Fragment>
			...
			<div className="grid grid-cols-12 gap-6">
              ...
              Vertically centered modal
				...
				<div className="xl:col-span-4 col-span-12">
					<Showcode
						title="Vertical Centered Scoralable"
						code={modal5}
						customCardClass="custom-box"
					>
						<button
			...
			<div className="grid grid-cols-12 gap-6">
				...
				<div className="xl:col-span-4 col-span-12">
					<Showcode
						title="White Variant"
						customCardClass="custom-box overflow-hidden"
