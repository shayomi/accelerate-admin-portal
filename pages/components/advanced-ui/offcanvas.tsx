	...
	return (
		<Fragment>
			...
			<div className="grid grid-cols-12 gap-6">
              ...
              Button
						...
						<div
							...
							className="hs-overlay hidden ti-offcanvas ti-offcanvas-left !z-[105]"
						>
							<div className="ti-offcanvas-header">
								<h6 className="ti-offcanvas-title">Notifications</h6>
								<button
									type="button"
              ...
              Enable backdrop
						...
						<div
							id="hs-overlay-backdrop-default"
							className="hs-overlay ti-offcanvas ti-offcanvas-left hidden !z-[105]"
						>
							<div className="ti-offcanvas-header">
								<h6 className="ti-offcanvas-title">Notifications</h6>
								<button
			...
			<div className="grid grid-cols-12 gap-6">
				<div className="xl:col-span-4 col-span-12">
					<Showcode
						title=" Enable Body scrolling and backdrop"
						code={offcanvas5}
						customCardClass="custom-box"
					>
						<button
              ...
              Enable both scrolling &amp; backdrop
				...
				<div className="xl:col-span-6 col-span-12">
					...
					>
						<button
							type="button"
							className="ti-btn ti-btn-primary-full me-2"
              ...
              Toggle top offcanvas
						...
						<div
							id="hs-overlay-top"
							className="hs-overlay hidden ti-offcanvas ti-offcanvas-top !z-[105]"
						>
							<div className="ti-offcanvas-header">
								<h5 className="ti-offcanvas-title">Offcanvas top</h5>
								<button
									type="button"
									className="ti-btn flex-shrink-0 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
									data-hs-overlay="#hs-overlay-top"
              ...
              Toggle right offcanvas
						...
						>
							<div className="ti-offcanvas-header">
								<h5 className="ti-offcanvas-title">Notifications</h5>
								<button
									type="button"
									className="ti-btn flex-shrink-0 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
									data-hs-overlay="#hs-overlay-right"
              ...
              Toggle bottom offcanvas
						...
						<div
							...
							className="hs-overlay hidden ti-offcanvas ti-offcanvas-bottom !z-[105]"
						>
							<div className="ti-offcanvas-header">
								<h5 className="ti-offcanvas-title">Offcanvas title</h5>
								<button
									type="button"
									className="ti-btn flex-shrink-0 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
									data-hs-overlay="#hs-overlay-bottom"
