          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="sm:flex space-x-6 rtl:space-x-reverse">
                ...
                <Link
                  className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary"
                  href="#!"
                  aria-current="page"
                >
                  Active
                ...
                <Link
                  className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50"
                  href="#!"
                >
                  Disabled
                </Link>
      ...
      <div className="grid grid-cols-12 gap-x-6">
              ...
              <div className="">
                ...
                >
                  <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
                    ...
                    celebrity cruises aren't as bad as you think. How cultural
                    solutions can help you predict the future. How to cheat at
                    dog friendly hotels and get away with it. 17 problems with
                    summer activities. How to cheat at travel agents and get
                    away with it. How not knowing family trip ideas makes you a
                    rookie. What everyone is saying about daily deals. How
                    twitter can teach you about carnival cruises. How to start
                    using cultural solutions.
                  </p>
                </div>
                <div
                  id="hs-tab-js-behavior-2"
                  className="hidden"
                  role="tabpanel"
                ...
                >
                  <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
                    ...
                    future. How carnival cruises make you a better lover. Why
              ...
              <div className="flex">
                <div className="border-e border-gray-200 dark:border-white/10">
                  ...
                  >
                    <button
                      type="button"
                      className="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg2 dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active"
                      id="hs-tab-js-vertical-item-1"
                      data-hs-tab="#hs-tab-js-vertical-1"
                      aria-controls="hs-tab-js-vertical-1"
                    >
                      Tab 1
                    </button>
                    <button
                      type="button"
                      className="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg2 dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                      id="hs-tab-js-vertical-item-2"
                      data-hs-tab="#hs-tab-js-vertical-2"
                      aria-controls="hs-tab-js-vertical-2"
                    >
                      Tab 2
                    </button>
                    <button
                      type="button"
                      className="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg2 dark:hs-tab-active:border-e-transparent dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300"
                      id="hs-tab-js-vertical-item-3"
                      data-hs-tab="#hs-tab-js-vertical-3"
                      aria-controls="hs-tab-js-vertical-3"
                    >
                      Tab 3
                    </button>
                  </nav>
                ...
                <div className="">
                  <div
                    id="hs-tab-js-vertical-1"
                    role="tabpanel"
                    aria-labelledby="hs-tab-js-vertical-item-1"
                  >
                    <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                      ...
                      dog friendly hotels and get away with it. 17 problems with
                      summer activities. How to cheat at travel agents and get
                      away with it. How not knowing family trip ideas makes you
                      a rookie. What everyone is saying about daily deals. How
                      twitter can teach you about carnival cruises. How to start
                      using cultural solutions.
                    </p>
                  </div>
                  <div
                    id="hs-tab-js-vertical-2"
                    className="hidden"
                    role="tabpanel"
                    aria-labelledby="hs-tab-js-vertical-item-2"
                  >
                    <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                      How travel coupons make you a better lover. Why cultural
                      solutions are the new black. Why mom was right about
                      travel insurances. How family trip ideas can help you
                      predict the future. How carnival cruises make you a better
                      lover. Why you'll never succeed at daily deals. 11 ways
                      cheapest flights can find you the love of your life. The
                      complete beginner's guide to mission trips. If you read
                      one article about cultural notes read this one. Why you
                      shouldn't eat vacation package in bed.
                    </p>
                  </div>
                  <div
                    id="hs-tab-js-vertical-3"
                    className="hidden"
                    role="tabpanel"
                    aria-labelledby="hs-tab-js-vertical-item-3"
                  >
                    <p className="text-gray-500 dark:text-[#8c9097] dark:text-white/50 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                      Unbelievable healthy snack success stories. 12 facts about
                      safe food handling tips that will impress your friends.
                      ...
                      Unbelievable food stamp success stories. How whole foods
                      markets are making the world a better place. 16 things
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <select
                id="tab-select"
                className="mb-5 sm:hidden py-2 px-3 pe-9 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-[#8c9097] dark:text-white/50"
                aria-label="Tabs"
              >
            ...
            <div className="box-body">
              <div className="border-b-2 border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 flex space-x-6 rtl:space-x-reverse">
                  <Link
                    className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary active"
                    href="#!"
                    id="underline-item-1"
                  ...
                  <Link
                    className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor  dark:text-[#8c9097] dark:text-white/50 hover:text-primary"
                    href="#!"
                    id="underline-item-2"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="sm:border-b border-gray-200 dark:border-white/10">
                <nav
                  className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse"
                  aria-label="Tabs"
                >
                  <button
                    type="button"
                    className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active"
                    id="tabs-with-badges-item-1"
                    data-hs-tab="#tabs-with-badges-1"
                    aria-controls="tabs-with-badges-1"
                  >
                    Tab 1{" "}
                    <span className="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-300">
                      99+
                    </span>
                  </button>
                  <button
                    type="button"
                    className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50"
            ...
            <div className="box-body">
              <div className="border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse">
                  <Link
                    className="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active"
                    href="#!"
                    id="card-type-item-1"
                    data-hs-tab="#card-type-1"
            ...
            <div className="box-body">
              <div className="sm:flex bg-gray-100 hover:bg-gray-200 rounded-sm transition p-1 dark:bg-black/20 dark:hover:bg-black/20">
                <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse">
                  <Link
                    className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                    href="#!"
                    id="segment-item-1"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="relative z-0 sm:flex border rounded-sm divide-y sm:divide-y-0 sm:divide-x rtl:divide-x-reverse divide-gray-200 overflow-hidden dark:border-white/10 dark:divide-white/10 ">
                <Link
                  className="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 dark:hs-tab-active:text-defaulttextcolor/70 group relative min-w-0 flex-1 bg-white dark:bg-black/20 py-4 px-4 text-defaulttextcolor hover:text-gray-700 text-sm font-medium text-center overflow-hidden dark:text-[#8c9097] dark:text-white/50 hover:bg-gray-50 focus:z-10 dark:bg-bgdark dark:hover:bg-black/20 dark:hover:text-white active"
                  href="#!"
                  id="bar-item-1"
                  data-hs-tab="#bar-1"
                  aria-controls="bar-1"
                ...
                <Link
                  className="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 dark:hs-tab-active:text-defaulttextcolor/70 group relative min-w-0 flex-1 bg-white dark:bg-black/20 py-4 px-4 text-gray-400 text-sm font-medium text-center pointer-events-none overflow-hidden focus:z-10 dark:bg-bgdark dark:text-white/50"
                  href="#!"
                  id="bar-item-4"
                  data-hs-tab="#bar-4"
                >
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              >
                <button
                  type="button"
                  className="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                ...
                <button
                  type="button"
                  className="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <nav
                className="sm:flex sm:space-x-2 rtl:space-x-reverse"
                aria-label="Tabs"
              >
                <button
                  type="button"
                  className="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                ...
                <button
                  type="button"
                  className="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                  id="fill-and-justify-item-2"
                  data-hs-tab="#fill-and-justify-2"
                  aria-controls="fill-and-justify-2"
                >
                ...
                <button
                  type="button"
                  className="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
                  id="fill-and-justify-item-3"
                  data-hs-tab="#fill-and-justify-3"
                  aria-controls="fill-and-justify-3"
                >
                  Tab 3
                </button>
              </nav>
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              >
                <button
                  type="button"
                  className="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active"
                ...
                <button
                  type="button"
                  className="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white"
          ...
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">
                Tabs With Horizontal Center Alignment
              </h5>
            </div>
            <div className="box-body">
              <div className="border-b border-gray-200 dark:border-white/10">
                ...
                >
                  <button
                    type="button"
                    className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active"
                  ...
                  <button
                    type="button"
                    className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50"
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">
                Tabs With Horizontal Right Alignment
              </h5>
            </div>
            <div className="box-body">
              <div className="border-b border-gray-200 dark:border-white/10">
                <nav
                  className="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse"
                  aria-label="Tabs"
                >
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    className="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50"
                    id="horizontal-right-alignment-item-3"
                    data-hs-tab="#horizontal-right-alignment-3"
                    aria-controls="horizontal-right-alignment-3"
                  >
                    Tab 3
                  </button>
                </nav>
              ...
              <div className="mt-3">
                ...
                <div
                  id="horizontal-right-alignment-3"
                  className="hidden"
                  role="tabpanel"
