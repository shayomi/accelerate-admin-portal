      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <nav aria-label="Page navigation">
              <ul className="ti-pagination mb-0">
                <li className="page-item">
                  ...
                  >
                    <span aria-hidden="true">
                      <i className="rtl:rotate-180 bx bx-chevron-left"></i>
                    </span>
                  </Link>
                </li>
                <li className="page-item">
                ...
                <li className="page-item">
                  ...
                  >
                    <span aria-hidden="true">
                      <i className="rtl:rotate-180 bx bx-chevron-right"></i>
                    </span>
                  </Link>
                </li>
              </ul>
        ...
        <div className="xxl:col-span-6 xl:col-span-12 col-span-12">
          <Showcode
            ...
            code={pagination15}
            customCardBodyClass="!flex flex-wrap justify-between gap-2"
          >
            <nav aria-label="...">
              <ul className="ti-pagination pagination-sm mb-0">
                <li className="page-item " aria-current="page">
                  <span className="page-link  active px-3 py-[0.375rem]">
                    1
                  </span>
                </li>
                <li className="page-item">
      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode
            ...
            customCardBodyClass="!flex flex-wrap"
          >
          ...
          <Showcode title="Pagination Style-2" code={page5}>
            <nav aria-label="Page navigation" className="pagination-style-2">
              <ul className="ti-pagination mb-0 flex-wrap">
                <li className="page-item disabled">
                  <Link
                    className="page-link px-3 py-[0.375rem] !border-0"
                    href="#!"
                  >
                    Prev
                  </Link>
                ...
                <li className="page-item">
                  <Link
                    className="page-link px-3 py-[0.375rem] !text-primary !border-0"
                    href="#!"
                  >
                    next
                  </Link>
