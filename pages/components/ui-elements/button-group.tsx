      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Mixed Style" code={group2}>
            <div
              className="ti-btn-group !gap-0"
              role="group"
              aria-label="Basic mixed styles example"
            >
              <button
                type="button"
                className="ti-btn-group py-3 px-4 border border-danger/10 ti-btn-danger-full ti-btn-wave"
              >
                Year
              </button>
              <button
                type="button"
                className="ti-btn-group py-3 px-4 border border-warning ti-btn-warning-full ti-btn-wave"
              >
                Month
              </button>
              <button
                type="button"
                className="ti-btn-group py-3 px-4 border border-success ti-btn-success-full ti-btn-wave"
              >
                Date
              </button>
            </div>
          ...
          <div className="xl:col-span-12 col-span-12">
            <Showcode title="Basic Button Group" code={group5}>
              ...
              <div className="inline-flex rounded-md shadow-sm mb-5 me-5">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-primary-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
              ...
              <div className="inline-flex rounded-md shadow-sm mb-5 me-5">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-secondary-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
              ...
              <div className="inline-flex rounded-md shadow-sm mb-5 me-5">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-warning-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
              ...
              <div className="inline-flex rounded-md shadow-sm mb-5 me-5">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-danger-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
              ...
              <div className="inline-flex rounded-md shadow-sm mb-5 me-5">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-info-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
              ...
              <div className="inline-flex rounded-md shadow-sm mb-0">
                <button
                  type="button"
                  className="ti-btn-group py-3 px-4 border ti-btn-success-full border-white/10 dark:border-white/10"
                >
                  Year
                </button>
                <button
