...
import {
  ...
  LinksButtons,
  Solidcolors,
} from "@/shared/data/ui-elements/listgroupdata";
              ...
              {BasicButtons.map((idx) => (
                <li className="ti-list-group-item" key={Math.random()}>
                  <div className="flex items-center">
                    ...
                    <div className="ms-2 font-semibold">{idx.text}</div>
                  </div>
                </li>
              ))}
            </ul>
          ...
          <Showcode title="Active Items" code={list2}>
            <ul className="ti-list-group">
              {ActiveButtons.map((idx) => (
                <li
                  className={`ti-list-group-item ${idx.class1}`}
                  aria-current="true"
                  key={Math.random()}
                >
                  <div className="flex items-center">
          ...
          <Showcode title="Disabled Items" code={list3}>
            <ul className="ti-list-group">
              {DisableItems.map((idx) => (
                <li
                  className={`ti-list-group-item ${idx.text}`}
                  aria-disabled="true"
                  key={Math.random()}
                >
                  {idx.class}
          ...
          <Showcode title="Flush" code={list4}>
            <ul className="ti-list-group ti-list-group-flush">
              <li className="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-semibold">
                ...
                Asish Trivedhi
                <span className="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">
                  (+1023-84534)
                </span>
              </li>
              <li className="ti-list-group-item !border-l-0 !border-r-0  font-semibold">
                <i className="bi bi-tiktok align-middle me-2 text-[#8c9097] dark:text-white/50"></i>
                Alezander Russo
                <span className="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">
                  (+7546-12342)
                </span>
              ...
              <li className="ti-list-group-item !border-l-0 !border-r-0  font-semibold">
                <i className="bi bi-whatsapp align-middle me-2 text-[#8c9097] dark:text-white/50"></i>
                Karem Smith
                <span className="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">
                  (+9944-56632)
                </span>
            ...
            <div className="ti-list-group">
              <ul className="list-none">
                {LinksButtons.map((idx) => (
                  <li
                    className={`ti-list-group-item ti-list-group-item-action ${idx.class1} ${idx.color1}`}
                    key={Math.random()}
                  >
                    <Link href="#!" aria-current="true">
                      <div className="flex items-center">
                        <div>
                          <span
                            className={`avatar avatar-xs bg-${idx.class} !text-${idx.color}textcolor avatar-rounded`}
                          >
                            {idx.text1}
                          </span>
                        </div>
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="Buttons" code={list6}>
            <div className="ti-list-group flex flex-col">
              <button
                type="button"
                className="ti-list-group-item text-start ti-list-group-item-action active"
                aria-current="true"
              >
                Simply dummy text of the printing
                <span className="badge ltr:float-right rtl:float-left bg-primary text-white">
                  243
                </span>
              </button>
              <button
                type="button"
                className="ti-list-group-item text-start ti-list-group-item-action"
              >
                There are many variations of passages
                <span className="badge ltr:float-right rtl:float-left bg-secondary/10 text-secondary">
                  35
                </span>
              </button>
              <button
              ...
              >
                ...
                <span className="badge ltr:float-right rtl:float-left bg-info/10 text-info">
                  132
                </span>
              </button>
              <button
              ...
              >
                All the Lorem Ipsum generators
                <span className="badge ltr:float-right rtl:float-left bg-success/10 text-success">
                  2525
                </span>
              </button>
              <button
              ...
              >
                ...
                <span className="badge ltr:float-right rtl:float-left bg-danger/10 text-danger">
                  21
                </span>
              </button>
            </div>
          ...
          <Showcode title="Contextual Classes" code={list7}>
            <ul className="ti-list-group">
              {ContextualButtons.map((idx) => (
                <li
                  className={`ti-list-group-item ${idx.class}`}
                  key={Math.random()}
                >
                  {idx.text}
                </li>
          ...
          <Showcode title="Contextual Classes With Over Style" code={list8}>
            <div className="ti-list-group flex flex-col">
              {ContextualButtons1.map((idx) => (
                <Link
                  href="#!"
                  className={`w-full ti-list-group-item ${idx.class}`}
                  key={Math.random()}
                >
                  {idx.text}
                </Link>
              ...
              <ul className="list-none">
                ...
                <li className="ti-list-group-item ti-list-group-item-action ">
                  <Link href="#!">
                    <div className="sm:flex w-full justify-between">
                      <h6 className="mb-1 font-semibold">
                        The standard Lorem Ipsum used since the 1500s?
                      </h6>
                      <small className="text-[#8c9097] dark:text-white/50">
                        45 mins ago
                      </small>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-4 col-span-12">
          <Showcode
            title="Sub Headings"
            code={list11}
            customCardClass="text-defaulttextcolor text-defaultsize"
          >
            <ol className="ti-list-group !list-decimal">
              <li className="ti-list-group-item flex justify-between items-start">
                <div className="ms-2 me-auto text-[#8c9097] dark:text-white/50">
                  <div className="font-semibold text-[.875rem] !text-defaulttextcolor">
                    What Happened?
                  </div>
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="List With Checkboxes" code={list13}>
            <ul className="ti-list-group">
              <li className="ti-list-group-item">
                <input
                  className="form-check-input me-1 font-semibold"
                  type="checkbox"
                  value=""
                  aria-label="..."
                  defaultChecked
        ...
        <div className="xl:col-span-4 col-span-12">
          <Showcode title="List With Badges" code={list15}>
            <ul className="ti-list-group">
              ...
              <li className="ti-list-group-item flex justify-between items-center font-semibold">
                Beauty
                <span className="badge bg-danger !rounded-full text-white">
                  32
                </span>
              </li>
              <li className="ti-list-group-item flex justify-between items-center font-semibold">
