...
import {
  colortooltip,
  tooltipdirection,
} from "@/shared/data/ui-elements/tooltipdata";
          ...
          <Showcode title="Tooltip Direction" code={tooltip1}>
            <div className="ti-btn-list">
              {tooltipdirection.map((idx) => (
                <div
                  className={`hs-tooltip ti-main-tooltip ${idx.class}`}
                  key={Math.random()}
                >
                  <button
                    type="button"
                    className="hs-tooltip-toggle ti-btn ti-btn-primary-full"
                  >
                    {idx.text}
                    <span
            ...
            <div className="ti-btn-list">
              {colortooltip.map((idx) => (
                ...
                >
                  <button
                    type="button"
                    className={`hs-tooltip-toggle ti-btn ti-btn-${idx.color}`}
                  >
                    {idx.text}
                    <span
          ...
          <Showcode title="Tooltips On Link" code={tooltip3}>
            <div className="hs-tooltip ti-main-tooltip [--placement:top]">
              <p className="text-muted mb-0">
                ...
                <Link aria-label="anchor" href="#!" title="Link Tooltip"></Link>
