              ...
              <ol className="flex items-center whitespace-nowrap min-w-0">
                <li className="text-smtext-primary hover:text-primary dark:text-primary">
                  ...
                  >
                    Home
                    <svg
                      className="flex-shrink-0 h-5 w-5 text-gray-300 dark:text-white/10 mx-2"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                      fill="none"
            ...
            <div className="box-body">
              <ol className="flex items-center whitespace-nowrap min-w-0">
                <li className="text-sm">
                  ...
                  >
                    <svg
                      className="flex-shrink-0 me-3 h-4 w-4 text-primary hover:text-primary dark:text-primary"
                      width="16"
                      height="16"
                      fill="currentColor"
                      viewBox="0 0 16 16"
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              <ol className="flex items-center whitespace-nowrap min-w-0 pb-2">
                ...
                <li className="text-sm">
                  <Link
                    className="flex items-center text-gray-500 dark:text-[#8c9097] dark:text-white/50 hover:text-primary"
                    href="#!"
                  >
                    Library
                  </Link>
