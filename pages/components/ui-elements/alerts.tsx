      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xxl:col-span-6 col-span-12">
          <Showcode title="Basic Alert" code={alerts}>
            <div
              className="alert alert-warning fade show flex"
              role="alert"
              id="dismiss-alert1"
            >
              <div className="">
        ...
        <div className="xxl:col-span-6 col-span-12">
          <Showcode
            ...
            code={Differentalerts}
          >
            {shadows.map((idx) => (
              <div
                className={`alert alert-${idx.color} shadow-sm`}
                key={Math.random()}
              >{`A simple ${idx.color} alert with small
                                it out!`}</div>
            ))}
          </Showcode>
        </div>
        ...
        <div className="xxl:col-span-6 col-span-12">
          <Showcode
            title="Rounded Alert With Custom Close Button"
            code={custombuttons}
          >
            {roundedalerts.map((idx) => (
              <div
        ...
        <div className="xxl:col-span-6 col-span-12">
          <Showcode title="Alert With Images" code={Imagealerts}>
            ...
            >
              ...
              <div>
                A simple secondary rounded alert with image—check it out!
              </div>
              <button
                type="button"
                className="m-2 p-3 absolute end-0 top-0 inline-flex bg-teal-50 rounded-sm text-teal-500 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:ring-offset-teal-50 focus:ring-teal-600"
                ...
                >
                  ...
                  <div className="text-center px-[3rem] pb-0">
                    ...
                    <div className="">
                      <button
                        type="button"
                        className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-outline-danger m-2"
                      >
                        Decline
                      </button>
                      <button
                        type="button"
                        className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium bg-primary text-white m-2"
                      >
                        Accept
                      </button>
                    </div>
                ...
                >
                  ...
                  <div className="text-center px-5 pb-0">
                    ...
                    <div className="">
                      <button
                        type="button"
                        className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium ti-btn-outline-secondary m-2"
                      >
                        Back
                      </button>
                      <button
                        type="button"
                        className="ti-btn !py-1 !px-2 !text-[0.75rem] !font-medium bg-warning text-white m-2"
                      >
                        Continue
                      </button>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-warning w-full">
                      ...
                      <div className="text-[0.75rem]">
                        ...
                        <Link href="#!" className="text-warning font-semibold">
                          open
                        </Link>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-danger w-full">
                      ...
                      <div className="text-[0.75rem]">
                        ...
                        <Link href="#!" className="text-danger font-semibold">
                          open
                        </Link>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-white w-full">
                      ...
                      <div className="text-[0.75rem]">
                        <Link
                          href="#!"
                          className="text-white font-semibold me-2"
                        >
                          close
                        </Link>
                      </div>
