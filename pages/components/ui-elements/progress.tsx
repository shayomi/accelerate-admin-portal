...
import {
  ...
  lables,
  stripped,
} from "@/shared/data/ui-elements/progressdata";
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Basic Progress" code={progress1}>
            {basicprogress.map((idx) => (
              <div
                className="progress mb-4 !rounded-full"
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Different Colored Progress" code={progress2}>
            {colorprogress.map((idx) => (
              ...
              >
                <div
                  className={`progress-bar !bg-${idx.color} !rounded-s-full ${idx.width}`}
                ></div>
              </div>
            ))}
          </Showcode>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Stripped Progress" code={progress3}>
            {stripped.map((idx) => (
              ...
              >
                <div
                  className={`progress-bar progress-bar-striped ${idx.color} ${idx.width}`}
                ></div>
              </div>
            ))}
          </Showcode>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Progress Height" code={progress4}>
            <div
              ...
              aria-valuemax={100}
            >
              <div className="progress-bar bg-primary !rounded-s-full w-[10%]"></div>
            </div>
            <div
            ...
            <div
              className="progress progress-lg mb-4"
              role="progressbar"
              aria-valuenow={75}
              aria-valuemin={0}
              aria-valuemax={100}
            >
              <div className="progress-bar bg-primary !rounded-s-full w-3/4"></div>
            </div>
            <div
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Progress With Labels" code={progress5}>
            {lables.map((idx) => (
              ...
              >
                <div
                  className={`progress-bar !rounded-s-full ${idx.color} ${idx.width}`}
                >
                  {idx.class}
                </div>
              </div>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Multiple Bars With Sizes" code={progress6}>
            <div className="progress-stacked progress-xs mb-4 flex">
              ...
              ></div>
              <div
                className="progress-bar !bg-secondary !rounded-none w-[10%]"
                role="progressbar"
                aria-valuenow={10}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-success !rounded-none w-[15%]"
                role="progressbar"
                aria-valuenow={15}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="progress-stacked progress-sm mb-4 flex">
              <div
                className="progress-bar !bg-warning w-[10%]"
                role="progressbar"
                aria-valuenow={10}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-info !rounded-none w-[15%]"
                role="progressbar"
                aria-valuenow={15}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-danger !rounded-none w-[20%]"
                role="progressbar"
                aria-valuenow={20}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="progress-stacked mb-4 flex">
              <div
                className="progress-bar !bg-info w-[15%]"
                role="progressbar"
                aria-valuenow={15}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-success !rounded-none w-1/5"
                role="progressbar"
                aria-valuenow={20}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !rounded-none w-1/4"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="progress-stacked progress-lg mb-4 flex">
              <div
                className="progress-bar !bg-purple w-1/5"
                role="progressbar"
                aria-valuenow={20}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-teal !rounded-none w-1/4"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-orange !rounded-none w-[30%]"
                role="progressbar"
                aria-valuenow={30}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="progress-stacked progress-xl mb-0 flex">
              ...
              ></div>
              <div
                className="progress-bar !bg-danger !rounded-none w-[30%]"
                role="progressbar"
                aria-valuenow={30}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-warning !rounded-none w-[35%]"
                role="progressbar"
                aria-valuenow={35}
                aria-valuemin={0}
                aria-valuemax={100}
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Gradient Progress" code={progress8}>
            {Gradient.map((idx) => (
              ...
              >
                <div
                  className={`progress-bar bg-${idx.color}-gradient ${idx.width}`}
                ></div>
              </div>
            ))}
          </Showcode>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Animated Progress" code={progress9}>
            {Gradient.map((idx) => (
              <div
                className="progress mb-4 progress-animate"
                role="progressbar"
                aria-valuenow={Number(idx.valuenow)}
                aria-valuemin={0}
                aria-valuemax={100}
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Progress-1" code={progress10}>
            <div
              className="progress progress-sm progress-custom mb-[3rem] progress-animate"
              role="progressbar"
              aria-valuenow={50}
              aria-valuemin={0}
              aria-valuemax={100}
            ...
            <div
              ...
              aria-valuemax={100}
            >
              <h6 className="progress-bar-title !bg-secondary !text-[0.63rem] after:!border-s-secondary">
                Watches
              </h6>
            ...
            <div
              ...
              aria-valuemax={100}
            >
              <h6 className="progress-bar-title !bg-success !text-[0.63rem] after:!border-s-success">
                Shirts
              </h6>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Progress-4" code={progress13}>
            {Custom.map((idx) => (
              <div
                className={`progress progress-xl mb-4 progress-animate custom-progress-4 ${idx.color}`}
                role="progressbar"
                aria-valuenow={Number(idx.valuenow)}
                aria-valuemin={0}
                aria-valuemax={100}
              ...
              >
                <div
                  className={`progress-bar bg-${idx.color}-gradient !rounded-sm ${idx.width}`}
                ></div>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Progress-5" code={progress14}>
            ...
            <div className="progress-stacked progress-xl mb-[3rem] flex">
              ...
              <div
                className="progress-bar !bg-secondary !rounded-none w-[35%]"
                role="progressbar"
                aria-valuenow={35}
                aria-valuemin={0}
                aria-valuemax={100}
              ...
              <div
                className="progress-bar !bg-danger !rounded-s-none !rounded-e-full w-2/5"
                role="progressbar"
                aria-valuenow={40}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="grid grid-cols-12 justify-center">
              <div className="xl:col-span-5 col-span-12">
                <div className="border border-defaultborder dark:border-defaultborder/10 p-4 rounded-md">
                  <p className="text-[0.75rem] font-semibold mb-0 text-[#8c9097] dark:text-white/50">
                    Html
                    <span className="ltr:float-right rtl:float-left text-[0.625rem] font-normal">
                      25%
                    </span>
                  </p>
                  <div
                  ...
                  <div
                    ...
                    aria-valuemax={100}
                  >
                    <div className="progress-bar !rounded-none !bg-secondary w-[35%]"></div>
                  </div>
                  <p className="text-[0.75rem] font-semibold mb-0 text-[#8c9097] dark:text-white/50">
                    Js
                    <span className="ltr:float-right rtl:float-left text-[0.625rem] font-normal">
                  ...
                  <div
                    ...
                    aria-valuemax={100}
                  >
                    <div className="progress-bar !rounded-e-full !bg-danger w-2/5"></div>
                  </div>
                </div>
              </div>
            </div>
