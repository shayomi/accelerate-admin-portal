      ...
      <div className="grid grid-cols-12 md:gap-x-6">
        <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              ...
              <p className="card-text text-[#8c9097] dark:text-white/50 mb-4">
                when an unknown printer took a galley of type and scrambled it
                to make a type specimen book. It has survived not only five
                centuries, but also the leap into electronic typesetting,
                remaining essentially unchanged.
              </p>
              <Link href="#!" className="ti-btn ti-btn-primary-full">
                Read More
              </Link>
            </div>
        ...
        <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
          ...
          <div className="box">
            <div className="box-body">
              ...
              <p className="card-subtitle mb-4 text-[#8c9097] dark:text-white/50">
                Card subtitle
              </p>
              <p className="card-text">
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration many variations of
                passages of Lorem Ipsum available there are so many ways to
                solve but the majority have suffered.
              </p>
            </div>
            <div className="box-footer">
              ...
              <Link href="#!" className="card-link text-success m-1">
                <u>Review</u>
              </Link>
            </div>
          </div>
        ...
        <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              <Link href="#!" className="card-link text-primary me-2">
                Card link
              </Link>
              <Link href="#!" className="card-link text-secondary inline-block">
                Another link
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="xl:col-span-12 col-span-12">
              ...
              <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                  <div className="box">
                    <div className="box-header  !text-start">Featured</div>
                    <ul className="list-group list-group-flush ">
                      <li className="list-group-item !border-0">An item</li>
                      <li className="list-group-item !border-s-0 !border-e-0">
                        A second item
                      </li>
                ...
                <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                  <div className="box">
                    ...
                    <div className="box-footer">Card footer</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="xl:col-span-4 col-span-12">
              <div className="box">
                <div className="box-body">
                  ...
                  <Link href="#!" className="ti-btn ti-btn-secondary-full">
                    Purchase
                  </Link>
                </div>
              </div>
            ...
            <div className="xl:col-span-4 col-span-12">
              <div className="box">
                <div className="box-body">
                  ...
                  <Link href="#!" className="ti-btn ti-btn-light">
                    Purchase
                  </Link>
                </div>
              </div>
      ...
      <div className="grid grid-cols-12 xl:gap-6">
        ...
        <div className="xl:col-span-3 col-span-12">
          ...
          <div className="box border border-success mb-4">
            <div className="!py-1 !px-2 bg/10 border-b !text-start !border-success">
              Header
            </div>
            <div className="box-body text-success">
              <h6 className="box-title font-semibold !text-success">
                Looking For Success?
              </h6>
              <p className="card-text">
            ...
            <div className="!py-1 !px-2 bg/10 border-t border-success">
              Footer
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-12 md:gap-x-6">
          ...
          <div className="box">
            <div className="box-header !border-b-0 !pb-0 !justify-start">
              <div>
                ...
                <p className="block text-[#8c9097] dark:text-white/50 mb-0 text-[.75rem] font-semibold">
                  1 year ago
                </p>
              </div>
            </div>
        ...
        <div className="xl:col-span-3 col-span-12">
          <div className="box text-center">
            <div className="box-header !border-b-0 pb-0">
              <span className="ms-auto shadow-sm text-[1.0625rem]">
            ...
            <div className="box-body !pt-1">
              ...
              <p className="mb-4 text-[#8c9097] dark:text-white/50 text-[.6875rem]">
                Web Developer
              </p>
        ...
        <div className="xl:col-span-3 col-span-12">
          <div className="box text-center">
            ...
            <div className="box-body">
              ...
              <Link href="#!" className="ti-btn ti-btn-primary-full mt-2 me-2">
                Read More
              </Link>
              <Link href="#!" className="ti-btn ti-btn-outline-secondary mt-2">
                Close
              </Link>
            </div>
        ...
        <div className="xl:col-span-3 col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              ...
              <div className="text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-6">
                Angular Developer
              </div>
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className={`box ${isFullscreen ? "box-fullscreen" : ""}`}>
            ...
            <div className="box-body">
              <h6 className="card-text font-semibold" onClick={handleBoxClick}>
                FullScreen Card
              </h6>
              <p className="card-text mb-0">
                There are many variations of passages of Lorem Ipsum available,
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="xl:col-span-6 col-span-12">
              <div className="box !w-[75%]">
                ...
                <div className="box-footer">
                  <Link href="#!" className="ti-btn ti-btn-primary-full !grid">
                    Button
                  </Link>
                </div>
              </div>
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              ...
              <p className="card-text mb-4 text-[#8c9097] dark:text-white/50">
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="box">
            <div className="box-body">
              ...
              <p className="card-text mb-1 text-[#8c9097] dark:text-white/50">
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="box overlay-card">
            ...
            <div className="card-img-overlay flex flex-column p-0">
              ...
              <div className="box-footer !text-white !border-t border-defaultborder">
                Last updated 3 mins ago
              </div>
            </div>
          </div>
            ...
            <div className={`box !bg-${idx.color}`}>
              <div className="box-body">
                <div className="flex items-center w-full">
                  ...
                  <div className="">
                    <div
                      className={`text-[.9375rem] font-semibold !text-${idx.class}`}
                    >
                      {idx.text1}
                    </div>
                    <p
                      className={`mb-0 text-${idx.class} opacity-[0.7] text-[.75rem]`}
                    >
                      {idx.text2}
                    </p>
                  </div>
            ...
            <div className="box-body ">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                ...
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-primary text-[1.125rem]"></i>
                </Link>
              </p>
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                Landing Page Design
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-secondary text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                Update New Project
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-warning text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                ...
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-info text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="badge bg-info/10 text-info">React</span>
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                ...
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-danger text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                ...
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-success text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                New Employees
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-default text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="badge bg-warning/10 text-warning">Html</span>
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              <p className="text-[.875rem] font-semibold mb-2 leading-none">
                ...
                <Link aria-label="anchor" href="#!">
                  <i className="bi bi-plus-square ltr:float-right rtl:float-left text-dark text-[1.125rem]"></i>
                </Link>
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="badge bg-primary/10 text-primary">
                ...
                <div className="box-body">
                  <div className="flex align-center">
                    ...
                    <div>
                      ...
                      <div className="box-title !text-[#8c9097] dark:text-white/50 !text-[.75rem] mb-0">
                ...
                <div className="box-body">
                  <div className="flex align-center">
                    ...
                    <div>
                      ...
                      <div className=" text-[#8c9097] dark:text-white/50 text-[.6875rem] mb-0">
                        24 Years, Female
                      </div>
                    </div>
                  </div>
