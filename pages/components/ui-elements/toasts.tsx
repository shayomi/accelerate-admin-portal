      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-9 col-span-12">
          <Showcode title="Basic Toast" code={toast1}>
            <div className="lg:flex lg:space-x-3 rtl:space-x-reverse space-y-4 lg:space-y-0">
              <div
                className="ti-toast bg-white dark:bg-bodybg dark:border-white/10"
                role="alert"
              >
              ...
              >
                <div className="flex p-4">
                  <div className="flex-shrink-0">
                    <svg
                      className="h-4 w-4 text-green mt-0.5"
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
              ...
              >
                <div className="flex p-4">
                  <div className="flex-shrink-0">
                    <svg
                      className="h-4 w-4 text-red mt-0.5"
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
              ...
              >
                <div className="flex p-4">
                  <div className="flex-shrink-0">
                    <svg
                      className="h-4 w-4 text-orange mt-0.5"
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
        ...
        <div className="xl:col-span-3 col-span-12">
          <Showcode title="Condensed Toasts" code={toast2}>
            <div
              className="ti-toast hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-white  dark:bg-bodybg dark:border-white/10"
              role="alert"
            >
              <div className="flex p-4">
                <p className="text-sm text-gray-700 dark:text-[#8c9097] dark:text-white/50">
          ...
          <Showcode title="Solid Colored Toast" code={toast3}>
            <div className="space-y-3">
              {ColorToasts.map((idx) => (
                <div key={Math.random()}>
                  <div
                    className={`ti-toast bg-${idx.color2} text-sm text-white`}
                    role="alert"
                  >
                    <div className="flex p-4">
          ...
          <Showcode title="Light Colored Toast" code={toast4}>
            <div className="space-y-3">
              {ColorToasts.map((idx) => (
                <div key={Math.random()}>
                  <div
                    className={`ti-toast bg-${idx.color2}/10 text-sm text-${idx.color2}`}
                    role="alert"
                  >
                    <div className="flex p-4">
                      Hello, world! This is a toast message.
          ...
          <Showcode title="Toast Message With Loading Indicator" code={toast5}>
            ...
            >
              <div className="flex items-center p-4">
                <div
                  className="ti-spinner w-4 h-4 text-primary"
                  role="status"
                  aria-label="loading"
                >
