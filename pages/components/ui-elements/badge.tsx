...
import {
  ...
  lightbadges,
  outlinebadges,
} from "@/shared/data/ui-elements/badgesdata";
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Badges" className={data} code={badges1}>
            {badges.map((idx) => (
              <span
                className={`badge me-2 bg-${idx.color}`}
                key={Math.random()}
              >
                {idx.class}
              </span>
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            {badges.map((idx) => (
              <span
                className={`badge me-2 !rounded-full bg-${idx.color}`}
                key={Math.random()}
              >
                {idx.class}
              </span>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            {gradientbadge.map((idx) => (
              <span
                className={`badge me-2 bg-${idx.color}-gradient`}
                key={Math.random()}
              >
                {idx.class}
              </span>
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            {gradientbadge.map((idx) => (
              <span
                className={`badge me-2 rounded-full bg-${idx.color}-gradient`}
                key={Math.random()}
              >
                {idx.class}
              </span>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            {outlinebadges.map((idx) => (
              <span
                className={`badge me-2 bg-outline-${idx.color}`}
                key={Math.random()}
              >
                {idx.class}
              </span>
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            {outlinebadges.map((idx) => (
              <span
                className={`badge me-2 !rounded-full bg-outline-${idx.color}`}
                key={Math.random()}
              >
                {idx.class}
              </span>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <button
              type="button"
              className="ti-btn bg-primary text-white my-1 me-2"
            >
              Notifications <span className="badge ms-2 bg-secondary">4</span>
            </button>
            <button
              type="button"
              className="ti-btn bg-secondary text-white my-1 me-2"
            >
              Notifications <span className="badge ms-2 bg-primary">7</span>
            </button>
            <button
              type="button"
              className="ti-btn bg-success text-white my-1 me-2"
            >
              Notifications <span className="badge ms-2 bg-danger">12</span>
            </button>
            <button
              type="button"
              className="ti-btn bg-info text-white my-1 me-2"
            >
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <button
              type="button"
              className="ti-btn ti-btn-outline-primary my-1 me-2"
            >
              Notifications{" "}
            ...
            <button
              type="button"
              className="ti-btn ti-btn-outline-secondary my-1 me-2"
            >
              Notifications{" "}
              <span className="badge bg-secondary ms-2 text-white">7</span>
            </button>
            <button
              type="button"
              className="ti-btn ti-btn-outline-success my-1 me-2"
            >
              Notifications{" "}
            ...
            <button
              type="button"
              className="ti-btn ti-btn-outline-info my-1 me-2"
            >
              Notifications{" "}
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="xl:col-span-12 col-span-12">
              ...
              >
                <button
                  type="button"
                  className="ti-btn bg-primary text-white relative me-3"
                >
                  Inbox
                ...
                <button
                  type="button"
                  className="ti-btn bg-secondary text-white relative me-3"
                >
                  Profile
                ...
                <span className="avatar relative me-2">
                  ...
                  />
                  <span className="absolute -top-2 start-[80%] translate-middle p-1 bg-success border border-light !rounded-full">
                    <span className="hidden">New alerts</span>
                  </span>
                </span>
                ...
                <span className="avatar avatar-rounded relative">
                  ...
                  <span className="absolute -top-2 start-[60%] translate-middle badge bg-secondary !rounded-full shadow-lg text-white">
                    1000+
                    <span className="hidden">New alerts</span>
                  </span>
                </span>
                ...
                <div className="flex items-center gap-5 flex-wrap">
                  ...
                  <div>
                    <span className="relative">
                      <svg
                        className="fill-textmuted dark:fill-textmuted/50 w-8 h-8 text-[2rem]"
                      ...
                      <span className="badge !rounded-full bg-success text-white absolute -end-2 top-0">
                        14
                      </span>
                    </span>
                  </div>
                  <div>
                    <span className="badge border dark:border-light bg-light text-defaulttextcolor font-semibold font-[.7rem]">
                  ...
                  <div>
                    <span className="text-badge relative">
                      ...
                      <span className="badge !rounded-full bg-success text-white">
                        32
                      </span>
                    </span>
                  </div>
