          ...
          <Showcode title="Dropdowns" code={dropdown1}>
            <div className="ti-btn-list flex align-center flex-wrap">
              ...
              <div className="hs-dropdown ti-dropdown">
                <Link
                  className="ti-btn ti-btn-secondary-full ti-dropdown-toggle !py-2"
                  href="#!"
                  id="dropdownMenuLink"
                  aria-expanded="false"
                >
            ...
            <div className="ti-btn-list">
              {SingleButtons.map((idx) => (
                <div className="ti-btn-group" key={Math.random()}>
                  <div className="hs-dropdown ti-dropdown">
                    <button
                      className={`ti-btn ti-btn-${idx.class}-full ti-dropdown-toggle`}
                      type="button"
            ...
            <div className="ti-btn-list">
              {SingleButtons.map((idx) => (
                <div className="ti-btn-group" key={Math.random()}>
                  <div className="hs-dropdown ti-dropdown">
                    <button
                      className={`ti-btn ti-btn-${idx.class}-full ti-dropdown-toggle !rounded-full`}
                      type="button"
            ...
            <div className="ti-btn-list">
              {SingleButtons.map((idx) => (
                <div className="ti-btn-group" key={Math.random()}>
                  <div className="hs-dropdown ti-dropdown">
                    <button
                      className={`ti-btn ti-btn-outline-${idx.class} ti-dropdown-toggle `}
                      type="button"
            ...
            <div className="ti-btn-list">
              {SingleButtons.map((idx) => (
                <div className="ti-btn-group" key={Math.random()}>
                  <div className="hs-dropdown ti-dropdown">
                    <button
                      className={`ti-btn ti-btn-outline-${idx.class} ti-dropdown-toggle !rounded-full`}
                      type="button"
                ...
                <div className="ti-btn-group !m-0" key={Math.random()}>
                  <div className="hs-dropdown ti-dropdown">
                    ...
                    <button
                      type="button"
                      aria-label="button"
                      className={`ti-btn ti-btn-${idx.class}-full opacity-[0.85] !rounded-s-none`}
                    >
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Dropdown Sizing" code={dropdown7}>
            <div className="ti-btn-group my-1 me-2 ti-dropdown hs-dropdown">
              <button
                className="ti-btn-primary-full ti-btn-lg ti-dropdown-toggle"
                type="button"
                aria-expanded="false"
              >
                Large button
            ...
            <div className="ti-btn-group my-1 me-2">
              <div className="hs-dropdown ti-dropdown">
                ...
                <button
                  type="button"
                  aria-label="button"
                  className="ti-btn ti-btn-light opacity-[0.85] !rounded-s-none !mb-0"
                >
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
                </button>
            ...
            <div className="ti-btn-group my-1 me-2">
              <div className="hs-dropdown ti-dropdown">
                ...
                <button
                  type="button"
                  aria-label="button"
                  className="ti-btn !py-1 !px-4 !text-[0.75rem]  ti-btn-light opacity-[0.85] !rounded-s-none"
                >
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
                </button>
          ...
          <Showcode title="Dropup" code={dropdown8}>
            <div className="hs-dropdown ti-dropdown [--placement:top-left] m-1">
              ...
              >
                Dropup
                <svg
                  className="hs-dropdown-open:rotate-180 ti-dropdown-caret !text-white"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
              ...
              <div
                className="hs-dropdown-menu  mt-0 transition-none ti-dropdown-menu hidden"
            ...
            <div className="ti-dropdown m-1">
              <button
                type="button"
                className="relative ti-dropdown-toggle  ti-btn ti-btn-secondary-full !py-1 !rounded-e-none !me-0"
              >
                Split dropup
              </button>
              <div className="hs-dropdown ti-dropdown [--placement:top-left]">
                ...
                <div
                  className="hs-dropdown-menu  transition-none mt-0 ti-dropdown-menu hidden"
          ...
          <Showcode title="Dropup Right" code={dropdown9}>
            <div className="hs-dropdown ti-dropdown [--placement:right-top] m-1">
              ...
              >
                Dropright
                <svg
                  className="w-auto h-2.5 ti-dropdown-caret !text-white"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
              ...
              <div
                className="hs-dropdown-menu  ti-dropdown-menu transition-none hidden"
        ...
        <div className="xl:col-span-3 col-span-12">
          <Showcode title="Dropup Left" code={dropdown10}>
            <div className="hs-dropdown ti-dropdown [--placement:left-top] m-1">
              ...
              >
                <svg
                  className="w-auto h-2.5 text-white"
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
          ...
          <Showcode title="Active" code={dropdown11}>
            <div className="hs-dropdown ti-dropdown">
              ...
              <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                ...
                <li>
                  <Link
                    className="ti-dropdown-item active"
                    href="#!"
                    aria-current="true"
                  >
                    Active link
        ...
        <div className="xl:col-span-3 col-span-12">
          <Showcode title="Disabled" code={dropdown12}>
            <div className="hs-dropdown ti-dropdown">
              <button
                type="button"
                className="ti-btn-primary-full ti-dropdown-toggle !py-2"
                aria-expanded="false"
              >
                Dropstart
                <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <ul className="hs-dropdown-menu ti-dropdown-menu hidden">
                ...
                <li>
                  <Link
                    className="ti-dropdown-item disabled"
                    href="#!"
                    aria-current="true"
                  >
                    Active link
          ...
          <Showcode title="Auto Close Behaviour" code={dropdown13}>
            <div className="ti-btn-list">
              <div className="ti-btn-group">
                <div className="hs-dropdown ti-dropdown">
                  <button
                    className="ti-btn ti-btn-primary-full ti-dropdown-toggle"
                    type="button"
                    id="defaultDropdown"
                    aria-expanded="false"
                  >
              ...
              <div className="ti-btn-group">
                <div className="hs-dropdown ti-dropdown">
                  <button
                    className="ti-btn ti-btn-secondary-full ti-dropdown-toggle"
                    type="button"
              ...
              <div className="ti-btn-group">
                <div className="hs-dropdown ti-dropdown">
                  <button
                    className="ti-btn ti-btn-info-full ti-dropdown-toggle"
                    type="button"
              ...
              <div className="ti-btn-group">
                <div className="hs-dropdown ti-dropdown">
                  <button
                    className="ti-btn ti-btn-warning-full ti-dropdown-toggle"
                    type="button"
      ...
      <div className="grid grid-cols-12 gap-6">
            ...
            <div className="ti-btn-list">
              <div className="ti-btn-group">
                <div className="ti-dropdown hs-dropdown">
                  <button
                    className="ti-btn ti-btn-primary-full ti-dropdown-toggle mb-0 !py-2"
                    type="button"
              ...
              <div className="ti-btn-group">
                <div className="ti-dropdown hs-dropdown">
                  <button
                    type="button"
                    className="ti-btn ti-btn-secondary-full ti-dropdown-toggle mb-0 !py-2"
                    aria-expanded="false"
                  >
                    Right-aligned menu
                    <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-btn-group">
                <div
                  className="ti-dropdown hs-dropdown"
                  data-hs-dropdown-strategy="absolute"
                >
                  <button
                    type="button"
                    id="hs-dropdown-left-but-right-on-lg"
                    className="ti-btn ti-btn-info-full ti-dropdown-toggle mb-0 !py-2"
                    aria-expanded="false"
                  >
                  ...
                  <ul
                    className="hs-dropdown-menu ti-dropdown-menu hidden lg:ti-dropdown-menu-end "
              ...
              <div className="ti-btn-group">
                ...
                >
                  <button
                    ...
                    className="ti-btn ti-btn-warning-full ti-dropdown-toggle mb-0 !py-2"
                    aria-expanded="false"
                  >
                  ...
                  <ul
                    className="hs-dropdown-menu ti-dropdown-menu hidden  ti-dropdown-menu-end lg:ti-dropdown-menu-start"
        ...
        <div className="xl:col-span-3 col-span-12">
          <Showcode title="Dark Dropdowns" code={dropdown16}>
            <div className="ti-dropdown hs-dropdown">
              <button
                className="ti-btn ti-btn-dark ti-dropdown-toggle !py-2 dark:hover:!bg-white  dark:hover:!text-black"
                type="button"
              ...
              <ul className="hs-dropdown-menu ti-dropdown-menu !bg-black  hidden">
                <li>
                  <Link
                    className="ti-dropdown-item !text-white dark:!text-defaulttextcolor"
                    href="#!"
                  >
                    Action
                  </Link>
            ...
            <div className="ti-btn-list flex flex-wrap gap-x-2">
              <div className="ti-dropdown hs-dropdown">
                ...
                <ul className="hs-dropdown-menu ti-dropdown-menu !bg-primary hidden">
                  <li>
                    <Link className="ti-dropdown-item !text-white" href="#!">
                      Action
                    </Link>
                  </li>
                  <li>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  className="ti-btn ti-btn-warning-full ti-dropdown-toggle !py-2"
                  type="button"
                  aria-expanded="false"
                >
                  warning
                ...
                <ul className="hs-dropdown-menu ti-dropdown-menu dropmenu-item-warning hidden">
                  <li>
                    <Link className="ti-dropdown-item active" href="#!">
                      Active
                    </Link>
                  </li>
                  <li>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  className="ti-btn ti-btn-info-full ti-dropdown-toggle !py-2"
                  type="button"
                  aria-expanded="false"
                >
                  info
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  className="ti-btn ti-btn-success ti-dropdown-toggle !py-2"
                  type="button"
                  aria-expanded="false"
                >
                  success
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  className="ti-btn ti-btn-danger ti-dropdown-toggle !py-2"
                  type="button"
                  aria-expanded="false"
                >
                  danger
          ...
          <Showcode title="Ghost Button Dropdowns" code={dropdown18}>
            <div className="ti-btn-list flex flex-wrap gap-x-2">
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-primary ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Primary
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-secondary ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Secondary
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-success ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Success
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-info ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Info
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-warning ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Warning
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
              ...
              <div className="ti-dropdown hs-dropdown">
                <button
                  type="button"
                  className="ti-btn ti-btn-ghost-danger ti-dropdown-toggle !py-2 !shadow-none"
                  aria-expanded="false"
                >
                  Danger
                  <i className="ri-arrow-down-s-line align-middle inline-block"></i>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-3 col-span-12">
          <Showcode title="Non-Interactive Dropdown Items" code={dropdown19}>
            <p className=" mb-3">
              Use <code>.ti-dropdown-item-text.</code> to create non-interactive
              dropdown items.
            </p>
            <div className="bd-example">
              <ul className="dropdown-menu border dark:border-defaultborder/10 shadow-sm">
                <li>
                  <span className="!py-2 !px-4 !text-[0.875rem]">
                    Dropdown item text
                  </span>
                </li>
                <li>
