          ...
          >
            <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
              <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-primary me-2"
                  href="#!"
                >
                  Popover Top
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content dark:bg-bodybg !p-0 !max-w-[276px]"
                    role="tooltip"
                  >
        ...
        <div className="xl:col-span-7 col-span-12">
          ...
          >
            <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-secondary me-2"
                  href="#!"
                >
                  Header Secondary
                  <div
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:bottom]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-info me-2"
                  href="#!"
                >
                  Header Info
                  <div
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:left]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-warning me-2"
                  href="#!"
                >
                  Header warning
                  <div
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-success me-2"
                  href="#!"
                >
                  Header success
                  <div
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-danger me-2"
                  href="#!"
                >
                  Header danger
                  <div
        ...
        <div className="xl:col-span-12 col-span-12">
          ...
          >
            <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
              <div className="hs-tooltip ti-main-tooltip  [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-primary-full me-2"
                  href="#!"
                >
                  Primary
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-primary dark:!bg-primary !z-[1000] !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:bottom]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-secondary-full me-2"
                  href="#!"
                >
                  Secondary
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-secondary dark:!bg-secondary !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b !border-solid dark:border-white/10 !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-info-full me-2"
                  href="#!"
                >
                  Info
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-info dark:!bg-info !p-0 !max-w-[276px]  !border-white/10"
                    role="tooltip"
                  >
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-warning-full me-2"
                  href="#!"
                >
                  Warning
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-warning dark:!bg-warning  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:bottom]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-success-full me-2"
                  href="#!"
                >
                  Success
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-success dark:!bg-success  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-danger-full me-2"
                  href="#!"
                >
                  Danger
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-danger dark:!bg-danger  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
        ...
        <div className="xl:col-span-12 col-span-12">
          ...
          >
            <div className="ti-btn-list space-x-2 rtl:space-x-reverse">
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top] ">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-primary me-2"
                  href="#!"
                >
                  Primary
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content dark:bg-bodybg !z-[1000] !p-0 !max-w-[276px] overflow-hidden"
                    role="tooltip"
                  >
                    <div className="!bg-primary/10">
                      ...
                      <p className="!text-primary !text-[0.8rem] !py-4 !px-4 text-start">
                        Popover With primary background
                      </p>
                    </div>
                  </div>
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-secondary me-2"
                  href="#!"
                >
                  Secondary
                  <div
                  ...
                  >
                    <div className="!bg-secondary/10">
                      ...
                      <p className="!text-secondary !text-[0.8rem] !py-4 !px-4 text-start">
                        Popover With secondary background
                      </p>
                    </div>
                  </div>
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-info me-2"
                  href="#!"
                >
                  Info
                  <div
                  ...
                  >
                    <div className="!bg-info/10">
                      ...
                      <p className="!text-info !text-[0.8rem] !py-4 !px-4 text-start">
                        Popover With info background
                      </p>
                    </div>
                  </div>
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-warning me-2"
                  href="#!"
                >
                  Warning
                  <div
                  ...
                  >
                    <div className="!bg-warning/10">
                      ...
                      <p className="!text-warning !text-[0.8rem] !py-4 !px-4 text-start">
                        Popover With warning background
                      </p>
                    </div>
                  </div>
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-success me-2"
                  href="#!"
                >
                  Success
                  <div
                  ...
                  >
                    <div className="!bg-success/10">
                      ...
                      <p className="!text-success !text-[0.8rem] !py-4 !px-4 text-start">
                        Popover With success background
                      </p>
                    </div>
                  </div>
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-danger me-2"
                  href="#!"
                >
                  danger
                  <div
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
              <Link
                className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-primary-full opacity-60"
                href="#!"
              >
                Disabled button
                <div
                  className="hs-tooltip-content ti-main-tooltip-content dark:!bg-bodybg2"
                  role="tooltip"
                >
                  Diabled Popover
                </div>
          ...
          >
            <div className="hs-tooltip ti-main-tooltip me-6 !max-w-[276px] [--trigger:click] [--placement:top]">
              ...
              >
                ...
                <div
                  className="hs-tooltip-content ti-main-tooltip-content !py-4 !px-4 !bg-primary !text-white"
                  role="tooltip"
                >
            ...
            <div className="hs-tooltip ti-main-tooltip !max-w-[276px] [--trigger:click] [--placement:left]">
              ...
              >
                ...
                <div
                  className="hs-tooltip-content ti-main-tooltip-content !bg-secondary !text-white !py-4 !px-4"
                  role="tooltip"
                >
                  <p>The Icon Popover</p>
                </div>
