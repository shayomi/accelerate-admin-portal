            ...
            <div className="box-body deals-content">
              <div className="flex items-center flex-wrap gap-2 justify-between">
                <div className="flex items-center">
                  ...
                  <span className="badge bg-light text-default align-middle">
                    16
                  </span>
                </div>
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    type="button"
                    className="ti-btn ti-btn-success !py-1 !px-2 !text-[0.75rem] btn-wave"
                  >
                    Export As CSV
                  </button>
                  <div className="hs-dropdown ti-dropdown">
                    <Link
                      href="#!"
                      className="ti-btn ti-btn-light !py-1 !px-2 !text-[0.75rem] btn-wave"
                      aria-expanded="false"
                    >
                      Sort By
          ...
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] lead-discovered">
                    Leads Discovered
                  </div>
        ...
        <div className="xxl:col-span-2 md:col-span-4 col-span-12">
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] lead-qualified">
                    Qualified Leads
                  </div>
        ...
        <div className="xxl:col-span-2 md:col-span-4 col-span-12">
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] contact-initiated">
                    Contact Initiated
                  </div>
        ...
        <div className="xxl:col-span-2 md:col-span-4 col-span-12">
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] need-identified">
                    Needs Identified
                  </div>
        ...
        <div className="xxl:col-span-2 md:col-span-4 col-span-12">
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] negotiation">
                    Negotiation
                  </div>
        ...
        <div className="xxl:col-span-2 md:col-span-4 col-span-12">
          <div className="box custom-box">
            <div className="box-body !p-4 deals-content">
              <div className="flex items-start flex-wrap justify-between">
                <div>
                  <div className="font-semibold text-[.9375rem] deal-finalized">
                    Deal Finalized
                  </div>
          ...
          <div className="box custom-box">
            <div className="box-body deals-content">
              <div className="flex items-center font-semibold justify-between gap-1 flex-wrap">
                <div className="flex items-center gap-2">
                  <div className="lh-1">
                    <span className="avatar avatar-sm avatar-rounded">PL</span>
                  </div>
            ...
            <div className="ti-modal-body px-4">
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="xl:col-span-6 col-span-12">
                  <label htmlFor="deal-name" className="form-label">
                    Contact Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="xl:col-span-6 col-span-12">
                  <label htmlFor="deal-lead-score" className="form-label">
                    Deal Value
                  </label>
                  <input
                    type="number"
