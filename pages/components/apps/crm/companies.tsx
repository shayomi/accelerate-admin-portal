                      ...
                      >
                        ...
                        <td>
                          <div className="flex items-center flex-wrap gap-1">
                            <span
                              className={`badge bg-${idx.color} text-${idx.class}`}
                            >
                              {idx.badge}
                            </span>
                          </div>
                        ...
                        <td>
                          <div className="btn-list">
                            <button
                              aria-label="button"
                              type="button"
                              className="ti-btn ti-btn-sm ti-btn-warning  me-2"
                            ...
                            <button
                              aria-label="button"
                              type="button"
                              className="ti-btn ti-btn-sm ti-btn-info  me-2"
                            >
      ...
      >
        <div className="ti-offcanvas-body !p-0">
          <div className="sm:flex items-start p-6 border-b border-dashed border-defaultborder main-profile-cover">
            <div>
              <span className="avatar avatar-xxl avatar-rounded me-3 bg-light/10 p-2">
                <img
                  src="../../../../assets/images/company-logos/12.png"
                  alt=""
                />
              </span>
            </div>
          ...
          <div className="p-6 border-b border-dashed border-defaultborder flex items-center gap-3">
            ...
            <div>
              <span className="badge bg-primary/10 m-1">Corporate</span> - 1001+
              Employees
            </div>
          </div>
          <div className="p-4 flex items-center gap-3">
            <div className="text-[.875rem] font-semibold">Key Contact :</div>
            <div className="flex items-center gap-2">
              <div className="leading-none">
                <span className="avatar avatar-rounded avatar-sm">
          ...
          <div className="ti-modal-content">
            ...
            <div className="ti-modal-body px-4">
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="xl:col-span-12 col-span-12">
                  <label htmlFor="company-mail" className="form-label">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="xl:col-span-12 col-span-12">
                  <label htmlFor="key-contact" className="form-label">
                    Key Contact
                  </label>
                  <input
                    type="text"
