          ...
          <div className="box custom-box">
            <div className="box-header flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  className="ti-btn ti-btn-success !py-1 !px-2 !text-[0.75rem] !m-0"
                >
                  Export As CSV
                </button>
                ...
                <table className="table whitespace-nowrap min-w-full">
                  ...
                  <tbody>
                    {manageCompanydata.map((idx) => (
                      <tr
                        className="border border-defaultborder crm-contact min-w-full"
                        key={Math.random()}
                      >
                        <td>
                          <input
                        ...
                        <td>
                          <div className="flex items-center flex-wrap gap-1">
                            <span className={`badge bg-${idx.color1}`}>
                              {idx.text3}
                            </span>
                            <span className={`badge bg-${idx.color2}`}>
                              {idx.text4}
                            </span>
                          </div>
                        </td>
