				...
				<div className="xl:col-span-9 col-span-12">
					<div className="box custom-box">
						<div className="box-header justify-between flex">
							...
							<div>
								<Link
									href="/components/apps/projects/create-project/"
                ...
                Key tasks :
                    ...
                    consistent and visually appealing.
							...
							<div>
								...
								<span className="badge me-2 bg-light text-default">
                  JavaScript
								</span>
								<span className="badge me-2 bg-light text-default">
                  Responsive Design
                  ...
                  Angular
					...
					<div className="box custom-box">
                      ...
                      E
										...
										<p className="mb-2">
											<b>You</b> Commented on <b>Work Process</b> in this
                      project{" "}
                      ...
                      Project is important and need to be completed on time to
                      meet company work flow.
										</p>
									</div>
								</li>
								<li>
                  ...
                  Add Member
                        ...
                        Actions
                          ...
                          UI Developer
										...
										<tr className="border border-defaultborder">
											...
											<td>
												<span className="badge bg-pink/10 text-pink">
                          Ui Designer
												</span>
											</td>
											<td>
					...
					<div className="box custom-box">
						<div className="box-header justify-between">
							...
							<div className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light btn-wave">
								<i className="ri-add-line align-middle me-1 font-semibold"></i>
                Add Goal
							</div>
						</div>
                        ...
                        0.45MB
								...
								<li className="list-group-item">
									<div className="flex items-center">
										...
										<div className="flex-grow">
											<Link href="#!">
												<span className="block font-semibold">assets.zip</span>
											</Link>
											<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] font-normal">
                        0.99MB
											</span>
								...
								<li className="list-group-item">
									<div className="flex items-center">
										...
										<div className="flex-grow">
											<Link href="#!">
												<span className="block font-semibold">image-1.png</span>
											</Link>
											<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] font-normal">
                        245KB
											</span>
								...
								<li className="list-group-item">
									<div className="flex items-center">
										...
										<div className="flex-grow">
											<Link href="#!">
												<span className="block font-semibold">doc.zip</span>
											</Link>
											<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] font-normal">
                        2MB
											</span>
								...
								<li className="list-group-item">
									<div className="flex items-center">
										...
										<div className="flex-grow">
											<Link href="#!">
												<span className="block font-semibold">landing.zip</span>
											</Link>
											<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] font-normal">
                        3.46MB
											</span>
