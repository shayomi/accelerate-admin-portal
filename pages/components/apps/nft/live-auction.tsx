import {
	Liveauctiondata,
	Liveauctiondata1,
} from "@/shared/data/apps/nft/liveacuationdata";
		...
		<Fragment>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xxl:col-span-9 col-span-12">
					<div className="flex items-center justify-between flex-wrap gap-2 mb-4">
						<div className="nft-tag nft-tag-primary active">
							...
							<span className="nft-tag-icon">
								<i className="ti ti-world text-[1.25rem]"></i>
							</span>
						...
						<div className="nft-tag nft-tag-secondary">
							...
							></Link>
							<span className="nft-tag-icon">
								<i className="ti ti-flame text-[1.25rem]"></i>
							</span>
						...
						<div className="nft-tag nft-tag-info">
							...
							></Link>
							<span className="nft-tag-icon">
								<i className="ti ti-palette text-[1.25rem]"></i>
							</span>
						...
						<div className="nft-tag nft-tag-success">
							...
							></Link>
							<span className="nft-tag-icon">
								<i className="ti ti-device-gamepad-2 text-[1.25rem]"></i>
							</span>
						...
						<div className="nft-tag nft-tag-danger">
							...
							></Link>
							<span className="nft-tag-icon">
								<i className="ti ti-tie text-[1.25rem]"></i>
							</span>
						...
						<div className="nft-tag nft-tag-warning">
							...
							></Link>
							<span className="nft-tag-icon">
								<i className="ti ti-music text-[1.25rem]"></i>
							</span>
					...
					<h6 className="font-semibold !text-defaulttextcolor">
            Live Auction:
					</h6>
					<div className="grid grid-cols-12 gap-x-6">
						{Liveauctiondata.map((idx) => (
							<div
								className="xxxl:col-span-3 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12"
								key={Math.random()}
							>
								<div className="box custom-box">
									<div className="box-body !p-4">
										<div className="mb-4 overflow-hidden relative">
											...
											/>
											<Link href="#!" className="nft-btn" aria-label="Like">
												<i className="ti ti-heart"></i>
											</Link>
											<span className="nft-timer-container">
												<i className="ti ti-bolt text-[.875rem]"></i>
												<span className="nft-timer ms-1 text-[0.6875rem]">
                          04 Days 03 : 44 : 04
												</span>
											</span>
										</div>
										<div className="flex justify-between items-start mb-4 flex-wrap">
											<div className="inline-flex items-start relative">
												...
												<div className="flex-grow">
													<span className="mb-0 block text-[.875rem] font-semibold">
														{idx.name}
													</span>
										...
										<div className="flex items-end flex-wrap gap-2">
											<div className="flex-grow">
												<p className="text-[.875rem] mb-1 text-[#8c9097] dark:text-white/50">
                          Highest Bid
												</p>
						...
						<div className="xl:col-span-12 col-span-12">
							<div className="box custom-box overflow-hidden">
								<div className="box-header justify-between">
									<div className="box-title">Featured Creators</div>
									<div>
										<button
											type="button"
											className="ti-btn ti-btn-primary !py-1 !px-2 !text-[0.75rem] btn-wave"
										>
                      View All
										</button>
									</div>
							...
							<div className="box custom-box overflow-hidden">
								<div className="box-header justify-between">
									...
									<div className="hs-dropdown ti-dropdown">
										<Link
											href="#!"
											className="p-2 text-[.75rem] text-[#8c9097] dark:text-white/50"
											aria-expanded="false"
										>
                      Today
                          ...
                          Last Week
                              ...
                              DreamSpace
														...
														<span className="text-[.75rem] text-[#8c9097] dark:text-white/50 ms-2">
                              24 mins ago
														</span>
													</div>
                            ...
                            for{" "}
														<span className="text-success font-semibold text-[.75rem]">
                              0.57ETH
														</span>
                            .
													</div>
										...
										<li className="list-group-item !border-e-0 !border-s-0">
											<div className="flex gap-4 items-center flex-wrap">
												...
												<div>
													<div className="mb-1">
														<span className="font-semibold">DreamSpace</span>
														<span className="text-[.75rem] text-[#8c9097] dark:text-white/50 ms-2">
                              16 mins ago
														</span>
													</div>
                            ...
                            You started following mark zensberg.
										...
										<li className="list-group-item !border-e-0 !border-s-0">
											<div className="flex gap-4 items-center">
												...
												<div>
													<div className="mb-1">
														<span className="font-semibold">Neo Nebulae</span>
														<span className="text-[.75rem] text-[#8c9097] dark:text-white/50 ms-2">
                              5 mins ago
														</span>
													</div>
                            ...
                            You showed interest in purchasing{" "}
														<Link
															href="#!"
															className="text-[.75rem] text-warning font-semibold"
														>
                              NeoNebulae
														</Link>
                            .
                            ...
                            for{" "}
														<span className="font-semibold text-[.75rem] text-pink">
                              1.345ETH
														</span>
                            .
													</div>
