					...
					<div className="xl:col-span-3 col-span-12">
						<div className="box custom-box overflow-hidden">
							<div className="box-header !border-b-0">
								<div className="box-title">Choose Network</div>
							</div>
									...
									<li className="list-group-item rounded-b-md">
										...
										<div className="flex items-center gap-2">
											<div>
												<span className="avatar avatar-rounded avatar-sm bg-light p-1">
													<img
														src="../../../../assets/images/nft-images/38.png"
														alt=""
													/>
												</span>
											</div>
					...
					<div className="xl:col-span-9 col-span-12">
						<div className="box custom-box">
							<div className="box-header justify-between">
								<div className="box-title">Choose Wallet</div>
								<div>
									<button
										type="button"
                    ...
                    Add New Wallet
											...
											<div className="flex items-center justify-center gap-4">
												<div className="leadining-none">
													<span className="avatar avatar-rounded p-2 bg-light">
														<img
															src="../../../../assets/images/nft-images/42.png"
															alt=""
														/>
													</span>
												</div>
										...
										<div className="p-4 text-center hover:bg-light border dark:border-defaultborder/10 rounded-md relative">
											...
											<div className="flex items-center justify-center gap-4">
												<div className="lh-1">
													<span className="avatar avatar-rounded p-2 bg-light">
														<img
															src="../../../../assets/images/nft-images/41.png"
															alt=""
														/>
													</span>
												</div>
											...
											<div className="flex items-center justify-center gap-4">
												<div className="lh-1">
													<span className="avatar avatar-rounded bg-light">
														<img
															src="../../../../assets/images/nft-images/43.png"
															alt=""
														/>
													</span>
												</div>
											...
											<div className="flex items-center justify-center gap-4">
												<div className="lh-1">
													<span className="avatar avatar-rounded bg-light p-2">
														<img
															src="../../../../assets/images/nft-images/40.png"
															alt=""
														/>
													</span>
												</div>
										...
										<div className="p-4 !text-center hover:bg-light border dark:border-defaultborder/10 rounded-md relative">
											...
											<div className="flex items-center justify-center gap-4">
												<div className="lh-1">
													<span className="avatar avatar-rounded bg-light p-2">
														<img
															src="../../../../assets/images/nft-images/44.png"
															alt=""
														/>
													</span>
												</div>
										...
										<div className="p-4 text-center hover:bg-light border dark:border-defaultborder/10 rounded-md relative">
											...
											<div className="flex items-center justify-center gap-4">
												<div className="lh-1">
													<span className="avatar avatar-rounded bg-light">
														<img
															src="../../../../assets/images/nft-images/45.png"
															alt=""
														/>
													</span>
												</div>
							...
							<div className="box-footer">
								<div>
									<button
										type="button"
										className="ti-btn ti-btn-success-full ltr:float-right rtl:float-left btn-wave"
									>
                    Connect
									</button>
								</div>
