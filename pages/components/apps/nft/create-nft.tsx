		...
		<Fragment>
			...
			<div className="grid grid-cols-12 gap-6">
				<div className="xxl:col-span-9 xl:col-span-8 col-span-12">
					<div className="box custom-box">
                        ...
                        NFT Title
										...
										<div className="xl:col-span-12 col-span-12">
											<label htmlFor="nft-description" className="form-label">
                        NFT Description
											</label>
											<textarea
												className="form-control"
										...
										<div className="xl:col-span-12 col-span-12">
											<label htmlFor="nft-link" className="form-label">
                        External Link
											</label>
											<input
												type="text"
								...
								<div className="xl:col-span-12 col-span-12">
									<div className="grid grdi-cols-12  sm:gap-x-4 gap-y-4">
										<div className="xl:col-span-6 col-span-12">
											<label htmlFor="nft-creator-name" className="form-label">
                        Creator Name
											</label>
											<input
												type="text"
										...
										<div className="xl:col-span-6 col-span-12">
											<label htmlFor="nft-price" className="form-label">
                        NFT Price
											</label>
											<input
												type="text"
										...
										<div className="xl:col-span-4 col-span-12">
											<label htmlFor="nft-size" className="form-label">
                        NFT Size
											</label>
											<input
												type="text"
										...
										<div className="xl:col-span-4 col-span-12">
											<label htmlFor="nft-property" className="form-label">
                        Property
											</label>
											<input
												type="text"
										...
										<div className="xl:col-span-12 col-span-12">
											...
											>
												...
												/>
												<label
													className="!mb-0 ti-btn !block sm:!inline-flex !py-1 !px-2 ti-btn-primary !bg-primary !text-white z-0 !rounded-e-none !border-e-0"
													htmlFor="strap1"
												>
													<i className="ti ti-tag me-1 align-middle text-[0.9375rem] inline-block"></i>
                          Fixed Price
												</label>
												<input
													type="radio"
												...
												/>
												<label
													className="!mb-0 ti-btn !block sm:!inline-flex !py-1 !px-2 ti-btn-outline-primary text-default !rounded-none !border-e-0 z-0"
													htmlFor="strap2"
												>
													<i className="ti ti-users text-[0.9375rem] me-1 align-middle inline-block"></i>
                          Open For Bids
												</label>
												<input
													type="radio"
												...
												/>
												<label
													className="!mb-0 ti-btn !block sm:!inline-flex !py-1 !px-2 ti-btn-outline-primary !rounded-s-none text-default z-0"
													htmlFor="strap3"
												>
													<i className="ti ti-hourglass-low text-[0.9375rem] me-1 align-middle inline-block"></i>
                          Timed Auction
												</label>
											</div>
										</div>
						...
						<div className="box-footer text-end">
							<Link
								href="#!"
								className="ti-btn ti-btn-primary-full btn-wave waves-effect waves-light"
							>
                Create NFT
							</Link>
						</div>
				...
				<div className="xxl:col-span-3 xl:col-span-4 col-span-12">
					<div className="box custom-box">
						<div className="box-header">
							<div className="box-title">NFT Preview Here</div>
						</div>
						<div className="box-body">
								...
								<div className="flex items-center justify-between nft-like-section w-full px-3">
									<div className="flex-fill">
										<button
											aria-label="button"
											type="button"
											className="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light"
										>
