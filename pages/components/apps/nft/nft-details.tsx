	...
	return (
		<Fragment>
			...
			<Pageheader
				...
				activepage="NFT"
				mainpage="NFT Details"
			/>
			<div className="container">
				<div className="box custom-box overflow-hidden">
					<div className="box-body">
						<span className="nft-details-auction-time shadow rtl:rotate-[315deg]">
              24hrs : 32mins : 11sec
						</span>
                        ...
                        thumbsSwiper && !thumbsSwiper.destroyed
                        	...
                        	: null,
									...
									>
										<SwiperSlide id="img-container">
											<img
												...
												src="../../../../assets/images/nft-images/32.png"
												alt="img"
											/>
										</SwiperSlide>
										<SwiperSlide className="image-container">
											<img
												className="img-fluid !rounded-md"
												src="../../../../assets/images/nft-images/31.png"
												alt="img"
											/>
										</SwiperSlide>
										<SwiperSlide className="image-container">
											<img
												className="img-fluid !rounded-md"
												src="../../../../assets/images/nft-images/30.png"
												alt="img"
											/>
										</SwiperSlide>
										<SwiperSlide className="image-container">
											<img
												className="img-fluid !rounded-md"
												src="../../../../assets/images/nft-images/33.png"
												alt="img"
											/>
										</SwiperSlide>
									</Swiper>
									...
									<div className="grid mt-4">
										<button
											type="button"
											className="ti-btn ti-btn-primary-full btn-wave"
										>
                      Place a bid
										</button>
									</div>
													...
													<td>
														<Link href="#!">
															<div className="flex items-start">
																<div className="similar-products-image me-2">
																	<img
																		src="../../../../assets/images/nft-images/19.png"
																		alt=""
																	/>
																</div>
																<div className="flex-grow">
													...
													<td>
														<Link href="#!">
															<div className="flex items-start">
																<div className="similar-products-image me-2">
																	<img
																		src="../../../../assets/images/nft-images/22.png"
																		alt=""
																	/>
																</div>
																<div className="flex-grow">
                    ...
                    Digital Dream Space - NFT Digital Art
									</p>
									<p className="text-[1.125rem] mb-4">
										...
										<span className="font-semibold text-[#8c9097] dark:text-white/50">
											<Link
												className="text-info text-[0.875rem] ms-2"
												href="#!"
											>
                        (2.4k Likes)
											</Link>
									...
									<div className="grid grid-cols-12 mb-6">
										<div className="xxl:col-span-3 xl:col-span-12 col-span-12">
											<p className="mb-1 leading-none text-[.6875rem] text-success font-semibold">
                        Special Offer
											</p>
											<p className="mb-1">
												<span className="h3">
                          ...
                          1.299<sup className="text-[0.875rem]">.00</sup>
												</span>
                      ...
                      "Digital Dreamscape" is a mesmerizing NFT artwork created
                      by a renowned digital artist. This unique piece takes
                      viewers on a journey through a vivid and ethereal world,
                      where vibrant colors blend seamlessly with abstract forms.
                      The artwork is a digital representation of the artist's
                      imagination, combining elements of surrealism and
                      ...
                      Features :
                            ...
                            Country of origin: USA
													...
													<li className="text-[#8c9097] dark:text-white/50">
                            Exhibition History: Digital Art Expo 2023 - Gallery
                            XYZ, New York City
													</li>
												</ul>
											</div>
                      ...
                      Reviews &amp; Ratings :
                              ...
                              Based on (23) ratings
												...
												<div className="flex items-center mb-4">
													<div className="text-[0.75rem] me-2 font-semibold">
                            5
													</div>
													<i className="ri-star-fill text-[0.625rem] me-1"></i>
													<div className="progress progress-xs flex-grow">
														<div
															className="progress-bar !bg-success !text-white w-[55%]"
															role="progressbar"
															aria-valuenow={55}
															aria-valuemin={0}
															aria-valuemax={100}
                            ...
                            4{" "}
													...
													<div className="progress progress-xs flex-grow">
														<div
															className="progress-bar !bg-success !text-white w-[22%]"
															role="progressbar"
															aria-valuenow={22}
															aria-valuemin={0}
															aria-valuemax={100}
                            ...
                            3{" "}
													...
													<div className="progress progress-xs flex-grow">
														<div
															className="progress-bar !bg-success !text-white w-[8%]"
															role="progressbar"
															aria-valuenow={8}
															aria-valuemin={0}
															aria-valuemax={100}
                            ...
                            2{" "}
													...
													<div className="progress progress-xs flex-grow">
														<div
															className="progress-bar !bg-warning w-[9%]"
															role="progressbar"
															aria-valuenow={9}
															aria-valuemin={0}
															aria-valuemax={100}
                            ...
                            1{" "}
													...
													<div className="progress progress-xs flex-grow">
														<div
															className="progress-bar !bg-danger w-[6%]"
															role="progressbar"
															aria-valuenow={6}
															aria-valuemin={0}
															aria-valuemax={100}
                            ...
                            (1)
                              ...
                              Digital Dreamspace is a truly captivating NFT that
                              takes you on an unforgettable journey. The
                              artwork's vivid colors and ethereal elements
													...
													<div className="product-images sm:!ps-4 !ps-0">
														<div className="grid grid-cols-12 sm:gap-6">
															...
															<div className="xl:col-span-6 col-span-12 flex items-end sm:justify-end sm:mt-0 mt-2 flex-wrap">
																<button
																	type="button"
																	className="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2"
																>
                                  Report abuse
																</button>
																<button
