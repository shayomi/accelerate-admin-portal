            ...
            <div className="box-header justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="ti-dropdown hs-dropdown">
                  <Link
                    href="#!"
                    className="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem] waves-effect waves-light"
                    aria-expanded="false"
                  >
                    Sort By
                ...
                <div>
                  <button
                    type="button"
                    className="ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave"
                  >
                    View All
                  </button>
                </div>
              ...
              <div className="table-responsive">
                <table className="table whitespace-nowrap table-bordered min-w-full">
                  ...
                  <tbody>
                    {allData.map((idx) => (
                      <tr
                        className="border border-defaultborder transaction"
                        key={Math.random()}
                      >
                        <td>
                          <span className="avatar avatar-sm avatar-rounded bg-light">
                            <i
                              className={`ti ti-arrow-narrow-${idx.class} text-${idx.color1} font-semibold text-[1rem]`}
                            ></i>
                          </span>
                        </td>
                        <td>
                        ...
                        <td>
                          <span
                            className={`badge bg-${idx.color2}/10 text-${idx.color2}`}
                          >
                            {idx.text2}
                          </span>
                        </td>
                        <td>
                          <div className="hs-tooltip ti-main-tooltip">
                            <button
                              type="button"
                              className="hs-tooltip-toggle me-2 ti-btn ti-btn-primary ti-btn-sm"
                            >
                              <span>
                          ...
                          <div className="hs-tooltip ti-main-tooltip">
                            <button
                              type="button"
                              className="hs-tooltip-toggle ti-btn ti-btn-danger  ti-btn-sm transaction-delete-btn"
                            >
                              <span onClick={() => handleRemove(idx.id)}>
              ...
              <div className="box-body !p-0">
                <div className="p-6 border-b dark:border-defaultborder/10 border-dashed flex items-start flex-wrap gap-2">
                  ...
                  <div className="flex-grow">
                    <h6 className="mb-2 text-[0.75rem]">
                      New Transactions
