import {
	...
	CapETH,
	CapEtherium,
} from "@/shared/data/apps/crypto/marcketcapdata";
		...
		<Fragment>
						...
						<div className="box-body">
							<div className="sm:flex items-center mb-4">
								<div className="flex items-center">
									...
									<div className="mb-0 font-semibold">Bitcoin - BTC</div>
								</div>
                    ...
                    (+2.33%)
						...
						<div className="box-footer !p-0">
							<div className="list-group border-0">
								<Link
									href="#!"
									className="py-3 !px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 !border-b dark:border-defaultborder/10 "
								>
									<div className="sm:flex w-full justify-between items-center">
										<p className="tx-14 mb-0 font-weight-semibold text-dark">
                      Price Change{" "}
											<span className="badge bg-primary/10  ms-4 text-primary">
                        Increased
											</span>
										</p>
								...
								<Link
									href="#!"
									className="py-3 !px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 "
								>
									<div className="flex w-full justify-between items-center">
										<p className="tx-14 mb-0 font-weight-semibold text-dark">
                      Market Rank
											<span className="badge bg-secondary/10 text-secondary ms-4">
                        3 Years
											</span>
										</p>
						...
						<div className="box-body">
							<div className="sm:flex items-center mb-4">
								<div className="flex items-center">
									...
									<div className="mb-0 font-semibold">Etherium - ETH</div>
								</div>
								<div className="ms-auto">
							...
							<div className="list-group border-0">
								...
								>
									<div className="sm:flex w-full justify-between items-center">
										<p className="tx-14 mb-0 font-weight-semibold text-dark">
                      Price Change{" "}
											<span className="badge bg-primary/10 ms-3 text-primary">
                        Increased
											</span>
										</p>
										<p className="text-success mb-0 font-weight-normal tx-13">
											<span className="numberfont">+2,044.24(1.32%)</span>{" "}
											<i className="fa fa-arrow-up"></i> today
										</p>
									</div>
								</Link>
								<Link
									href="#!"
									className="py-3 px-[1.25rem] flex flex-col items-start border-topacity-0 border-start-0 border-end-0 "
								>
									<div className="flex w-full justify-between items-center">
										<p className="tx-14 mb-0 font-weight-semibold text-dark">
                      Market Rank
						...
						<div className="box-body">
							<div className="sm:flex items-center mb-4">
								<div className="flex items-center">
									...
									<div className="mb-0 font-semibold">Dash - DASH</div>
								</div>
								<div className="ms-auto">
                    ...
                    (+112.95%)
                      ...
                      Price Change{" "}
                        ...
                        Increased
										...
										<p className="text-success mb-0 font-weight-normal tx-13">
											<span className="numberfont">+40.17 (1.52%)</span>{" "}
											<i className="fa fa-arrow-up"></i> today
										</p>
									</div>
								</Link>
								<Link
									href="#!"
									className="py-3 px-[1.25rem] flex flex-col items-start border-t-0 border-x-0 !border-b-0 "
								>
									<div className="flex w-full justify-between items-center">
										<p className="tx-14 mb-0 font-weight-semibold text-dark">
                      Market Rank
				...
				<div className="xxl:col-span-3 xl:col-span-6 lg:col-span-12 col-span-12">
					<div className="box custom-box overflow-hidden">
						<div className="box-header justify-between">
							<div className="box-title">My Top Currencies</div>
							<div>
								<button
									type="button"
									className="ti-btn ti-btn-info !py-1 !px-2 !text-[0.75rem] btn-wave"
								>
                  View All
								</button>
							</div>
			...
			<div className="grid grid-cols-12 gap-6">
				<div className="xl:col-span-12 col-span-12">
					<div className="box custom-box">
						<div className="box-header justify-between">
							<div className="box-title">Crypto MarketCap</div>
                    ...
                    Sort By
                        ...
                        All-Time High (ATH)
								...
								<div>
									<button
										type="button"
										className="ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem]"
									>
                    View All
									</button>
								</div>
							...
							<div className="table-responsive">
								<table className="table whitespace-nowrap min-w-full">
									<thead>
										<tr>
											<th scope="col"></th>
											<th scope="col" className="font-semibold text-start">
                        #
											</th>
                        ...
                        Trade
										...
										<tr className="border border-defaultborder">
											...
											<td>
												<span className="text-danger font-semibold">
													<i className="ti ti-arrow-narrow-down text-[.9375rem] font-semibold"></i>
                          0.483%
												</span>
											</td>
											<td>
												<span className="text-success font-semibold">
													<i className="ti ti-arrow-narrow-up text-[.9375rem] font-semibold"></i>
                          0.239%
												</span>
											</td>
											<td>
                            ...
                            19.43M of (21M)
													...
													<div className="progress-stacked progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success opacity-[0.5] w-[88%]"
															role="progressbar"
															aria-valuenow={88}
															aria-valuemin={0}
															aria-valuemax={100}
														></div>
														<div
															className="progress-bar !rounded-s-none !rounded-e-full !bg-danger opacity-[0.5] w-[12%]"
															role="progressbar"
															aria-valuenow={12}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          0.29%
                            ...
                            $2.83B USD
											...
											<td>
												<Link href="#!">
													<span className="font-semibold block">120M</span>
												</Link>
											</td>
											<td>
												<div id="eth-chart">
                          ...
                          34.96%
                            ...
                            1,000M
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !rounded-full !bg-success opacity-[0.5] w-full"
															role="progressbar"
															aria-valuenow={100}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          1.24%
                            ...
                            11.37M of (18.92M)
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success opacity-[0.5] w-[56%]"
															role="progressbar"
															aria-valuenow={56}
															aria-valuemin={0}
															aria-valuemax={100}
														></div>
														<div
															className="progress-bar !rounded-s-none !rounded-e-full !rounded-full !bg-danger opacity-[0.5] w-[44%]"
															role="progressbar"
															aria-valuenow={44}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          2.22%
                            ...
                            73.40M
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success !rounded-full opacity-[0.5] w-full"
															role="progressbar"
															aria-valuenow={100}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          0.91%
                            ...
                            52.54B of (100B)
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success opacity-[0.5] w-[52%]"
															role="progressbar"
															aria-valuenow={52}
															aria-valuemin={0}
															aria-valuemax={100}
														></div>
														<div
															className="progress-bar !rounded-s-none !rounded-e-full !bg-danger opacity-[0.5] w-[48%]"
															role="progressbar"
															aria-valuenow={48}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          20.65%
                            ...
                            10.1B of (105B)
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success opacity-[0.5] w-[10%]"
															role="progressbar"
															aria-valuenow={10}
															aria-valuemin={0}
															aria-valuemax={100}
														></div>
														<div
															className="progress-bar !rounded-s-none !rounded-e-full  !bg-danger opacity-[0.5] w-[90%]"
															role="progressbar"
															aria-valuenow={90}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          27.12%
                            ...
                            184.02B of (184.07B)
													...
													<div className="progress-stacked  progress-xs w-[75%] mb-4 flex">
														<div
															className="progress-bar !bg-success opacity-[0.5] w-[99%]"
															role="progressbar"
															aria-valuenow={99}
															aria-valuemin={0}
															aria-valuemax={100}
														></div>
														<div
															className="progress-bar !rounded-s-none !rounded-e-full  !bg-danger opacity-[0.5] w-[1%]"
															role="progressbar"
															aria-valuenow={1}
															aria-valuemin={0}
															aria-valuemax={100}
                          ...
                          1.41%
                            ...
                            $7.50M USD
											...
											<td>
												<Link href="#!">
													<span className="font-semibold block">2.78B</span>
												</Link>
											</td>
											<td>
												<div id="iota-chart">
                          ...
                          3.48%
                            ...
                            $105.8M USD
											...
											<td>
												<Link href="#!">
													<span className="font-semibold block">18.15M</span>
												</Link>
											</td>
											<td>
												<div id="monero-chart">
