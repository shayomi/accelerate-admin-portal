			...
			<div className="container">
				<div className="grid grid-cols-12 gap-6">
                      ...
                      In USD
							...
							<div className="box-footer">
								<div className="btn-list text-center">
									<button
										type="button"
										className="ti-btn ti-btn-primary min-w-[9.375rem] me-1 btn-wave"
									>
                    Deposit
									</button>
									<button
										type="button"
										className="ti-btn ti-btn-success min-w-[9.375rem] btn-wave"
									>
                    Withdraw
									</button>
								</div>
						...
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">ETH WALLET</div>
							</div>
							<div className="box-body">
								<div className="flex items-center justify-between gap-2">
									<div className="flex items-center gap-2">
                    ...
                    Withdraw
						...
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">XRP WALLET</div>
							</div>
							<div className="box-body">
								<div className="flex items-center justify-between gap-2">
									<div className="flex items-center gap-2">
                    ...
                    Withdraw
						...
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">LTC WALLET</div>
							</div>
							<div className="box-body">
								<div className="flex items-center justify-between gap-2">
									<div className="flex items-center gap-2">
							...
							<div className="xl:col-span-12 col-span-12">
								<div className="box custom-box">
									<div className="box-header justify-between">
										<div className="box-title">BTC Wallet Address</div>
										<div>
											<button
												type="button"
												className="ti-btn ti-btn-outline-primary ti-btn-wave"
											>
                        Connect
											</button>
										</div>
                            ...
                            Copy
											...
											<div>
												<span className="avatar avatar-xxl border dark:border-defaultborder/10">
													<img
														src="../../../../assets/images/media/media-89.png"
														className="p-1 qr-image"
														alt=""
													/>
												</span>
											</div>
                                ...
                                6.2834{" "}
																<span className="text-[0.75rem] text-[#8c9097] dark:text-white/50 font-normal">
                                  BTC
																</span>
															</span>
														</div>
								...
								<div className="box custom-box">
									<div className="box-header justify-between">
										<div className="box-title">ETH Wallet Address</div>
										<div>
											<button
												type="button"
												className="ti-btn ti-btn-outline-primary ti-btn-wave"
                        ...
                        Connect
                          ...
                          Wallet Address
                            ...
                            Copy
								...
								<div className="box custom-box">
									<div className="box-header justify-between">
										<div className="box-title">LTC Wallet Address</div>
										<div>
											<button
												type="button"
												className="ti-btn ti-btn-outline-primary ti-btn-wave"
