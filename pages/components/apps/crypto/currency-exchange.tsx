import {
	...
	CurrencyOptions2,
	CurrencyXRS,
} from "@/shared/data/apps/crypto/currencydata";
								...
								<div className="p-4 mb-4 rounded currency-exchange-area">
									<div className="grid grid-cols-12 sm:gap-4 gap-2">
										<div className="xxl:col-span-3 col-span-12">
											<input
												type="text"
												className="form-control dark:!bg-bodybg"
												defaultValue="0.0453"
										...
										<div className="xxl:col-span-2 col-span-12">
											<div>
												<Select
													...
													className=""
													defaultValue={[CurrencyOptions1[0]]}
													menuPlacement="auto"
												/>
											</div>
										</div>
                        ...
                        =
										...
										<div className="xxl:col-span-2 col-span-12">
											<Select
												...
												className=""
												defaultValue={[CurrencyOptions2[0]]}
												menuPlacement="auto"
												classNamePrefix="Select2"
											/>
										</div>
								...
								<div className="text-center">
									<button
										type="button"
										className="ti-btn ti-btn-success-full btn-wave"
									>
                    Exchange Now
									</button>
								</div>
			...
			<div className="grid grid-cols-12 gap-x-6 justify-center">
                    ...
                    24.3%{" "}
                      ...
                      24H
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-primary">
                    0.00434
									</span>
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-secondary">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-success">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-warning">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-pink">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-purple">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-danger">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-3 col-span-12">
                    ...
                    17.67%{" "}
                      ...
                      +1.30
								...
								<div className="text-end">
									<span className="block text-[.875rem] mb-1 text-info">
                    1.2923
									</span>
									<span className="block text-success font-semibold">
                    $2,283.73
				...
				<div className="xl:col-span-12 col-span-12">
					<div className="text-center my-6">
						<button
							className="ti-btn ti-btn-primary !border !border-primary"
							type="button"
							disabled
						>
							<span
								className="ti-spinner  !w-[1rem] !h-[1rem] align-middle"
								role="status"
								aria-hidden="true"
							></span>
              Loading...
