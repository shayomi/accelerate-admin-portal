import {
	...
	Data2,
	SellStatistics,
} from "@/shared/data/apps/crypto/buy&selldata";
			...
			<div className="container">
				<div className="sm:grid grid-cols-12 gap-6">
					<div className="xl:col-span-4 col-span-12">
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">Buy Crypto</div>
							</div>
							<div className="box-body crypto-data">
								<div>
									<div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
										<input
											type="text"
											className="form-control crypto-buy-sell-input border-e-0 form-control-sm"
									...
									<div>
										<div className="text-[.875rem] py-2">
											<span className="font-semibold text-dark">Price:</span>
											<span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem] inline-block">
                        6.003435
											</span>
											<span className="text-dark font-semibold ltr:float-right rtl:float-left">
                        BTC
											</span>
										</div>
										<div className="text-[.875rem] py-2">
											<span className="font-semibold text-dark">Amount:</span>
											<span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem] inline-block">
                        2,34,4543.00
											</span>
											<span className="text-dark font-semibold ltr:float-right rtl:float-left">
                        LTC
										...
										<div className="font-semibold text-[.875rem] py-2">
                      Total:{" "}
											<span className="text-[.875rem] inline-block">
                        22.00 BTC
											</span>
										</div>
										<div className="text-[0.75rem] text-success">
                      Additional Charges: 0.32%(0.0001231 BTC)
										</div>
										<label className="font-semibold text-[0.75rem] mt-4 mb-2">
					...
					<div className="xl:col-span-4 col-span-12">
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">Sell Crypto</div>
							</div>
							<div className="box-body crypto-data">
								<div
                            ...
                            Checking ...
									...
									<div>
										<div className="text-[.875rem] py-2">
											<span className="font-semibold text-dark">Price:</span>
											<span className="text-[#8c9097] dark:text-white/50 ms-2 text-[.875rem]">
                        6.003435
											</span>
											<span className="text-dark font-semibold ltr:float-right rtl:float-left">
                        BTC
					...
					<div className="xl:col-span-4 col-span-12">
						<div className="box custom-box">
							<div className="box-header">
								<div className="box-title">Quick Secure Transfer</div>
							</div>
                            ...
                            Checking ...
									...
									<div className="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
										<input
											type="text"
											className="form-control crypto-buy-sell-input border-e-0"
											aria-label="crypto buy select"
											placeholder="36,335.00"
										/>
										<Select
				...
				<div className="grid grid-cols-12 gap-6">
					<div className="xl:col-span-12 col-span-12">
						<div className="box custom-box">
							<div className="box-header justify-between">
								<div className="box-title">Buy &amp; Sell Statistics</div>
								<div
                    ...
                    1Y
									...
									<div className="xl:col-span-8 col-span-12 pe-0 border-e border-dashed dark:border-defaultborder/10">
										<div className="flex flex-wrap items-center border-b border-dashed dark:border-defaultborder/10 mb-4 p-4 gap-4 ps-[3rem]">
											<div>
												...
												<span className="block font-semibold text-[.9375rem] text-success">
                          $324.25 USD
												</span>
											</div>
											<div>
												<span className="block text-[0.75rem]">Total Sell</span>
												<span className="block font-semibold text-[.9375rem] text-danger">
                          $4,235.25 USD
												</span>
											</div>
											<div>
                          ...
                          Available Balance
												...
												<span className="block font-semibold text-[.9375rem] text-primary">
                          $22,803.92 USD
												</span>
											</div>
											<div>
                          ...
                          Total Crypto Asset Value
												...
												<span className="block font-semibold text-[.9375rem] text-warning">
                          $4,56,683.00 USD
												</span>
											</div>
											<div></div>
											...
											<div className="box custom-box !bg-light shadow-none">
												<div className="box-body">
													<div className="flex items-center justify-between">
														<div>
															<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] mb-2">
                                BTC/USD
															</span>
															<span className="font-semibold h6 mb-0">
                                27.53612
															</span>
															<span className="text-danger block text-[0.75rem] mt-1">
                                -0.06%
															</span>
														</div>
														<div>
                                ...
                                20.6782
															...
															<span className="text-success block text-[0.75rem] mt-1">
                                +2.86%
															</span>
														</div>
														<div>
