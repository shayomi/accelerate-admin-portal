                ...
                <div className="grid grid-cols-12 items-center">
                  <div className="lg:col-span-8 col-span-12">
                    <div className="flex">
                      <h5 className="font-semibold mb-0">
                        <span className="font-normal">Showing</span> 3456 Jobs
                      </h5>
                    </div>
                  </div>
                  <div className="lg:col-span-4 col-span-12 text-end">
                    <div className="btn-group hs-dropdown ti-dropdown">
                      <button
                        className="ti-btn ti-btn-light border dark:border-defaultborder/10 dropdown-toggle"
                        type="button"
                        aria-expanded="false"
                      >
                        Sort By
                      ...
                      <ul className="hs-dropdown-menu ti-dropdown-menu hidden !text-end">
                        <li>
                          <Link
                            className="ti-dropdown-item !text-start"
                            href="#!"
                          >
                            Featured
                          </Link>
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  ...
                  <div className="px-2 py-4 pb-0">
                    <div className="form-check mb-2">
                      ...
                      <span className="badge bg-light !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">
                        2,712
                      </span>
                    </div>
                    <div className="form-check mb-2">
                    ...
                    >
                      <div className="form-check mb-2">
                        ...
                        <span className="badge bg-light text-defaulttextcolor  ltr:float-right rtl:float-left">
                          7,165
                        </span>
                      </div>
                      <div className="form-check mb-2">
            ...
            <div className="box custom-box featured-jobs">
              <div className="box-body">
                ...
                <div className="popular-tags mb-4">
                  ...
                  >
                    <i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad
                  </Link>
                  <Link
                    href="#!"
                    className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"
                  >
                    <i className="bi bi-briefcase text-muted me-1"></i> 13
                    Openings
                  </Link>
                  <Link
                    href="#!"
                  ...
                  <Link
                    ...
                    className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"
                  >
                    <i className="bi bi-clock text-muted me-1"></i> Min - 2Years
                  </Link>
                  <Link
                    href="#!"
                    className="badge  me-2 !rounded-full bg-light !text-defaulttextcolor"
                ...
                <div className="flex justify-between">
                  ...
                  <Link
                    href="#!"
                    className="text-primary font-semibold text-[.875rem] inline-flex items-center"
                  >
