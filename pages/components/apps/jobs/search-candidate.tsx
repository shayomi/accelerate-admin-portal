              ...
              <div className="box-body !p-0">
                <div className="!p-6 border-b dark:border-defaultborder/10">
                  ...
                  <div className="px-2 py-3 pb-0">
                    <div className="form-check mb-2">
                      ...
                      <span className="badge bg-light me-1 text-default font-500 ltr:float-right rtl:float-left">
                        2,712
                      </span>
                    </div>
                    <div className="form-check mb-2">
                    ...
                    <div
                      id="hs-show-hide-categeories-heading"
                    ...
                    >
                      <div className="form-check mb-2">
                        ...
                        <span className="badge bg-light me-1 text-defaulttextcolor  ltr:float-right rtl:float-left">
                          7,165
                        </span>
                      </div>
                      <div className="form-check mb-2">
                ...
                <div className="p-4">
                  ...
                  <div className="px-2 py-3 pb-0">
                    ...
                    <div
                      id="hs-show-hide-skills-heading"
                      className="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300"
                    ...
                    >
                      <div className="form-check mb-2">
                        ...
                        <span className="badge bg-light me-1 !text-defaulttextcolor font-500 ltr:float-right rtl:float-left">
                          5,946
                        </span>
                      </div>
                      <div className="form-check mb-2">
            ...
            <div className="grid grid-cols-12 gap-6 items-center mb-6">
              <div className="lg:col-span-12 col-span-12">
                <div className="inline-flex !w-full companies-search-input">
                  ...
                  <input
                    type="text"
                    className="form-control !rounded-none border-x-0"
                    aria-label="Text input with segmented dropdown button"
                  ...
                  <button
                    type="button"
                    aria-label="button"
                    className="ti-btn ti-btn-primary-full !mb-0 !rounded-s-none"
                  >
              ...
              <div className="box-body">
                <div className="sm:flex items-center">
                  ...
                  <div className="btn-group hs-dropdown ti-dropdown">
                    <button
                      className="ti-btn ti-btn-light border dropdown-toggle"
                      type="button"
                      aria-expanded="false"
                    >
                      Sort By
                    ...
                    <div className="flex items-center text-xs text-[#8c9097] dark:text-white/50">
                      ...
                      <div className="min-w-fit ms-2">
                        <span className="text-warning">
                          <i className="bi bi-star-fill me-1 me-1"></i>
                        </span>
                        <span className="text-warning">
                          <i className="bi bi-star-fill me-1 me-1"></i>
                        </span>
                        ...
                        <span className="text-warning">
                          <i className="bi bi-star-half me-1 me-1"></i>
                        </span>
                      </div>
                      <Link
                        href="#!"
                ...
                <div className="sm:flex items-center gap-3">
                  ...
                  <div>
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link
                        href="#!"
                        className="hs-tooltip-toggle badge badge-md !rounded-full bg-info/10 me-1 text-info"
                      >
                  ...
                  <div>
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link
                        ...
                        className="hs-tooltip-toggle badge badge-md !rounded-full bg-info/10 me-1 text-info"
                      >
                        <i className="bi bi-hand-thumbs-up me-1"></i>2 year bond
                        accepted
                        <span
                          className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm"
                          role="tooltip"
