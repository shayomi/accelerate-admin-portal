				...
				<div className="grid grid-cols-12 gap-x-6">
					<div className="xxl:col-span-3 lg:col-span-5 col-span-12">
                        ...
                        7,165
										...
										<div
											id="hs-show-hide-industry-heading"
                        ...
                        Hyderabad
											...
											<span className="badge bg-light text-default  ltr:float-right rtl:float-left">
                        512
											</span>
										</div>
										<div className="form-check mb-2">
							...
							<div className="lg:col-span-12 col-span-12">
								<div className="inline-flex !w-full companies-search-input">
									...
									<Select
										name="colors"
										options={Data}
										className="search-company ti-form-select !p-0 !rounded-s-none"
										menuPlacement="auto"
                    ...
                    1287{" "}
                      ...
                      Companies match for your search
										</span>{" "}
									</h5>
									<div className="btn-group hs-dropdown ti-dropdown">
										<button
											className="ti-btn ti-btn-outline-light border dark:!border-defaultborder/10 dropdown-toggle dark:hover:!bg-light"
											type="button"
											aria-expanded="false"
										>
                      Sort By{" "}
							...
							<div className="box-body">
								<div className="btn-list ltr:float-right rtl:float-left">
									<div className="hs-tooltip ti-main-tooltip">
										<button
											type="button"
											className="hs-tooltip-toggle avatar !rounded-full bg-light !text-defaulttextcolor avatar-sm"
										>
											<span>
							...
							<div className="box-footer">
								<div className="flex items-center flex-wrap gap-2">
									<div className="flex-grow">
										...
										>
											<i className="bi bi-people me-1"></i>No. of Emp : 345
										</Link>
										<Link
											href="#!"
											className="badge badge-md !rounded-full bg-primary/10 text-primary"
										>
											<i className="bi bi-briefcase me-1"></i>Vacancies : 50
										</Link>
									</div>
									<Link
										href="#!"
										className="ti-btn btn-wave ti-btn-primary-full"
									>
