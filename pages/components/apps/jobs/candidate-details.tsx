		...
		<Fragment>
			...
			<div className="container">
                            ...
                            -
                              ...
                              $20,000
											...
											<div className="popular-tags">
												<Link
													href="#!"
													className="badge  me-2 !rounded-full bg-info/10  text-info mb-2"
												>
									...
									<div className="btn-list flex">
										<Link
											href="#!"
											className="ti-btn  ti-btn-primary-full dark:border-defaulttextcolor/10 me-2 whitespace-nowrap"
										>
				...
				<div className="grid grid-cols-12 gap-6">
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2 mb-4">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-briefcase text-[.8125rem]"></i>
										</span>{" "}
                    Career Objective :
									</h5>
                      ...
                      labore..
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-mortarboard text-[.8125rem]"></i>
										</span>{" "}
                    Education :
									</h5>
									<div className="ms-6 ps-4">
                      ...
                      Intermediate (MPC)
                        ...
                        Warangal
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-award text-[.8125rem]"></i>
										</span>{" "}
                    Certifications :
									</h5>
									<div className="ms-6 ps-4">
                      ...
                      Python Development (6 Months)
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-journal-medical text-[.8125rem]"></i>
										</span>{" "}
                    Publications :
									</h5>
									<div className="ms-4">
                        ...
                        SitePoint, Feb 2019
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-activity text-[.8125rem]"></i>
										</span>{" "}
                    Activities and Interests :
								...
								<div className="p-6 border-b dark:border-defaultborder/10">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-link-45deg text-[.8125rem]"></i>
										</span>{" "}
                    References :
									</h5>
									<div className="ms-6 ps-4">
										<p className="mb-4">
											<span className="font-semibold ">Name : </span> Nicole
                      Chiu
										</p>
										<p className="mb-4">
                      ...
                      Full Stack Developer (2019 Mar - 2022 Apr)
                        ...
                        analysis, customer feedback, and usability findings.
								...
								<div className="p-6">
									<h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2 mb-4">
										<span className="avatar !rounded-full bg-primary avatar-sm">
											<i className="bi bi-people text-[.8125rem]"></i>
										</span>{" "}
                    Volunteer Experience:
                      ...
                      🖐 Was this profile fit for someone?
									...
									<div className="lg:col-span-6 col-span-6 text-end">
										<Link
											href="#!"
											className="ti-btn ti-btn-success-full dark:border-defaultborder/10 ti-btn-lg"
										>
                ...
                Related Profiles
							...
							<p className="!text-defaultsize !text-defaulttextcolor mb-6">
                ...
                aliqua
							...
							>
										...
										<div className="box-body">
											<div className="btn-list ltr:float-right rtl:float-left space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
													...
													>
														<span>
															<i className="ri-download-2-line text-[.8125rem] align-middle"></i>
														</span>
														<span
                              ...
                              Whislist
												...
												<div className="hs-tooltip ti-main-tooltip">
													...
													>
														<span>
															<i className="ri-eye-line text-[.8125rem] align-middle"></i>
														</span>
														<span
															className="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm "
															role="tooltip"
                              ...
                              View Profile
											...
											<div className="sm:flex mb-3 items-center">
												...
												<div className="ms-2">
													<h5 className="font-semibold mb-0 sm:flex items-center">
														<Link href="#!">
															{" "}
                              Brenda Simpson{" "}
															<i
                          ...
                          Immediate Joinee
												...
												<Link
													href="#!"
													className="badge !rounded-full bg-light !text-defaulttextcolor"
												>
                          ...
                          Good at English
                            ...
                            Angular
													...
													<Link
														href="#!"
														className="badge !rounded-full bg-primary/10 text-primary"
													>
												...
												<div>
													<Link
														href="#!"
														className="badge  me-2 badge-md !rounded-full bg-info/10 text-info"
                            ...
                            bond accepted
													...
													<Link
														href="#!"
														className="badge badge-md !rounded-full bg-primary/10 text-primary"
													>
                            ...
                            Years
                              ...
                              Gachibowli, Hyderabad
													...
													<div className="sm:flex items-center text-[0.75rem] text-[#8c9097] dark:text-white/50">
														...
														<Link
															href="#!"
															className="mb-0 ms-1 min-w-fit text-[#8c9097] dark:text-white/50"
														>
															<span>(35)</span>
															<span>Ratings</span>
														</Link>
                          ...
                          Good at English
										...
										<div className="box-footer">
											<div className="sm:flex items-center gap-3">
												...
												<div className="popular-tags sm:flex-grow">
													<Link
														href="#!"
														className="badge  me-1 !rounded-full bg-light !text-defaulttextcolor"
													>
                            React
													</Link>
													<Link
                            ...
                            React Navtive
												...
												<div>
													<Link
														href="#!"
														className="badge badge-md !rounded-full bg-info/10 text-info"
														title="1 year bond accepted"
													>
                    ...
                    Social :
									...
									<div className="btn-list mb-0 flex gap-1 flex-wrap">
										<button
											type="button"
											aria-label="button"
											className="ti-btn ti-btn-sm ti-btn-icon ti-btn-primary me-[0.375rem] xl:mb-0"
										>
										...
										<button
											type="button"
											aria-label="button"
											className="ti-btn ti-btn-sm ti-btn-icon ti-btn-secondary me-[0.375rem] xl:mb-0"
										>
										...
										<button
											type="button"
											aria-label="button"
											className="ti-btn ti-btn-sm ti-btn-icon ti-btn-warning me-[0.375rem] xl:mb-0"
										>
										...
										<button
											type="button"
											aria-label="button"
											className="ti-btn ti-btn-sm ti-btn-icon ti-btn-success me-[0.375rem] xl:mb-0"
										>
										...
										<button
											type="button"
											aria-label="button"
											className="ti-btn ti-btn-sm ti-btn-icon ti-btn-danger xl:mb-0"
										>
