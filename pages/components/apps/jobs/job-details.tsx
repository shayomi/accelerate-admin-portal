			...
			<div className="container">
								...
								<div className="sm:flex flex-wrap gap-2">
									...
									<div>
										<h4 className="font-bold mb-0 flex items-center">
											<Link href="#!">UI Developer - Fresher</Link>
										</h4>
                      ...
                      .PVT.LTD
                          ...
                          and Above
										...
										<div className="popular-tags mb-2 sm:mb-0">
											<Link
												href="#!"
												className="badge  me-2 !rounded-full bg-info/10 text-info"
											>
                ...
                aliqua
							...
							>
										...
										<div className="box-body">
											<div className="btn-list ltr:float-right rtl:float-left">
												<div className="hs-tooltip ti-main-tooltip">
													<button
														type="button"
														className="hs-tooltip-toggle avatar avatar-sm  me-2 !rounded-full bg-light !text-defaulttextcolor"
													>
														<span>
                              ...
                              Add to Whislist
												...
												<div className="hs-tooltip ti-main-tooltip">
													<button
														type="button"
														className="hs-tooltip-toggle avatar avatar-sm  me-2 !rounded-full !bg-warning/10 !text-warning"
													>
														<span>
                              ...
                              Featured Jobs
											...
											<div className="sm:flex mb-4">
												<span className="avatar avatar-lg !rounded-full !bg-primary/10 !fill-primary border dark:border-defaultborder/10 flex-none">
													<svg
												...
												<div className="ms-2">
													<h5 className="font-semibold mb-0 flex items-center">
														<Link href="#!"> HTML Developer</Link>
													</h5>
													<Link href="#!">
														<i className="bi bi-building"></i> Spotech Technical
                            Solutions
													</Link>
												</div>
											</div>
											<div className="popular-tags mb-4">
												<Link
													href="#!"
													className="badge  me-2 !rounded-full bg-light text-default"
												>
                          ...
                          Graduate
												...
												>
													<i className="bi bi-clock text-muted me-1"></i> Min -
                          2Years
												</Link>
											</div>
                          ...
                          $25,000 - $35,000
												...
												<Link
													href="#!"
													className="text-primary font-semibold text-[.875rem]"
												>
                          Apply Now <i className="fe fe-arrow-right"></i>
                              ...
                              Featured Jobs
											...
											<div className="sm:flex mb-4">
												...
												<div className="ms-2">
													<h5 className="font-semibold mb-0 flex items-center">
														<Link href="#!"> React Developer</Link>
													</h5>
													<Link href="#!">
														<i className="bi bi-building"></i> Infratech PVT LTD
													</Link>
												</div>
											</div>
											<div className="popular-tags mb-4">
                          ...
                          Apply Now <i className="fe fe-arrow-right"></i>
                              ...
                              Featured Jobs
											...
											<div className="sm:flex mb-4">
												...
												<div className="ms-2">
													<h5 className="font-semibold mb-0 flex items-center">
														<Link href="#!"> Vuejs Developer</Link>
													</h5>
									...
									<li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
										<div className="sm:flex">
											...
											<div className="ms-2 flex-grow">
												...
												<p className="mb-0 me-4">
													<i className="bi bi-building text-muted"></i> Spruko
									...
									<li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
										<div className="sm:flex">
											...
											<div className="ms-2 flex-grow">
												...
												<p className="mb-0 me-4">
													<i className="bi bi-building text-muted"></i> Hardware
                          Private Solutions
												</p>
											</div>
										</div>
									...
									<li className="list-group-item !border-b-0 !border-s-0 !border-e-0">
										<div className="sm:flex">
											...
											<div className="ms-2 flex-grow">
												...
												<p className="mb-0 me-4">
													<i className="bi bi-building text-muted"></i> G
                          Technical Solutions
												</p>
											</div>
										</div>
                          ...
                          Lead Developer{" "}
									...
									<li className="list-group-item !border-s-0 !border-e-0  mb-2">
										<div className="sm:flex">
											...
											<div className="ms-2 flex-grow">
												<p className="font-semibold text-[.875rem] mb-1">
													<Link href="#!">Spruko Technologies PVT LTD</Link>
												</p>
												<p className="mb-0 me-4">
                  ...
                  View All <i className="fe fe-arrow-right"></i>
                    ...
                    By Subscribing you accept to{" "}
										<Link href="#!" className="text-success mx-2">
											<u>privacy policy</u>
										</Link>
									</label>
								</div>
