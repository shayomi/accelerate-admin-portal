										...
										{Joblistdata.map((idx) => (
											...
											>
												...
												<td>
													<div className="flex">
														<span
															className={"avatar avatar-md !rounded-full bg-primary/10 !fill-primary"}
														>
															<svg
														...
														<div className="ms-2">
															<p className="font-semibold mb-0 flex items-center">
																<Link href="/components/apps/jobs/job-details/">
																	{idx.class}
																</Link>
															</p>
												...
												<td>
													<div className="flex items-center">
														...
														<Link href="#!" className="font-semibold mb-0">
															{idx.text1}
														</Link>
													</div>
												</td>
												...
												<td>
													<span
														className={`badge !rounded-full bg-${idx.color1}/10 text-${idx.color1}`}
													>
														{idx.text}
													</span>
												</td>
												...
												<td>
													<span
														className={`badge bg-${idx.color1}/10 text-${idx.color1}`}
													>
												...
												<td>
													<Link
														aria-label="anchor"
														href="/components/apps/jobs/job-details/"
														className="ti-btn ti-btn-icon ti-btn-sm ti-btn-primary  me-2"
													>
