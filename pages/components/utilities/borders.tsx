    ...
    <div>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Border Color Styling" code={border5}>
            <div className="mb-4">
              ...
              <input
                type="email"
                className="form-control w-full !rounded-md !border-success"
            ...
            <div className="p-4 bg-info/10 border !border-info  !border-s-0 rounded-e-md mb-1">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-md"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-t-md"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-e-md"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-b-md"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-s-md"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-none"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-sm"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
            ...
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-lg"
              alt="..."
            />
            <img
              src="../../../assets/images/media/media-58.jpg"
              className="bd-placeholder-img rounded-xl"
              alt="..."
            />
          </Showcode>
        </div>
