    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Enable flex behaviors</div>
            </div>
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Direction</div>
            </div>
            <div className="box-body">
              <div className="bd-example flex-container">
      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Justify content</div>
            </div>
            <div className="box-body">
              <div className="bd-example flex-container mb-4">
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Align items</div>
            </div>
            <div className="box-body">
              <div className="bd-example flex-container mb-4">
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Align self</div>
            </div>
            <div className="box-body">
              <div className="bd-example flex-container mb-4">
          ...
          <div className="grid gap-x-6">
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">
                    Align content ( Heads up! This property has no effect on
                    single rows of flex items.)
                  </div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="grid  gap-x-6">
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">Fill</div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
                    <div className="flex">
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">Grow and shrink</div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">Auto margins</div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
                    <div className="flex mb-4">
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">Wrap</div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
            ...
            <div className="xl:col-span-12 col-span-12">
              <div className="box">
                <div className="box-header">
                  <div className="box-title">With items</div>
                </div>
                <div className="box-body">
                  <div className="bd-example flex-container mb-4">
