...
const Showcode = dynamic(
  () => import("@/shared/layout-components/showcode/showcode"),
  { ssr: false }
);
  ...
  return (
    <Fragment>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
          <Showcode title="Disabled" code={radio2}>
            ...
            <div className="form-check">
              <input
                className="form-check-input opacity-[0.6]"
                type="checkbox"
                defaultValue=""
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-6 lg:col-span-6 md:col-span-12 sm:col-span-12 col-span-12">
          <Showcode
            title="Switches"
            code={radio11}
            customCardBodyClass="flex flex-col gap-y-4"
          >
            <div className="flex items-center">
              ...
              <label
                ...
                className="text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50"
              >
                Checked
              </label>
            </div>
            ...
            <div className="flex items-center">
              <label className="text-sm text-gray-500 me-3 dark:text-[#8c9097] dark:text-white/50">
                On
              </label>
              <input
                type="checkbox"
                ...
                className="ti-switch"
              />
              <label className="text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">
                Off
              </label>
            </div>
          </Showcode>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xxl:col-span-6 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
          <Showcode
            ...
            code={radio12}
            customCardBodyClass="sm:flex items-center justify-between"
          >
            <div className="flex">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
          <Showcode
            title="Inline"
            code={radio14}
            customCardBodyClass="sm:flex gap-2"
          >
          ...
          <Showcode title="Toggle Switches Style-1" code={radio7}>
            <div className="grid grid-cols-12 gap-y-1">
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle  mb-4 ${primary1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-secondary  mb-4 ${secondary1}`}
                  onClick={() => {
                    secondary1 == "on"
                      ? setsecondary1("off")
                      : setsecondary1("on");
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-warning mb-4 ${warning1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-info mb-4 ${info1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-success mb-4 ${success1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-danger mb-4 ${danger1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-light mb-4 ${light1}`}
                  onClick={() => {
              ...
              <div className="xl:col-span-4 col-span-12">
                <div
                  className={`toggle toggle-dark mb-4 ${dark1}`}
                  onClick={() => {
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6  lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
          <Showcode
            title="Toggle Switch-1 Sizes"
            code={radio10}
            customCardBodyClass="flex flex-col"
          >
            ...
            <div className="flex items-center flex-wrap mb-4">
              ...
              <div
                className={`toggle toggle-secondary mb-0 ${secondary2}`}
                onClick={() => {
                  secondary2 == "on"
                    ? setsecondary2("off")
                    : setsecondary2("on");
            ...
            <div className="flex items-center flex-wrap">
              ...
              <div
                className={`toggle toggle-lg toggle-success  mb-0 ${success2}`}
                onClick={() => {
