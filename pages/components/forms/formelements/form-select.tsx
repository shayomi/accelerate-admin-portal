      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12 md:col-span-6 xl:!col-span-3">
          <div className="box">
            ...
            <div className="box-body">
              <select
                className="opacity-70 pointer-events-none ti-form-select rounded-sm !py-2 !px-3"
                disabled
              >
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 md:col-span-6 xl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <label className="ti-form-select rounded-sm !py-2 !px-3-label">
                Label
              </label>
              <Select
                classNamePrefix="Select2"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-3">
                <Select
                  classNamePrefix="Select2"
                  className="py-[0.15rem] !text-[12px] !px-0 ti-form-select"
                  options={defaultselect}
                  placeholder="Open this select menu"
                />
                <Select
                  className="ti-form-select sm:p-4 !px-0 !py-2"
                  classNamePrefix="Select2"
                  options={defaultselect}
                  placeholder="Open this select menu"
                />
                <Select
                  className="ti-form-select sm:p-5 !px-0 !py-3 !text-[16px]"
                  classNamePrefix="Select2"
                  options={defaultselect}
                  placeholder="Open this select menu"
                />
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="relative">
                    <Select
                      ...
                      className="validation-statedata ti-form-select danger-input rounded-sm !py-2 !px-3 pe-16 !border-red focus:border-red focus:ring-red"
                      aria-valid="false"
                      options={defaultselect}
                      placeholder="Open this select menu"
                    />
                    ...
                    <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-8">
                      <svg
                        className="h-4 w-4 me-3 text-red"
                        width="16"
                        height="16"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                ...
                <div>
                  ...
                  <div className="relative">
                    <Select
                      classNamePrefix="react-select"
                      className="ti-form-select success-input rounded-sm !py-2 !px-3 pe-16 !border-green focus:border-green focus:ring-green"
                      aria-valid="false"
                      options={defaultselect}
                      placeholder="Open this select menu"
                    />
                    <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-8">
                      <svg
                        className="h-4 w-4 me-3 text-green"
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                        fill="none"
      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12  md:col-span-6 xxl:!col-span-3">
          <div className="box">
            ...
            <div className="box-body">
              <select
                className="ti-form-select rounded-sm !p-2"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <Select
                ...
                classNamePrefix="Select2"
                defaultValue={[
                  multiDropdownSelect[0],
                  multiDropdownSelect[1],
                  multiDropdownSelect[2],
                  multiDropdownSelect[3],
                ]}
              />
            </div>
          </div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            ...
            <div className="box-body">
              <label className=" rounded-sm !py-2 !px-3-label">
                Default Choices Select
              </label>
