              ...
              <div className="space-y-3">
                <div>
                  <div className="flex rounded-sm">
                    ...
                    <input
                      type="text"
                      className="py-2 px-3 ti-form-input rounded-none rounded-e-sm focus:z-10 !border-s-0"
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex rounded-sm">
                    ...
                    <input
                      type="text"
                      className="ti-form-input rounded-none rounded-e-sm focus:z-10 !border-s-0 sm:p-4"
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex rounded-sm">
                    ...
                    <input
                      type="text"
                      className="ti-form-input rounded-none rounded-e-sm focus:z-10 !border-s-0 sm:p-5"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="sm:flex rounded-sm">
                    ...
                    <input
                      type="text"
                      className="ti-form-input rounded-none -mt-px -ms-px first:rounded-t-sm last:rounded-b-sm sm:first:rounded-s-sm sm:mt-0 sm:first:ms-0  sm:first:rounded-se-none  sm:last:rounded-es-none  sm:last:rounded-e-sm  relative focus:z-10"
                    />
                    <input
                      type="text"
                      className="ti-form-input rounded-none -mt-px -ms-px first:rounded-t-sm last:rounded-b-sm sm:first:rounded-s-sm sm:mt-0 sm:first:ms-0  sm:first:rounded-se-none  sm:last:rounded-es-none  sm:last:rounded-e-sm  relative focus:z-10"
                ...
                <div>
                  <div className="sm:flex rounded-sm">
                    <input
                      type="text"
                      className="ti-form-input rounded-none  pe-11 -mt-px -ms-px first:rounded-t-sm last:rounded-b-sm sm:first:rounded-s-sm sm:mt-0 sm:first:ms-0  sm:first:rounded-se-none  sm:last:rounded-es-none  sm:last:rounded-e-sm  relative focus:z-10"
                    />
                    <span className="py-2 px-3 inline-flex items-center min-w-fit w-full border border-gray-200 bg-light text-sm text-gray-500 -mt-px -ms-px first:rounded-t-sm last:rounded-b-sm sm:w-auto sm:first:rounded-s-sm sm:mt-0 sm:first:ms-0  sm:first:rounded-se-none  sm:last:rounded-es-none  sm:last:rounded-e-sm  dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50">
                      <svg
                        className="hidden sm:block h-4 w-4 text-gray-500 dark:text-[#8c9097] dark:text-white/50"
                      ...
                      <svg
                        className="sm:hidden mx-auto h-4 w-4 text-gray-500 dark:text-[#8c9097] dark:text-white/50"
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        fill="currentColor"
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 md:col-span-6 xxl:!col-span-3">
          <div className="box">
            ...
            <div className="box-body">
              <div>
                <label htmlFor="hs-leading-icon" className="ti-form-label">
                  Email address
                </label>
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <svg
                      className="h-4 w-4 text-gray-500 dark:text-[#8c9097] dark:text-white/50"
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-3">
          <div className="box">
            ...
            <div className="box-body">
              <div>
                <label htmlFor="hs-trailing-icon" className="ti-form-label">
                  Card number
                </label>
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input rounded-sm pe-11 focus:z-10"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input rounded-sm !ps-[58px] pe-16 focus:z-10"
                  />
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <span className="text-gray-500 dark:text-[#8c9097] dark:text-white/50">
                      $ 0.00
                    </span>
                  </div>
                  <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-4">
              ...
              <div>
                ...
                <div className="flex rounded-sm">
                  <div className="px-4 inline-flex items-center min-w-fit rounded-s-sm border-e-0 border-gray-200 bg-light dark:bg-black/20 dark:border-white/10">
                    <span className="text-sm text-gray-500 dark:text-[#8c9097] dark:text-white/50">
                      http://
                    </span>
                  </div>
                  <input
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 md:col-span-6 xxl:!col-span-3">
          <div className="box">
            ...
            <div className="box-body">
              <div>
                <label htmlFor="hs-inline-add-on" className="ti-form-label">
                  Website URL
                </label>
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input rounded-sm ps-16 focus:z-10"
                    placeholder="www.example.com"
                  />
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <span className="text-sm text-gray-500 dark:text-[#8c9097] dark:text-white/50">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input ps-[76px] rounded-sm focus:z-10"
                  ...
                  <div className="absolute inset-y-0 start-0 flex items-center text-gray-500 dark:text-[#8c9097] dark:text-white/50 ps-px">
                    ...
                    <select
                      ...
                      className="block w-full border-defaultborder dark:border-defaultborder/10 focus:ring-primary focus:border-primary dark:bg-bodybg ps-2 pe-[2.25rem] border-x-0"
                    >
                      <option>US</option>
                      <option>CA</option>
                      <option>EU</option>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input rounded-sm !ps-[58px] pe-20 focus:z-10"
                  />
                  <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                    <span className="text-gray-500 dark:text-[#8c9097] dark:text-white/50">
                      $ 0.00
                  ...
                  <div className="absolute inset-y-0 end-0 flex items-center text-gray-500 dark:text-[#8c9097] dark:text-white/50 pe-px">
                    ...
                    <select
                      ...
                      className="block w-full border-x-0 border-defaultborder dark:border-defaultborder/10 focus:ring-primary focus:border-primary dark:focus:border-defaultborder/10 dark:bg-bodybg ps-2 pe-[2.25rem]"
                    >
                      <option>USD</option>
                      <option>CAD</option>
                      <option>EUR</option>
                  ...
                  <div className="flex rounded-sm">
                    <span className="px-4 inline-flex items-center min-w-fit rounded-s-sm border-e-0 border-gray-200 bg-light text-sm text-gray-500 dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50">
                      <span className="flex">
                        ...
                        />
                        <label
                          htmlFor="hs-input-group-with-radio"
                          className="sr-only"
                        >
                          Radio
                        </label>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex rounded-sm">
                    ...
                    <input
                      ...
                      className=" ti-form-input rounded-s-none focus:z-10"
                      placeholder="www.example.com"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label
                    htmlFor="hs-trailing-multiple-add-on"
                    className="sr-only"
                  >
                    Multiple add-on
                  </label>
                  <div className="flex rounded-sm">
                    <input
                      ...
                      className="ti-form-input rounded-e-none focus:z-10"
                      placeholder="www.example.com"
                    />
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex rounded-sm">
                    ...
                    <button
                      aria-label="button"
                      type="button"
                      className="inline-flex flex-shrink-0 justify-center items-center h-[2.875rem] w-[2.875rem] rounded-e-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      <svg
                        className="h-4 w-4"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  <label
                    htmlFor="hs-trailing-button-add-on-with-leading-and-trailing"
                    className="sr-only"
                  >
                    Label
                  </label>
                  <div className="flex rounded-sm">
                    ...
                    <input
                      ...
                      className="ti-form-input rounded-none focus:z-10"
                    />
                    <button
                      aria-label="button"
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative flex rounded-sm">
                    <input
                      ...
                      className="ti-form-input ps-11 rounded-none rounded-s-sm focus:z-10"
                    />
                    <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                      <svg
                        className="h-4 w-4 text-gray-500 dark:text-[#8c9097] dark:text-white/50"
                    ...
                    <button
                      type="button"
                      className="py-2 px-3 inline-flex flex-shrink-0 justify-center items-center rounded-e-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      Search
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex rounded-sm">
                    ...
                    <button
                      type="button"
                      className="py-2 px-3 inline-flex flex-shrink-0 justify-center items-center gap-2 rounded-e-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      Button
                    </button>
                  </div>
                ...
                <div>
                  <label
                    htmlFor="hs-trailing-button-add-on-multiple-add-ons"
                    className="sr-only"
                  >
                    Label
                  </label>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-3">
                <div>
                  ...
                  <div className="flex rounded-sm">
                    <button
                      aria-label="button"
                      type="button"
                      className="inline-flex flex-shrink-0 justify-center items-center h-[2.875rem] w-[2.875rem] rounded-s-sm border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      <svg
                        className="h-4 w-4"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <input
                      ...
                      className="ti-form-input rounded-none rounded-e-sm focus:z-10"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label
                    htmlFor="hs-leading-button-add-on-with-leading-and-leading"
                    className="sr-only"
                  >
                    Label
                  </label>
                  <div className="flex rounded-sm">
                    ...
                    <input
                      type="text"
                      id="hs-leading-button-add-on-with-leading-and-leading"
                ...
                <div>
                  <label
                    htmlFor="hs-leading-button-add-on-with-icon-and-button"
                    className="sr-only"
                  >
                    Label
                  </label>
                  <div className="relative flex rounded-sm">
                    <button
                      type="button"
                      className="py-2 px-3 inline-flex flex-shrink-0 justify-center items-center rounded-s-sm border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      Search
                    </button>
                    <input
                      ...
                      className="ti-form-input pe-11 rounded-none rounded-e-sm focus:z-10"
                    />
                    <div className="absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-4">
                      <svg
                        className="h-4 w-4 text-gray-500 dark:text-[#8c9097] dark:text-white/50"
                ...
                <div>
                  <label htmlFor="hs-leading-button-add-on" className="sr-only">
                    Label
                  </label>
                  <div className="flex rounded-sm">
                    <button
                      type="button"
                      className="py-2 px-3 inline-flex flex-shrink-0 justify-center items-center gap-2 rounded-s-sm border-transparent font-semibold bg-primary text-white hover:bg-primary focus:z-10 focus:outline-none focus:ring-0 focus:ring-primary transition-all text-sm"
                    >
                      Button
                    </button>
                    <input
                ...
                <div>
                  <label
                    htmlFor="hs-leading-button-add-on-multiple-add-ons"
                    className="sr-only"
                  >
                    Label
                  </label>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-3">
                ...
                <div>
                  <label
                    htmlFor="hs-search-box-with-loading-2"
                    className="ti-form-label"
                  >
                    Search
                  </label>
                ...
                <div>
                  <label
                    htmlFor="hs-search-box-with-loading-3"
                    className="ti-form-label"
                  >
                    Search
                  </label>
                ...
                <div>
                  <label
                    htmlFor="hs-search-box-with-loading-4"
                    className="ti-form-label"
                  >
                    Search
                  </label>
                ...
                <div>
                  <label
                    htmlFor="hs-search-box-with-loading-5"
                    className="ti-form-label"
                  >
                    Search
                  </label>
                  <div className="relative flex rounded-sm">
                    <input
                      ...
                      className="rounded-none ti-form-input ps-11 rounded-s-sm"
                      placeholder="Input search"
                    />
                    <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4">
                      <svg
