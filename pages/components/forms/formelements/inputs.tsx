        ...
        <div className="xl:col-span-12 col-span-12">
          <Showcode title="Input Types" code={input4}>
            <div className="grid grid-cols-12 sm:gap-6">
              ...
              <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                <label htmlFor="input-datetime-local" className="form-label">
                  Type datetime-local
                </label>
                <input
                  type="datetime-local"
              ...
              <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                ...
                <input
                  type="button"
                  className="form-control ti-btn !text-white !bg-primary"
                  id="input-button"
                  defaultValue="Button"
                />
              </div>
              <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                <div className="grid grid-cols-12 gap-6">
                  <div className="xl:col-span-3 col-span-12 flex flex-col ">
                    ...
                    <input
                      className="form-control form-input-color !rounded-md"
                      type="color"
                      defaultValue="#136bd0"
                    />
                  </div>
              ...
              <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                <div>
                  ...
                  <input
                    ...
                    name="file-input"
                    id="file-input"
                    className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10
                                                 file:border-0
              ...
              <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                <label htmlFor="disabled-readonlytext" className="form-label">
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Input Border Style" code={input2}>
            <div className="grid grid-cols-12 gap-y-3">
              ...
              <div className="xl:col-span-12 col-span-12">
                <label htmlFor="input-rounded2" className="form-label">
                  Dotted Input
                </label>
                <input
                  type="text"
              ...
              <div className="xl:col-span-12 col-span-12">
                <label htmlFor="input-rounded3" className="form-label">
                  Dashed Input
                </label>
                <input
                  type="text"
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode
            title="Overview"
            code={input9}
            customCardHeaderClass=" justify-between"
          >
            <form>
              <div className="mb-3">
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="grid grid-cols-12">
            ...
            <div className="xl:col-span-12 col-span-12">
              <Showcode
                title="Inline text can use any typical inline HTML element with nothing more than the <span className=text-danger>.form-text</span> class."
                code={input12}
                customCardHeaderClass=" justify-between"
              >
          ...
          >
            <form>
              <fieldset disabled>
                ...
                <button
                  type="submit"
                  className="ti-btn ti-btn-primary-full opacity-[0.6]"
                >
                  Submit
                </button>
              </fieldset>
