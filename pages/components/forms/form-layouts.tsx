          ...
          <Showcode title="Horizontal Form" code={layout2}>
            <form>
              <div className="grid grid-cols-12 mb-4">
                <label
                  htmlFor="inputEmail3"
                  className="sm:col-span-2 col-span-12 col-form-label"
                >
                  Email
                </label>
              ...
              <div className="grid grid-cols-12 mb-4">
                <div className=" sm:col-span-2 col-span-12 col-form-label pt-0">
                  Qualified
                </div>
                <div className="sm:col-span-10 col-span-12 ">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Vertical Form with Icon" code={layout3}>
            ...
            <button
              className="ti-btn ti-btn-primary-full !mb-0 mt-4"
              type="submit"
            >
              Submit
            </button>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Horizontal Form with Icons" code={layout4}>
            <form>
              ...
              <div className="grid grid-cols-12 mb-4">
                <div className="col-form-label sm:col-span-2 col-span-12 pt-0">
                  Qualified
                </div>
                <div className="sm:col-span-10 col-span-12">
                  <div className="form-check">
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Inline Forms" code={layout5}>
            <form className="sm:grid grid-cols-4 gap-4 items-center">
              ...
              <select
                className="mb-4 sm:mb-0 form-select !py-3"
          ...
          <Showcode title="Horizontal Form Label sizing" code={layout7}>
            <div className="grid grid-cols-12 mb-4">
              <label
                ...
                className="sm:col-span-2 col-span-12 col-form-label col-form-label-sm"
              >
                Email
              </label>
              <div className="sm:col-span-10 col-span-12">
            ...
            <div className="grid grid-cols-12">
              <label
                ...
                className="sm:col-span-2 col-span-12 col-form-label col-form-label-lg text-[1.25rem]"
              >
                Email
              </label>
              <div className="sm:col-span-10 col-span-12">
          ...
          <Showcode title="Auto Sizing" code={layout8}>
            ...
            <form className="grid grid-cols-12  gap-x-4 gap-y-2 items-center mt-2">
              ...
              <div className="sm:col-span-3 col-span-12">
                ...
                <select
                  className="form-select !py-[0.59rem]"
                ...
                <div className="grid grid-cols-12">
                  ...
                  <div className="xl:col-span-12 col-span-12 mb-4">
                    <div className="grid grid-cols-12 gap-3">
                      <label className="form-label mb-1 xl:col-span-12 col-span-12">
                        Maritial Status
                      </label>
                      <div className="xl:col-span-6 col-span-12">
                        <div className="form-check">
