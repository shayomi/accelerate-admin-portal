		...
		<Fragment>
					...
					<div className="grid grid-cols-12 gap-x-6">
                        ...
                        8,289
                          ...
                          This Month
										...
										<div>
											<span className="text-[0.875rem] font-semibold text-danger">
                        -1.28%
											</span>
										</div>
									</div>
							...
							<div className="box">
								...
								<div className="box-body">
									<div className="sm:grid grid-cols-12 md:gap-y-0 gap-y-3">
										<div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-12">
											<div className="flex items-start">
												<div className="me-3">
												...
												<div>
													<span className="block mb-1 text-[#8c9097] dark:text-white/50">
                            New Applicants
													</span>
			...
			<div className="grid grid-cols-12 gap-x-6 col-span-12">
				<div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
					<div className="box">
						<div className="box-header">
							<div className="box-title">Jobs Summary</div>
						</div>
                      ...
                      Published
								...
								<div className="col p-0">
									<div className="text-center">
										<span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] mb-1 hrm-jobs-legend private inline-block ms-2">
                      Private
										</span>
										<div>
								...
								<div className="col p-0">
									<div className="text-center">
										<span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] mb-1 hrm-jobs-legend closed inline-block ms-2">
                      Closed
										</span>
										<div>
								...
								<div className="col p-0">
									<div className="text-center">
										<span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] mb-1 hrm-jobs-legend onhold inline-block ms-2">
                      On Hold
										</span>
										<div>
											<span className="text-[1rem] font-semibold">1,153</span>
				...
				<div className="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
					<div className="box">
								...
								<li className="timeline-widget-list">
									<div className="flex items-start">
										<div className="me-[3rem] text-center">
											<span className="block text-[1.25rem] font-semibold text-primary">
                        02
											</span>
                        ...
                        Mon
                          ...
                          09:00AM
													<span className="badge text-success bg-success/10 ms-2">
                            Birthday
													</span>
												</p>
												<p className="mb-1 sm:text-truncate timeline-widget-content text-wrap">
                          Amet sed no dolor kasd - Et Dolores Tempor Erat
												...
												<p className="mb-0 text-[0.75rem] leading-none text-[#8c9097] dark:text-white/50">
                          04:00PM
													<span className="badge text-primary bg-primary/10 ms-2">
                            Announcement
													</span>
												</p>
											</div>
					...
					<div className="box">
						...
						<div className="box-body !p-0">
							<div className="table-responsive">
								<table className="table whitespace-nowrap min-w-full">
									<thead>
										<tr>
											<th scope="col" className="text-start !min-w-[200px]">
                        Client
											</th>
                        ...
                        Action
                              ...
                              Diana Aise
														...
														<span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem] text-start">
                              C.E.O
														</span>
													</div>
												</div>
				...
				<div className="xl:col-span-12 col-span-12">
					<div className="box">
						<div className="box-header justify-between flex-wrap">
							<div className="box-title">Bills Summary</div>
									...
									<tbody>
										{Billssummary.map((idx) => (
											...
											>
												...
												<td>{idx.duedate}</td>
												<td>
													<span className={`badge bg-${idx.color} text-white`}>
														{idx.status}
													</span>
												</td>
												<td>{idx.amount}</td>
