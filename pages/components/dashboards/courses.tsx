import {
	...
	Earningsreport,
	Payouts,
} from "@/shared/data/dashboards/coursedata";
		...
		<Fragment>
						...
						<div className="xl:col-span-12 col-span-12">
							<div className="box">
								<div className="box-header justify-between">
									<div className="box-title">Top Categories</div>
									<div>
										<button
											type="button"
										...
										<div className="xxl:col-span-3 xl:col-span-3 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
											<div>
												...
												>
													...
													<p className="text-[0.875rem] mb-1 text-default font-semibold text-defaulttextcolor">
                            UI/UX Design
													</p>
					...
					<div className="grid grid-cols-12 gap-x-6">
								...
								<div className="box-body">
									<div className="flex flex-wrap items-start gap-2">
										...
										<div className="flex-grow">
											<h5 className="block font-semibold text-[1.125rem]">
                        $98,312
											</h5>
                          ...
                          YTD Earnings
												...
												<div className="text-success">
													<i className="ti ti-trending-up text-[1rem] me-1 align-middle inline-flex"></i>
                          +2.02%
												</div>
											</div>
											<Link href="#!" className="text-primary text-[0.75rem]">
                        View All
                        ...
                        35,393
                          ...
                          Total Students
												...
												<div className="text-danger">
													<i className="ti ti-trending-down text-[1rem] me-1 align-middle inline-flex"></i>
                          -0.24%
												</div>
											</div>
											<Link href="#!" className="text-secondary text-[0.75rem]">
                        View All
												<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i>
											</Link>
										</div>
                        ...
                        573
                          ...
                          -1.32%
											...
											<Link href="#!" className="text-warning text-[0.75rem]">
                        View All
												<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i>
											</Link>
										</div>
                        ...
                        2,389
                          ...
                          +0.89%
											...
											<Link href="#!" className="text-danger text-[0.75rem]">
                        View All
												<i className="ti ti-arrow-narrow-right ms-2 font-semibold inline-block"></i>
											</Link>
										</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				...
				<div className="xl:col-span-5 col-span-12">
					<div className="box">
						<div className="box-header justify-between">
							<div className="box-title">New Students</div>
							<div>
										...
										<tr>
											<th scope="row">
												<div className="flex items-center">
													...
													<div>
														<span className="blockfont-semibold">
                              Richard Dom
														</span>
				...
				<div className="xl:col-span-4 col-span-12">
					<div className="box">
						<div className="box-header justify-between">
							<div className="box-title">Payouts</div>
							<div
								className="inline-flex rounded-md shadow-sm"
								role="group"
								aria-label="Basic example"
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xl:col-span-12 col-span-12">
					<div className="box">
						<div className="box-header justify-between">
							<div className="box-title">Course List</div>
