    ...
    <Fragment>
            ...
            <div className="box-body">
              <div className="grid grid-cols-12">
                <div className="col-span-6 pe-0">
                  ...
                  <Link href="#!" className="text-[0.75rem] mb-0 text-primary">
                    Show full stats
                ...
                <li className="mt-0 activity">
                  <div className="text-[0.75rem]">
                    <p className="mb-0">
                      ...
                      <span className="mx-2 text-[0.75rem]">shared a page</span>
                      <span>
                        <Link
              ...
              <div className="tab-menu-heading border-0 p-0 ms-auto sm:mt-0 mt-2">
                <div className="tabs-menu-task me-3">
                  <nav className="" aria-label="Tabs">
                    <Link
                      href="#!"
                      className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-secondary active"
                      id="active-item"
                      data-hs-tab="#Active"
                    ...
                    <Link
                      href="#!"
                      className="hs-tab-active:bg-secondary/10 hs-tab-active:text-secondary cursor-pointer text-defaulttextcolor px-4 py-2 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-secondary "
                      id="Complete-item"
      ...
      <div className="grid grid-cols-12 gap-x-6">
              ...
              <ul className="list-group my-1">
                <li className="list-group-item !py-3 !border-0">
                  <Link href="#!" className="!border-0">
                    <div className="flex items-start">
                      <img
                        className="avatar avatar-md me-4 my-auto"
                        src="../../../assets/images/faces/2.jpg"
          ...
          <div className="box">
              ...
              <div className="tab-menu-heading !border-0 !p-0 ms-auto">
                <div className="tabs-menu-billing my-1">
                  <nav className="" aria-label="Tabs">
                    <Link
                      href="#!"
                      className="hs-tab-active:bg-success/10 hs-tab-active:text-success text-defaulttextcolor py-[0.35rem] px-4 flex-grow  text-[0.75rem] font-medium text-center rounded-md hover:text-success active"
                      id="Invoice-item"
                      data-hs-tab="#Invoice"
                    ...
                    <Link
                      href="#!"
                      className="hs-tab-active:bg-success/10 hs-tab-active:text-success text-defaulttextcolor py-[0.35rem] px-4 text-[0.75rem] flex-grow font-medium text-center  rounded-md hover:text-success "
                      id="Revenue-item"
                      data-hs-tab="#Revenue"
            ...
            <div className="box-body !p-0">
              <div className="tab-content">
                  ...
                  <ul className="list-group border-0 py-2 my-2">
                      ...
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-005 _{" "}
                              <span className="text-[0.75rem] ">$1,938</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Nov 24,2022
                            </span>
                          </div>
                        </div>
                    ...
                    <li className="list-group-item items-start !border-0 mb-2">
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          <div>
                            <span className="badge bg-success text-white me-4">
                              Sent
                            </span>
                          </div>
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-006 _{" "}
                              <span className="text-[0.75rem]">$1,098</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Nov 28,2022
                            </span>
                    ...
                    <li className="list-group-item items-start !border-0 mb-2">
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          <div>
                            <span className="badge bg-warning text-white me-4">
                              Pending
                            </span>
                          </div>
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-007 _{" "}
                              <span className="text-[0.75rem] ">$3,672</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Dec 20,2022
                            </span>
                      ...
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-008 _{" "}
                              <span className="text-[0.75rem] ">$4,362</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Dec 16,2022
                            </span>
                      ...
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-009 _{" "}
                              <span className="text-[0.75rem] ">$2,389</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Dec 10,2022
                            </span>
                      ...
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <div className="billing-invoice-details">
                            <span className="mb-0 font-semibold me-2">
                              Invoice #A12-002 _{" "}
                              <span className="text-[0.75rem] ">$4,390</span>
                            </span>
                            <span className="small text-[#8c9097] dark:text-white/50 text-[0.6875rem] block">
                              Nov 30,2022
                            </span>
                ...
                <div
                  className="tab-pane hidden !border-0 !p-0"
                  id="Revenue"
                  aria-labelledby="Revenue-item"
                  role="tabpanel"
                >
                      ...
                      <Link href="#!">
                        ...
                        <div className="flex w-full justify-between">
                          <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                            <i className="ri-arrow-up-fill align-middle text-success me-1"></i>{" "}
                    ...
                    <li className="list-group-item flex-col items-start !border-0 mb-1">
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <p className="mb-0 font-semibold text-danger text-[0.875rem]">
                            -$2,178
                          </p>
                        </div>
                        <div className="flex w-full justify-between">
                          <span className="text-[#8c9097] dark:text-white/50  text-[0.75rem]">
                            <i className="ri-arrow-down-fill align-middle text-danger me-1"></i>
                    ...
                    <li className="list-group-item flex-col items-start !border-0 mb-1">
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <p className="mb-0 font-semibold text-danger text-sm">
                            -$678
                          </p>
                        </div>
                        <div className="flex w-full justify-between">
                    ...
                    <li className="list-group-item flex-col items-start !border-0 mb-1">
                      <Link href="#!">
                        <div className="flex w-full justify-between">
                          ...
                          <p className="mb-0 font-semibold text-success text-sm">
                            +$578
                          </p>
                        </div>
                        <div className="flex w-full justify-between">
        ...
        <div className="xxl:col-span-3 xl:col-span-6 col-span-12">
          <div className="box">
            <div className="box-header justify-between">
              <div className="box-title">Sale Value</div>
              <div className="hs-dropdown ti-dropdown">
                <Link
                  aria-label="anchor"
                  href="#!"
              ...
              <div className="grid grid-cols-12 pt-3 ">
                ...
                <div className="xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-6 border-e dark:border-defaultborder/10 p-4 text-center">
                  ...
                  <p className="text-[0.6875rem] text-[#8c9097] dark:text-white/50 mb-0">
                    ...
                    <span className="text-success ms-2">
                      <i className="ri-arrow-up-s-line me-2 font-bold align-middle inline-block"></i>
                      <span className="badge bg-success/10 text-success !text-[0.6875rem]">
                        0.9%
                      </span>
                    </span>
                  </p>
                ...
                <div className="xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-6  p-4 text-center">
                  ...
                  <p className="text-[0.6875rem] text-[#8c9097] dark:text-white/50 mb-0">
                    Profit
                    <span className="text-success ms-2">
                      <i className="ri-arrow-down-s-line me-2 font-bold align-middle inline-block"></i>
                      <span className="badge bg-success/10 text-success !text-[0.6875rem]">
                        0.15%
                      </span>
                    </span>
            ...
            <div className="box-body">
              <ul className="mb-0 !rounded-[0.375rem]">
                ...
                <li className="list-group-item text-center !py-4">
                  <button
                    type="button"
                    className="ti-btn ti-btn-lg !mb-0 !text-[0.75rem] !font-semibold ti-btn-primary ti-btn-wave"
                  >
                    See All Activity
                  </button>
                </li>
                  ...
                  <tbody>
                    {Trendingorders.map((idx) => (
                      ...
                      >
                        ...
                        <td>
                          <span
                            className={`badge bg-${idx.bg} text-${idx.color}`}
                          >
                            {idx.status}
                          </span>
                        </td>
