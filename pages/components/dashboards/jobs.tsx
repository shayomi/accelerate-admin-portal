    ...
    <Fragment>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-grow">
                      <div className="flex mb-1 items-start justify-between">
                        <h5 className="font-semibold mb-0 leading-none text-[1.25rem]">
                          256
                        </h5>
                      ...
                      <p className="mb-0 text-[0.625rem] opacity-[0.7] text-[#8c9097] dark:text-white/50 font-semibold">
                        TOTAL EMPLOYERS
                      </p>
                    </div>
                  </div>
                ...
                <div className="box-body !p-0">
                  <div className="grid grid-cols-12 border-bottom border-block-end-dashed">
                    ...
                    <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                      <div className="p-3 sm:border-e !border-0 sm:text-start text-center">
                        <p className="text-[1.25rem] font-semibold mb-0">
                          <span className="basic-subscription">742</span>
                        </p>
                        <p className="mb-0 text-[#8c9097] dark:text-white/50">
                          Basic Subscriptions
                        </p>
                    ...
                    <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
                      <div className="p-3 sm:text-start !border-0 text-center">
                        <p className="text-[1.25rem] font-semibold mb-0">
                          <span className="pro-subscription">259</span>
                        </p>
                        <p className="mb-0 text-[#8c9097] dark:text-white/50">
                          Pro Subscriptions
                        </p>
                    ...
                    <li className="list-group-item !border-x-0">
                      <Link href="#!">
                        <div className="flex items-center">
                          ...
                          <div className="text-end">
                            <p className="mb-0 text-[0.75rem] text-primary font-semibold">
                              Freelancer
                            </p>
                            <span className="badge bg-success/10 text-success">
                              Fresher
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xxl:col-span-4 col-span-12">
          <div className="box overflow-hidden">
            <div className="box-header">
              <div className="box-title">Registers By Country</div>
            </div>
            <div className="box-body !p-0">
              <div className="table-responsive">
                <table className="table whitespace-nowrap min-w-full">
                  <thead>
                    <tr>
                      <th scope="col" className="text-start min-w-[130px]">
                        Country
                      </th>
                      ...
                      >
                        <th scope="row">
                          <div className="flex items-center">
                            ...
                            />
                            <div>
                              <span className="font-semibold">{idx.city}</span>
                            </div>
                          </div>
                        </th>
                        <td>{idx.date}</td>
        ...
        <div className="xxl:col-span-5 col-span-12">
          <div className="box overflow-hidden">
            <div className="box-header justify-between">
              <div className="box-title">Top Companies</div>
              <div className="hs-dropdown ti-dropdown">
                <Link
                  href="#!"
                  className="text-[0.75rem] px-2 font-normal text-[#8c9097] dark:text-white/50"
            ...
            <div className="box-body !p-0">
              <div className="table-responsive">
                <table className="table table-hover whitespace-nowrap min-w-full">
                  <thead>
                    <tr>
                      <th scope="col" className="text-start min-w-52">
                        Name
                      </th>
                      <th scope="col" className="text-start">
                        Subscription
        ...
        <div className="xxl:col-span-3 col-span-12">
          <div className="box">
            <div className="box-header">
              <div className="box-title">Acquisitions</div>
            </div>
            <div className="box-body">
              ...
              <ul className="list-group">
                <li className="list-group-item !py-3">
                  Total Applications
                  <span className="badge ltr:float-right rtl:float-left bg-primary/10 text-primary">
                    1,982
                  </span>
                </li>
                <li className="list-group-item !py-3">
                ...
                <li className="list-group-item !py-3">
                  Rejected
                  <span className="badge ltr:float-right rtl:float-left bg-warning/10 text-warning">
                    395
                  </span>
                </li>
                <li className="list-group-item !py-3 flex-grow">
                  Blocked
                  <span className="badge ltr:float-right rtl:float-left bg-danger/10 text-danger m-auto">
                    79
                  </span>
                </li>
              </ul>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xxl:col-span-12 xl:col-span-12 col-span-12">
          <div className="box box-card">
            <div className="box-header justify-between">
              <div className="box-title">Recent Employers</div>
