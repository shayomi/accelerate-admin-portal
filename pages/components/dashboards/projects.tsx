import {
	...
	Team4,
	Team5,
} from "@/shared/data/dashboards/projectsdata";
				...
				<div className="xxl:col-span-9 col-span-12">
					<div className="grid grid-cols-12 gap-x-6">
						<div className="xxl:col-span-5 col-span-12">
									...
									<div className="box">
										<div className="box-body flex justify-between items-center">
											<div>
												...
												<h4 className="font-semibold mb-1 text-[1.5rem]">
                          109
												</h4>
												<span className="badge bg-success/10 text-success">
                          1.5% <i className="ti ti-trending-up"></i>
												</span>
												<span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
												</span>
											</div>
											<div>
                          ...
                          0.23% <i className="ti ti-trending-down"></i>
												</span>
												<span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
												</span>
                          ...
                          389
												...
												<span className="badge bg-success/10 text-success">
                          0.67% <i className="ti ti-trending-up"></i>
												</span>
												<span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
												</span>
                          ...
                          227
												...
												<span className="badge bg-success/10 text-success">
                          0.53% <i className="ti ti-trending-up"></i>
												</span>
												<span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
												</span>
                      ...
                      View All
                          ...
                          Export
									...
									<ul className="list-none daily-task-card my-2">
										<li>
											<div className="box border border-primary/25 shadow-none mb-0">
												<div className="box-body">
													<p className="text-[0.875rem] font-semibold mb-2 leadining-none">
                            Home Page Design
													...
													<div className="flex flex-wrap gap-2 mb-4">
														<span className="badge text-primary bg-primary/10">
                              Framework
														</span>
														<span className="badge text-secondary bg-secondary/10">
                              Angular
														</span>
														<span className="badge text-info bg-info/10">
                              Php
														</span>
													</div>
                            ...
                            About Us Page redesign
													...
													<div className="flex flex-wrap gap-2 mb-4">
														<span className="badge text-danger bg-danger/10">
                              Html
														</span>
														<span className="badge text-warning bg-warning/10">
                              Symphony
														</span>
														<span className="badge text-success bg-success/10">
                              Php
														</span>
													</div>
													<div className="avatar-list-stacked">
					...
					<div className="grid grid-cols-12 gap-x-6">
						<div className="xxl:col-span-12 col-span-12">
							<div className="box shadow-none projects-tracking-card overflow-hidden text-center">
								<div className="box-body">
									...
									/>
									<div>
										<span className="text-[0.9375rem] font-semibold block mt-6 mb-4">
                      ...
                      Track Here
									...
									<span className="shape-1 text-primary">
										<i className="ti ti-circle text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-2 text-secondary">
										<i className="ti ti-triangle text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-3 text-warning">
										<i className="ti ti-square text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-4 text-info">
										<i className="ti ti-square-rotated text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-5 text-success">
										<i className="ti ti-pentagon text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-6 text-danger">
										<i className="ti ti-star text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-7 text-pink">
										<i className="ti ti-hexagon text-[1.25rem] font-bold"></i>
									</span>
									<span className="shape-8 text-teal">
										<i className="ti ti-octagon text-[1.25rem] font-bold"></i>
									</span>
