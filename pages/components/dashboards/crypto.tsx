import {
	...
	Selectdata2,
	Statistics,
} from "@/shared/data/dashboards/cryptodata";
		...
		<Fragment>
								...
								<div className="box-body">
									<div className="flex items-center mb-5">
										<div className="flex items-center">
											...
											<div className="mb-0 fw-semibold">Dash - DASH</div>
										</div>
										<div className="ms-auto">
											<div id="dash-chart">
												<Cryptodash />
						...
						<div className="xxl:col-span-8 xl:col-span-7 col-span-12">
							<div className="box">
								<div className="box-header justify-between flex-wrap">
									<div className="box-title">Crypto Statistics</div>
									<div
								...
								<div className="box-body !p-0">
									<div className="flex flex-wrap p-4 border-b border-dashed dark:border-defaultborder/10">
										...
										<div className="flex flex-wrap sm:justify-evenly flex-grow">
											...
											<div className="sm:m-0 m-2">
												<span>Price (USD)</span>
												<p className="text-success font-semibold mb-0">
                          $4,253.49
												</p>
											</div>
											<div className="sm:m-0 m-2">
                          ...
                          Something else here
                                ...
                                Sell
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">+$19,123.02</p>
												...
												<div className="flex items-center justify-between">
													<div className="flex items-center">
														...
														<div>
															...
															<p className="mb-0  text-[0.6875rem] text-primary font-semibold">
                                Buy
															</p>
														</div>
													</div>
													<div className="text-end">
														<p className="mb-0 font-semibold">-$1,430.92</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50  text-[0.6875rem]">
                              ETH 10,783.23
														</p>
													</div>
                                ...
                                Sell
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">+$5,236.53</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50  text-[0.6875rem]">
                              DASH 12,456.98
														</p>
													</div>
                                ...
                                Buy
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">-$1,810.93</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50  text-[0.6875rem]">
                              BYTE 8,154.00
														</p>
													</div>
                                ...
                                Sell
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">+$5,046.34</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50 text-[0.6875rem]">
                              GOLEM 9,384.73
														</p>
													</div>
                                ...
                                Sell
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">+$2,625.50</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50  text-[0.6875rem]">
                              SIA 3,151.09
														</p>
													</div>
                                ...
                                Sell
													...
													<div className="text-end">
														<p className="mb-0 font-semibold">+$1,256.24</p>
														<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50  text-[0.6875rem]">
                              XMR 2,799.06
														</p>
													</div>
					...
					<div className="grid grid-cols-12 gap-x-6">
							...
							<div className="box">
								<div className="box-header">
									<div>
										<div className="mb-1">
                      Wallet Value
											<span className="text-[0.625rem] badge bg-success/10 text-success p-1 ms-2">
												<i className="ri-arrow-up-s-line align-middle me-1"></i>
                        12.2%
											</span>
										</div>
                      ...
                      Sell
										...
										>
											...
											<div>
												<div className="text-[0.875rem] py-2">
													<span className="font-semibold text-dark dark:text-defaulttextcolor/70">
                            Price:
													</span>
													<span className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.875rem] inline-block">
                            6.003435
													</span>
													<span className="text-dark font-semibold ltr:float-right rtl:float-left dark:text-defaulttextcolor/70">
                            BTC
													</span>
												</div>
												<div className="text-[0.875rem] py-2">
                            ...
                            LTC
												...
												<div className="font-semibold text-[0.875rem] py-3 dark:text-defaulttextcolor/70">
                          Total:{" "}
													<span className="text-[0.875rem] inline-block dark:text-defaulttextcolor/70">
                            22.00 BTC
													</span>
												</div>
												<div className="text-[0.75rem] text-success !mb-3">
                          Additional Charges: 0.32%(0.0001231 BTC)
												</div>
												<label className="font-semibold text-[0.75rem] !mt-2 !mb-2  dark:text-defaulttextcolor/70">
                          ...
                          BUY
                            ...
                            Price:
													...
													<span className="text-[#8c9097] ms-2 text-[0.875rem] dark:text-defaulttextcolor/70">
                            6.003435
													</span>
													<span className="text-dark font-semibold ltr:float-right rtl:float-left dark:text-defaulttextcolor/70">
                            BTC
                            ...
                            LTC
												...
												<div className="font-semibold text-[0.875rem] py-3">
                          Total:{" "}
													<span className="text-[0.875rem]">22.00 BTC</span>
												</div>
												<div className="text-[0.75rem] text-success !mb-3">
                          Additional Charges: 0.32%(0.0001231 BTC)
												</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
                        ...
                        Something else here
                          ...
                          Time &amp; Status
												...
												>
													<td>
														<div className="text-center">
															<p className="text-[#8c9097] dark:text-white/50 mb-0 font-semibold">
																{idx.month}
															</p>
                                  ...
                                  Currency
													...
													<td>
														<div className="items-center">
															<span className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mb-1">
																{idx.status}
															</span>
															<p className="mb-0">
																{idx.time} -
				...
				<div className="xxl:col-span-3 xl:col-span-6 col-span-12">
					<div className="box">
						<div className="box-header md:justify-between flex-wrap">
							<div className="box-title">Bitcoin Price Statistics</div>
							<div className="">
								<button
									type="button"
								...
								<li className="py-[0.8rem] px-[1.25rem] border-b dark:border-defaultborder/10">
									<Link href="#!" className=" flex-column items-start">
										<div className="flex w-full justify-between items-center">
											<p className="tx-14 mb-0 font-normal text-dark">
								...
								<li className="py-[0.8rem] px-[1.25rem] border-b dark:border-defaultborder/10">
									<Link href="#!" className=" flex-column items-start">
										<div className="flex w-full justify-between items-center">
											<p className="tx-14 mb-0 font-normal text-dark">
                        Market Rank
												<span className="badge bg-secondary/10 ms-3 text-secondary">
                          3 Years
												</span>
											</p>
											<p className="text-dark mb-0 tx-15">
				...
				<div className="xxl:col-span-4 xl:col-span-6 col-span-12">
					<div className="box">
						<div className="box-header justify-between">
							<div className="box-title">Top Traders</div>
							<div className="hs-dropdown ti-dropdown">
								<Link
									href="#!"
                  ...
                  View All
                      ...
                      Last Week
                        ...
                        0.09251821409{" "}
												<span className="text-default">- BTC</span>
											</p>
											<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50 text-[0.6875rem]">
                        $1,203.92
											</p>
                        ...
                        $19,092.56
                          ...
                          Bought +12.9092 Euro coin
										...
										<div className="text-end">
											<p className="mb-0 font-semibold text-success">
                        0.009823487{" "}
												<span className="text-default">- EUROC</span>
											</p>
											<p className="mb-0 opacity-[0.7] text-[#8c9097] dark:text-white/50 text-[0.6875rem]">
                        $8,977.46
											</p>
									...
									<div className="flex items-center justify-between">
										<div className="flex items-center">
											...
											<div>
												...
												<p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                          Bought 32.09472944 Dash using wallet
												</p>
											</div>
										</div>
										<div className="text-end">
									...
									<div className="flex items-center justify-between">
										<div className="flex items-center">
											...
											<div>
												...
												<p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                          Sent 0.00662 Bitcoin to Ravos Chan
												</p>
											</div>
										</div>
										<div className="text-end">
                  ...
                  Crypto currencies Market Value
                    ...
                    1Y
                          ...
                          Price Change
                            ...
                            0.30%{" "}
														<i className="ti ti-arrow-big-up-lines ms-1"></i>
													</span>
												</td>
											</tr>
											<tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                            ...
                            0.49%{" "}
														<i className="ti ti-arrow-big-down-lines ms-1"></i>
													</span>
												</td>
											</tr>
										</tbody>
