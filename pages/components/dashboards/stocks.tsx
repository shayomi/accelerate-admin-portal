            ...
            >
                    ...
                    <div className="box-body">
                      <div className="flex gap-3 flex-wrap items-start justify-between">
                        <div className="flex-grow flex items-start sm:mb-0">
                          ...
                          <div>
                            <span className="block text-[#8c9097] dark:text-white/50">
                    ...
                    <div className="box-body">
                      <div className="flex items-center justify-between gap-4 flex-wrap">
                        <div className="flex flex-wrap flex-grow gap-3 sm:ms-[3rem] ms-0">
                          <div>
                            <span className="block text-[#8c9097] dark:text-white/50 mb-1">
                              Invested Value
                            </span>
                          ...
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-success">
                                <i className="ti ti-arrow-narrow-up"></i>0.14%
                              </span>
                            </div>
                            <div>
                        ...
                        <li>
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-success">
                                <i className="ti ti-arrow-narrow-up"></i>2.14%
                              </span>
                            </div>
                            <div>
                              <span className="text-[0.875rem]">
                          ...
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-danger">
                                <i className="ti ti-arrow-narrow-down"></i>2.73%
                              </span>
                            </div>
                            <div>
                              <span className="text-[0.875rem]">
                        ...
                        <li>
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-success">
                                <i className="ti ti-arrow-narrow-up"></i>8.63%
                              </span>
                            </div>
                            <div>
                              <span className="text-[0.875rem]">
                        ...
                        <li>
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-danger">
                                <i className="ti ti-arrow-narrow-down"></i>4.10%
                              </span>
                            </div>
                            <div>
                              <span className="text-[0.875rem]">
                        ...
                        <li>
                          <div className="flex items-center flex-grow leading-none">
                            ...
                            <div className="text-end me-3">
                              ...
                              <span className="block text-success">
                                <i className="ti ti-arrow-narrow-up"></i>0.79%
                              </span>
                            </div>
                            <div>
                              <span className="text-[0.875rem]">
                        ...
                        <div className="flex gap-2 flex-wrap items-center justify-between mb-4">
                          <div className="flex flex-grow items-center">
                            ...
                            <div className="leading-none">
                              <span className="font-semibold block mb-2 text-default">
                                Apple
                              </span>
                              <span className="block text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                                $12,289.44
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              0.14%<i className="ti ti-arrow-bear-right"></i>
                            </span>
                    ...
                    <div className="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                      <div className="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                        <div className="flex gap-2 flex-wrap items-center justify-between mb-4">
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              2.14%<i className="ti ti-arrow-bear-right"></i>
                            </span>
                    ...
                    <div className="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                      <div className="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                        <div className="flex gap-2 flex-wrap items-center justify-between mb-4">
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              4.02%<i className="ti ti-arrow-bear-right"></i>
                            </span>
                    ...
                    <div className="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                      <div className="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                        <div className="flex gap-2 flex-wrap items-center justify-between mb-4">
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              5.14%<i className="ti ti-arrow-bear-right"></i>
                            </span>
                    ...
                    <div className="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                      <div className="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                        <div className="flex flex-wrap items-center justify-between mb-4">
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              3.32%<i className="ti ti-arrow-bear-right"></i>
                            </span>
                    ...
                    <div className="xxl:col-span-2 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                      <div className="p-4 box border dark:border-defaultborder/10 bg-white rounded">
                        <div className="flex flex-wrap items-center justify-between mb-4">
                          ...
                          <div className="text-success text-[0.75rem] text-end">
                            <span className="block">
                              1.24%<i className="ti ti-arrow-bear-right"></i>
                            </span>
              ...
              <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xl:col-span-7 col-span-12">
                  <div className="box">
                    <div className="box-header justify-between">
                      <div className="box-title">Market Movers</div>
                        ...
                        <table className="table whitespace-nowrap table-bordered border-primary/10 min-w-full">
                          ...
                          <tbody>
                            <tr className="border border-inherit border-solid dark:border-defaultborder/10">
                              ...
                              <td>
                                App1e Inc.
                                <span className="font-normal text-primary text-[.625rem] ms-1">
                                  NASDAQ
                                </span>
                              </td>
                              <td>
            ...
            >
              ...
              <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-12 col-span-12">
                  <div className="box">
                    <div className="box-header justify-between">
                      <div className="box-title">Market Cap</div>
                      <div>
                        <input
                          className="ti-form-control form-control-sm"
                          type="text"
                          ...
                          <div className="p-4">
                            <div className="flex flex-wrap items-center justify-between">
                              <div className="flex flex-grow gap-3 ms-[3rem]">
                                <div>
                                  <h5 className="font-semibold text-primary text-[1.25rem] mb-1">
                                    $12,390.02
                                    <span className="text-[0.75rem] ms-1 text-danger">
                                      0.14%
                                      <i className="ti ti-trending-down ms-1"></i>
                                    </span>
                                  </h5>
                                  <span className="block text-[#8c9097] dark:text-white/50 mb-1 text-[0.75rem]">
                              ...
                              <div className="flex text-end">
                                <div>
                                  ...
                                  <span className="block text-[#8c9097] dark:text-white/50 text-[0.6875rem] mb-1">
                                    GTHB INDEXNSE
                                  </span>
                                  <span className="block">
                                    <Link
                              ...
                              <div className="grid grid-cols-12 gap-x-6">
                                ...
                                <div className="xl:col-span-6  col-span-12">
                                  ...
                                  <div className="flex gap-3">
                                    ...
                                    <button
                                      type="button"
                                      className="flex-grow ti-btn ti-btn-sm bg-secondary text-white me-2"
                                    >
                                      Sell
                                    </button>
                                  </div>
