import {
	...
	TrendingNFTs1,
	Trendingauctions,
} from "@/shared/data/dashboards/nftdata";
		...
		<Fragment>
			...
			<div className="grid grid-cols-12 gap-x-6">
								...
								<div className="grid grid-cols-12 gap-3 sm:gap-0">
									<div className="sm:col-span-8 pe-2 col-span-12 my-auto">
										<div className="my-auto">
											<h4 className="font-semibold mb-2 text-[1.5rem] leading-6">
                        Discover, collect and sell your{" "}
												<span className="text-primary">NFTs</span> at one place
											</h4>
											<p className="mb-6 text-[#8c9097] dark:text-white/50 text-[0.875rem] opacity-[0.7]">
                        NFT means non-fungible tokens (NFTs), which are
                        generally created using the same type of programming
                        used for cryptocurrencies.It is is a unique digital
				...
				<div className="xxl:col-span-2 col-span-12">
					<div className="xxl:col-span-12 col-span-12">
                      ...
                      Total Assets
                        ...
                        0.25%
												<i className="ri-arrow-up-s-line align-middle ms-1 me-2"></i>
											</span>
                      This month
										</p>
									</div>
				...
				<div className="xxl:col-span-2 col-span-12">
					<div className="xxl:col-span-12 col-span-12">
                      ...
                      Total Value
										...
										<h5 className="font-semibold mb-1 text-[1.25rem]">
                      $1,298
										</h5>
										<p className="text-[0.6875rem] text-[#8c9097] dark:text-white/50 mb-0">
											<span className="text-success font-semibold">
				...
				<div className="xxl:col-span-2 col-span-12">
                    ...
                    Your Balance
							...
							<p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.6875rem] opacity-[0.7]">
                Top offers on USD-27,981
								<span className="text-success font-semibold ms-1 inline-block">
                  (+29.09%)
								</span>
							</p>
				...
				<div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 col-span-12">
					<div className="box overflow-hidden">
						<div className="box-header justify-between">
							<div className="box-title">Top Creators</div>
				...
				<div className="xxl:col-span-3 xl:col-span-12 lg:col-span-12 col-span-12">
					<div className="box">
						<div className="box-header !border-b-0 justify-between">
							<div className="box-title">Top Collectors</div>
							<div className="hs-dropdown ti-dropdown">
								<Link
									href="#!"
										...
										{TopCollectors.map((idx) => (
											...
											>
												...
												<td>
													...
													<span className="text-[0.6875rem] font-normal text-success">
														{idx.text2}
													</span>
												</td>
											</tr>
				...
				<div className="xxl:col-span-6 xl:col-span-8 lg:col-span-7 md:col-span-12 sm:col-span-12 col-span-12">
					<div className="box">
						<div className="box-header justify-between flex-wrap">
							<div className="box-title">NFTs Statistics</div>
							<div
              ...
              Featured Collections :
                ...
                View All
					...
					>
                        ...
                        Collection Rank :
												<span className="font-semibold text-success text-[0.9375rem] mb-0 ms-1">
                          #1
												</span>
											</div>
										</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xxl:col-span-9 col-span-12">
					<div className="box">
						<div className="box-header justify-between">
							<div className="box-title">Trending NFTs</div>
							<div className="flex">
								<div className="me-3">
									<input
						...
						<div className="box-body">
							<div className="table-responsive">
								<table className="table table-hover table-bordered whitespace-nowrap min-w-full">
									<thead>
										<tr>
											<th scope="row" className="text-start !min-w-[200px]">
                        Collection
											</th>
											<th scope="row" className="text-start">
                        Rank
											</th>
											<th scope="row" className="text-start min-w-32">
                        Volume
											</th>
											<th scope="row" className="text-start">
                        24h %
				...
				<div className="xxl:col-span-3 col-span-12">
					<div className="box overflow-hidden">
						<div className="box-header justify-between !border-b-0">
							<div className="box-title">Personal Listings</div>
							<div className="hs-dropdown ti-dropdown">
								<Link
									href="#!"
									className="px-2 font-normal text-[0.75rem] text-[#8c9097] dark:text-white/50"
									...
									>
										<Link href="#!">
											<div className="flex flex-wrapitems-center justify-between">
												<div className="flex items-center">
													...
													<div>
														...
														<span className="text-[#8c9097] dark:text-white/50 text-[0.75rem]">
															{idx.mail}
															<span
																className={`ms-2 text-${idx.color} text-[0.6875rem]`}
															>
																{idx.icon}
																{idx.value}
															</span>
												...
												<div>
													<span className="text-[0.625rem] text-[#8c9097] dark:text-white/50 ps-4">
                            PRICE
													</span>
													<p className="mb-0 font-semibold flex items-center">
														<span className="avatar avatar-sm p-1 !mb-0">
															<img
																src="../../../assets/images/crypto-currencies/regular/Ethereum.svg"
																alt=""
															/>
